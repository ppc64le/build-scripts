...
# Version          : v1.0.3
# Source repo      : https://github.com/CODAIT/hadoop-yarn-api-python-client
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=yarn-api-client
PACKAGE_VERSION=${1:-v1.0.3}
PACKAGE_URL=https://github.com/CODAIT/hadoop-yarn-api-python-client
PACKAGE_DIR=yarn-api-client
