...
# Version			: 1.7, 2.0-RC1
# Source repo		: https://github.com/apache/commons-dbutils
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="commons-dbutils"
PKG_VERSION=1.7
PKG_VERSION_LATEST=2.0-RC1
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-dbutils.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/DBUTILS_1_7
...
git checkout -b $PKG_VERSION_LATEST tags/DBUTILS_2_0_RC1
