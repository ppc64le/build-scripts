...
# Package			: gson-fire
# Version			: 1.8.3
# Source repo		: https://github.com/julman99/gson-fire
# Tested on			: RHEL 7.6
...
PKG_NAME="gson-fire"
PKG_VERSION=1.8.3
PKG_VERSION_LATEST=1.8.3
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/julman99/gson-fire.git"
...
#git checkout -b $PKG_VERSION_LATEST-new tags/v$PKG_VERSION_LATEST-new
