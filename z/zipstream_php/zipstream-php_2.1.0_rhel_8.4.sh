# -----------------------------------------------------------------------------
#
# Package	: ZipStream-PHP 
# Version	: 2.1.0
# Source repo	: https://github.com/maennchen/ZipStream-PHP
# Tested on	: RHEL 8.4 
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=ZipStream-PHP
PACKAGE_VERSION=${1:-2.1.0}
PACKAGE_URL=https://github.com/maennchen/ZipStream-PHP
