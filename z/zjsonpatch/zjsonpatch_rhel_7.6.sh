...
PKG_NAME="zjsonpatch"
PKG_VERSION=0.4.4
PKG_VERSION_LATEST=0.4.10
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/flipkart-incubator/zjsonpatch.git"
...
mvn -Dgpg.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
