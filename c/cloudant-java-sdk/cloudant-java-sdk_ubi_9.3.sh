...
# ----------------------------------------------------------------------------
# 
# Package       : cloudant-java-sdk
# Version       : v0.9.1
# Source repo   : https://github.com/IBM/cloudant-java-sdk
# Tested on     : UBI:9.3
# Language      : Java
# Travis-Check  : True
...
PACKAGE_NAME=cloudant-java-sdk
PACKAGE_VERSION=${1:-v0.9.1}
PACKAGE_URL=https://github.com/IBM/cloudant-java-sdk
