...
# Version       : 3.4.42
# Source repo   : https://github.com/symfony/class-loader.git
# Tested on     : ubi 8.4
...
PACKAGE_NAME=symfony/class-loader
PACKAGE_VERSION=${1:-3.4.42}
PACKAGE_URL=https://github.com/symfony/class-loader.git
