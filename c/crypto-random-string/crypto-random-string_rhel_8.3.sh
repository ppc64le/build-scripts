...
# Version	: 2.0.0
# Source repo	: https://github.com/sindresorhus/crypto-random-string
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=crypto-random-string
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/sindresorhus/crypto-random-string
