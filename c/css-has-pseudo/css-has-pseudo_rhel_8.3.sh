# -----------------------------------------------------------------------------
#
# Package	: css-has-pseudo
# Version	: 0.10.0
# Source repo	: https://github.com/csstools/css-has-pseudo
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=css-has-pseudo
PACKAGE_VERSION=0.10.0
PACKAGE_URL=https://github.com/csstools/css-has-pseudo
