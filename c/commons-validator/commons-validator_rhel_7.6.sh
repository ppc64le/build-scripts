...
# Version			: 1.6
# Source repo		: https://github.com/apache/commons-validator
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="commons-validator"
PKG_VERSION=1.6
PKG_VERSION_LATEST=1.6
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-validator.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/VALIDATOR_1_6
