...
# Version	    : v3.12.0
# Source repo	    : https://github.com/browserify/crypto-browserify
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=crypto-browserify
PACKAGE_VERSION=${1:-v3.12.0}
PACKAGE_URL=https://github.com/browserify/crypto-browserify
