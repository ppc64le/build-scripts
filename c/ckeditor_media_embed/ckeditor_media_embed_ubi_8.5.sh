...
# Version          : 8.x-1.10
# Source repo      : https://git.drupalcode.org/project/ckeditor_media_embed.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=ckeditor_media_embed
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/ckeditor_media_embed.git
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.10}
...
cd ../../
cd core/
if ! ../vendor/bin/phpunit ../modules/ckeditor_media_embed/tests/src/Unit; then
...
#ckeditor_media_embed has only Unit test case.Unit test don't need drupal framework and DB etc. So can be executed by given script.
#[root@14877a48adff core]# ../vendor/bin/phpunit ../modules/ckeditor_media_embed/tests/src/Unit
#PHPUnit 7.5.20 by Sebastian Bergmann and contributors.

#Testing ../modules/ckeditor_media_embed/tests/src/Unit
#.............                                                     13 / 13 (100%)

#Time: 826 ms, Memory: 4.00 MB
