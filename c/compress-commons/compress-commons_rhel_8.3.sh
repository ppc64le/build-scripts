...
# Version	: 1.2.2
# Source repo	: https://github.com/archiverjs/node-compress-commons
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=compress-commons
PACKAGE_VERSION=1.2.2
PACKAGE_URL=https://github.com/archiverjs/node-compress-commons
