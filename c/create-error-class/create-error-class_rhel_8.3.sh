# -----------------------------------------------------------------------------
#
# Package	: create-error-class
# Version	: 3.0.2
# Source repo	: https://github.com/floatdrop/create-error-class
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=create-error-class
PACKAGE_VERSION=3.0.2
PACKAGE_URL=https://github.com/floatdrop/create-error-class
