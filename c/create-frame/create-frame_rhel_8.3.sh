# -----------------------------------------------------------------------------
#
# Package	: create-frame
# Version	: 1.0.0
# Source repo	: https://github.com/jonschlinkert/create-frame
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=create-frame
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/jonschlinkert/create-frame
