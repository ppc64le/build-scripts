# -----------------------------------------------------------------------------
#
# Package	: consolidation/site-alias
# Version	: 3.1.0
# Source repo	: https://github.com/consolidation/site-alias
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=consolidation/site-alias
PACKAGE_VERSION=3.1.0
PACKAGE_URL=https://github.com/consolidation/site-alias
