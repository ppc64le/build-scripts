# -----------------------------------------------------------------------------
#
# Package	: code-block-writer
# Version	: 10.1.1
# Source repo	: https://github.com/dsherret/code-block-writer
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=code-block-writer
PACKAGE_VERSION=10.1.1
PACKAGE_URL=https://github.com/dsherret/code-block-writer
