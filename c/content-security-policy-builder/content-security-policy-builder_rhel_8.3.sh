# -----------------------------------------------------------------------------
#
# Package	: content-security-policy-builder
# Version	: 2.0.0
# Source repo	: https://github.com/helmetjs/content-security-policy-builder
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=content-security-policy-builder
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/helmetjs/content-security-policy-builder
