# -----------------------------------------------------------------------------
#
# Package	: circular-json
# Version	: 0.5.9
# Source repo	: https://github.com/WebReflection/circular-json
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=circular-json
PACKAGE_VERSION=0.5.9
PACKAGE_URL=https://github.com/WebReflection/circular-json
