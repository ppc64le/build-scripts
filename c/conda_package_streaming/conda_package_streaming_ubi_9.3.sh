...
# -----------------------------------------------------------------------------
#
# Package          : conda_package_streaming
# Version          : v0.9.0
# Source repo      : https://github.com/conda/conda-package-streaming
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=conda_package_streaming
PACKAGE_VERSION=${1:-v0.9.0}
PACKAGE_URL=https://github.com/conda/conda-package-streaming
PACKAGE_DIR=conda_package_streaming
