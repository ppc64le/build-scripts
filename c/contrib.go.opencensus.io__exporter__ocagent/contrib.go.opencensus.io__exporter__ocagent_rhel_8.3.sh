# -----------------------------------------------------------------------------
#
# Package	: contrib.go.opencensus.io/exporter/ocagent
# Version	: v0.6.0
# Source repo	: https://github.com/census-ecosystem/opencensus-go-exporter-ocagent
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=contrib.go.opencensus.io/exporter/ocagent
PACKAGE_VERSION=v0.6.0
PACKAGE_URL=https://github.com/census-ecosystem/opencensus-go-exporter-ocagent
