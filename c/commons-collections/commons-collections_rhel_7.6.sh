...
# variables
PKG_NAME="commons-collections"
PKG_VERSION=4.4
PKG_VERSION_LATEST=4.4
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-collections.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/commons-$PKG_NAME-$PKG_VERSION
