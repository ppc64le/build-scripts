...
ln -s ~/.cbdepscache/exploded/ppc64le/go-1.8.5 ~/.cbdepscache/exploded/ppc64le/go-1.8.5
rm go1.8.5.linux-ppc64le.tar.gz

echo " ------- installing go 1.9.6 ------- "
...
ln -s ~/.cbdepscache/exploded/ppc64le/go-1.9.6 ~/.cbdepscache/exploded/ppc64le/go-1.9.6
...
make gsl-lite.t
make catch_tests
make gsl-lite-cpp11.t
make hdr_histogram_test
make hdr_histogram_log_test
make hdr_atomic_test
make gsl-lite-cpp14.t
