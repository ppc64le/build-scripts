...
# Version       : v2.4.9
# Source repo   : https://github.com/jhildenbiddle/css-vars-ponyfill
# Tested on     : UBI: 9.3
# Language      : JavaScript
# Travis-Check  : True
...
set -e
PACKAGE_NAME=css-vars-ponyfill
PACKAGE_VERSION=${1:-v2.4.9}
PACKAGE_URL=https://github.com/jhildenbiddle/css-vars-ponyfill
HOME_DIR=${PWD}
