# -----------------------------------------------------------------------------
#
# Package	: copy-concurrently
# Version	: 1.0.5
# Source repo	: https://github.com/npm/copy-concurrently
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=copy-concurrently
PACKAGE_VERSION=1.0.5
PACKAGE_URL=https://github.com/npm/copy-concurrently
