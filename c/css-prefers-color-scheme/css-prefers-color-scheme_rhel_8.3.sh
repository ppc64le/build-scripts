# -----------------------------------------------------------------------------
#
# Package	: css-prefers-color-scheme
# Version	: 3.1.1
# Source repo	: https://github.com/csstools/css-prefers-color-scheme
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=css-prefers-color-scheme
PACKAGE_VERSION=3.1.1
PACKAGE_URL=https://github.com/csstools/css-prefers-color-scheme
