# -----------------------------------------------------------------------------
#
# Package	: chi-teck/drupal-code-generator
# Version	: 1.32.1
# Source repo	: https://github.com/Chi-teck/drupal-code-generator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=chi-teck/drupal-code-generator
PACKAGE_VERSION=1.32.1
PACKAGE_URL=https://github.com/Chi-teck/drupal-code-generator
