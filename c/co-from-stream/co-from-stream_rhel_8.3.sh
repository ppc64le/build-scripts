# -----------------------------------------------------------------------------
#
# Package	: co-from-stream
# Version	: 0.0.0
# Source repo	: https://github.com/juliangruber/co-from-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=co-from-stream
PACKAGE_VERSION=0.0.0
PACKAGE_URL=https://github.com/juliangruber/co-from-stream
