...
# Package          : checksumdir
# Version          : 1.2.0
# Source repo      : http://github.com/cakepietoast/checksumdir
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=checksumdir
PACKAGE_VERSION=${1:-1.2.0}
PACKAGE_URL=http://github.com/cakepietoast/checksumdir
PACKAGE_DIR=checksumdir
