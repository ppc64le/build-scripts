...
PACKAGE_VERSION=commons-io-2.6  #provide full tag name as naming convention for release is not consistent
PACKAGE_NAME=commons-io

echo "Usage: $0 [-v <PACKAGE_VERSION>]"
echo "PACKAGE_VERSION is an optional paramater whose default value is commons-io-2.6, not all versions are supported."
