# -----------------------------------------------------------------------------
#
# Package	: change-emitter
# Version	: 0.1.6
# Source repo	: https://github.com/acdlite/change-emitter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=change-emitter
PACKAGE_VERSION=0.1.6
PACKAGE_URL=https://github.com/acdlite/change-emitter
