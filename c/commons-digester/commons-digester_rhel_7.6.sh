...
# Version			: 1.8.1, 3.2
# Source repo		: https://github.com/apache/commons-digester
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="commons-digester"
PKG_VERSION=1.8.1
PKG_VERSION_LATEST=3.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-digester.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/DIGESTER_1_8_1
...
git checkout -b $PKG_VERSION_LATEST tags/DIGESTER3_3_2
