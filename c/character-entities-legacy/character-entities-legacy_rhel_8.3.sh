# -----------------------------------------------------------------------------
#
# Package	: character-entities-legacy
# Version	: 1.1.4
# Source repo	: https://github.com/wooorm/character-entities-legacy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=character-entities-legacy
PACKAGE_VERSION=1.1.4
PACKAGE_URL=https://github.com/wooorm/character-entities-legacy
