# -----------------------------------------------------------------------------
#
# Package	: consolidation/config
# Version	: 1.2
# Source repo	: https://github.com/consolidation/config
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=consolidation/config
PACKAGE_VERSION=1.2
PACKAGE_URL=https://github.com/consolidation/config
