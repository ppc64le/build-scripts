...
# Version	: 4.2.1
# Source repo	: https://github.com/consolidation/annotated-command
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=consolidation/annotated-command
PACKAGE_VERSION=4.2.1
PACKAGE_URL=https://github.com/consolidation/annotated-command
