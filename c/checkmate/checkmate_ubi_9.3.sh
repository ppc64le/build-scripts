...
# Package       : checkmate
# Version       : 2.3.1
# Source repo   : https://github.com/cran/checkmate
# Tested on     : UBI:9.3
# Language      : R
# Ci-Check  : True
...
PACKAGE_URL=https://github.com/cran/checkmate
...
dnf install -y geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel libgit2-devel openssl-devel libcurl-devel 
