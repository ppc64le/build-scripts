...
# Version	: 1.6.0
# Source repo	: https://github.com/bripkens/connect-history-api-fallback
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=connect-history-api-fallback
PACKAGE_VERSION=1.6.0
PACKAGE_URL=https://github.com/bripkens/connect-history-api-fallback
