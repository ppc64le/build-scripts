...
# Version          : storage/v1.6.0, storage/v1.3.0
...
PACKAGE_VERSION=${1:-storage/v1.6.0}
...
#Test cases are in parity with intel based on below errors:-
#
#=== RUN   TestCallBuilders
#    bucket_test.go:419: google: could not find default credentials. See https://developers.google.com/accounts/docs/application-default-credentials for more information.
#--- FAIL: TestCallBuilders (0.00s)
#
#=== RUN   TestIntegration_PublicBucket
#    integration_test.go:3172: integration_test.go:2202: read: storage: object doesn't exist
#--- FAIL: TestIntegration_PublicBucket (1.39s)
#
#=== RUN   TestIntegration_ReadCRC
#    integration_test.go:2356: uncompressed, entire file: storage: object doesn't exist
#--- FAIL: TestIntegration_ReadCRC (0.60s)
#
#=== RUN   TestWithEndpoint
#    storage_test.go:1154: error creating client: dialing: google: could not find default credentials. See https://developers.google.com/accounts/docs/application-default-credentials for more information.
