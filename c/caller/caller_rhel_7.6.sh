...
# Package       : caller
# Version       : v1.0.1
# Source        : https://github.com/totherik/caller.git
# Tested on     : RHEL 7.6
...
git clone https://github.com/totherik/caller.git && cd caller
git checkout $PACKAGE_VERSION


npm install npm@6.14.5
sed -i -e "s/require('.\/fixtures\/init')/require.resolve('.\/caller')/g" test/caller.js
