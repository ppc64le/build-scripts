# -----------------------------------------------------------------------------
#
# Package	: consolidation/output-formatters
# Version	: 3.3.1
# Source repo	: https://github.com/consolidation/output-formatters
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=consolidation/output-formatters
PACKAGE_VERSION=3.3.1
PACKAGE_URL=https://github.com/consolidation/output-formatters
