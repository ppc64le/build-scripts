...
# Version			: 2.0, 2.8.0
# Source repo		: https://github.com/apache/commons-pool
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="commons-pool"
PKG_VERSION=2.0
PKG_VERSION_LATEST=2.8.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-pool.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/POOL_2_0
