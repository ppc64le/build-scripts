...
# Version          : rel/commons-pool-2.12.0
# Source repo      : https://github.com/apache/commons-pool.git
# Tested on        : UBI:9.3
# Language         : Java
# Ci-Check     : True
...
#variables
PACKAGE_NAME=commons-pool
PACKAGE_URL=https://github.com/apache/commons-pool.git
PACKAGE_VERSION=${1:-rel/commons-pool-2.12.0}
