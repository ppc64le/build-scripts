...
#
#-------------------------------------------------------------------------------------------------
#Note: Version Upgraded, requested version 10.12.0 failed to build hence checked on latest version
#Version 10.46.0 has in parity with x86
#-------------------------------------------------------------------------------------------------
...
#FAIL Package:  packages/components/tests/es-test.js (5.902 s)
