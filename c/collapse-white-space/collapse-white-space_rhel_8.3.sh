# -----------------------------------------------------------------------------
#
# Package	: collapse-white-space
# Version	: 1.0.6
# Source repo	: https://github.com/wooorm/collapse-white-space
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=collapse-white-space
PACKAGE_VERSION=1.0.6
PACKAGE_URL=https://github.com/wooorm/collapse-white-space
