...
# Version          : rel/commons-dbutils-1.8.1
# Source repo      : https://github.com/apache/commons-dbutils.git
# Tested on        : UBI:9.3
# Language         : Java
# Ci-Check     : True
...
#variables
PACKAGE_NAME=commons-dbutils
PACKAGE_URL=https://github.com/apache/commons-dbutils.git
PACKAGE_VERSION=${1:-rel/commons-dbutils-1.8.1}
