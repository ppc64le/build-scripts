# -----------------------------------------------------------------------------
#
# Package	: cache-content-type
# Version	: 1.0.1
# Source repo	: https://github.com/node-modules/cache-content-type
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=cache-content-type
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/node-modules/cache-content-type
