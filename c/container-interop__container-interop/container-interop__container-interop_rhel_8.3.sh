# -----------------------------------------------------------------------------
#
# Package	: container-interop/container-interop
# Version	: 1.2.0
# Source repo	: https://github.com/container-interop/container-interop
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=container-interop/container-interop
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/container-interop/container-interop
