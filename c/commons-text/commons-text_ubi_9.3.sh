...
# Version          : rel/commons-text-1.12.0
# Source repo      : https://github.com/apache/commons-text.git
# Tested on        : UBI:9.3
# Language         : Java
# Ci-Check     : True
...
PACKAGE_URL=https://github.com/apache/commons-text.git
PACKAGE_VERSION=${1:-rel/commons-text-1.12.0}
