...
# Package			: compiler
# Version			: 0.9.6
# Source repo		: https://github.com/spullara/mustache.java
# Tested on			: RHEL 7.6
...
PKG_NAME="compiler"
PKG_VERSION=0.9.6
PKG_VERSION_LATEST=0.9.6
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/spullara/mustache.java.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/mustache.java-$PKG_VERSION
cd compiler/
