...
# Version			: 1.10, 2.1.1, 2.7
# Source repo		: https://github.com/apache/commons-configuration
# Tested on			: RHEL 7.6
...
REPOSITORY="https://github.com/apache/commons-configuration.git"
...
# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION_1
cd $PKG_NAME-$PKG_VERSION_1/
git checkout -b $PKG_VERSION_1 tags/CONFIGURATION_2_1_1
mvn install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_1.txt
