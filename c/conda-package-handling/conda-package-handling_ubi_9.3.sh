...
# Version          : 2.2.0
# Source repo      : https://github.com/conda/conda-package-handling
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=conda-package-handling
PACKAGE_VERSION=${1:-2.2.0}
PACKAGE_URL=https://github.com/conda/conda-package-handling
PACKAGE_DIR=conda-package-handling
