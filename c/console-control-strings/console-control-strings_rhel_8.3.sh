...
# Version	: 1.1.0
# Source repo	: https://github.com/iarna/console-control-strings
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=console-control-strings
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/iarna/console-control-strings
