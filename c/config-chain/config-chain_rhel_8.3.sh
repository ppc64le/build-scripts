# -----------------------------------------------------------------------------
#
# Package	: config-chain
# Version	: 1.1.12
# Source repo	: https://github.com/dominictarr/config-chain
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=config-chain
PACKAGE_VERSION=1.1.12
PACKAGE_URL=https://github.com/dominictarr/config-chain
