...
# Version       : 3.1.2
# Source repo   : https://github.com/ForbesLindesay/constantinople
# Tested on     : UBI8.5
# Language      : Node
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/ForbesLindesay/constantinople
...
# Tests failing with "Invalid 'reference' directive syntax" which is in parity with intel.
