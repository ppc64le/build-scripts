# -----------------------------------------------------------------------------
#
# Package	: composer/ca-bundle
# Version	: 1.2.9
# Source repo	: https://github.com/composer/ca-bundle
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=composer/ca-bundle
PACKAGE_VERSION=1.2.9
PACKAGE_URL=https://github.com/composer/ca-bundle
