# -----------------------------------------------------------------------------
#
# Package	: code-error-fragment
# Version	: 0.0.230
# Source repo	: https://github.com/vtrushin/code-error-fragment
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=code-error-fragment
PACKAGE_VERSION=0.0.230
PACKAGE_URL=https://github.com/vtrushin/code-error-fragment
