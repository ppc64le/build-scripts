...
--> Now using project "consul" on server "https://api.sneha-ppc.cp.fyre.ibm.com:6443".
...
--> Found container image 41cd3e9 (About an hour old) from quay.io for "ibmcom/consul-ppc64le:latest"
