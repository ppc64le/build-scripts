# -----------------------------------------------------------------------------
#
# Package	: commerceguys/addressing
# Version	: 1.2.0
# Source repo	: https://github.com/commerceguys/addressing
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=commerceguys/addressing
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/commerceguys/addressing
