# -----------------------------------------------------------------------------
#
# Package	: css-declaration-sorter
# Version	: 4.0.1
# Source repo	: https://github.com/Siilwyn/css-declaration-sorter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=css-declaration-sorter
PACKAGE_VERSION=4.0.1
PACKAGE_URL=https://github.com/Siilwyn/css-declaration-sorter
