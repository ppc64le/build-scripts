# -----------------------------------------------------------------------------
#
# Package	: capture-stack-trace
# Version	: 1.0.1
# Source repo	: https://github.com/floatdrop/capture-stack-trace
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=capture-stack-trace
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/floatdrop/capture-stack-trace
