...
apt-get update -y
apt-get install vim git make build-essential wget zip ffmpeg golang-go go-bindata cmake python3 xz-utils xvfb zlib1g-dev libgconf-2-4 libxss1 libdrm-dev libgbm-dev libasound2 libxshmfence-dev libnss3 libatk-adaptor libcups2 libgtk-3-0 libxtst6 xauth -y
