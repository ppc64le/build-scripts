...
apt-get update -y
DEBIAN_FRONTEND=noninteractive apt-get install vim git wget -y 
...
sed -i -e '$aunzip -qq /opt/installScripts/cypress/cypress.zip -d /root/.cache/Cypress/${1}/' factory/installScripts/cypress/default.sh
