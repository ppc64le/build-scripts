# -----------------------------------------------------------------------------
#
# Package	: composer/metadata-minifier
# Version	: 1.0.0
# Source repo	: https://github.com/composer/metadata-minifier
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=composer/metadata-minifier
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/composer/metadata-minifier
