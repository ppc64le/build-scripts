...
# -----------------------------------------------------------------------------
#
# Package          : conda-content-trust
# Version          : 0.2.0
# Source repo      : https://github.com/conda/conda-content-trust
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=conda-content-trust
PACKAGE_VERSION=${1:-0.2.0}
PACKAGE_URL=https://github.com/conda/conda-content-trust
PACKAGE_DIR=conda-content-trust
