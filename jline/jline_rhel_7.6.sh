...
# Package			: jline
# Version			: 3.14.0
# Source repo		: https://github.com/jline/jline3
# Tested on			: RHEL 7.6
...
PKG_NAME="jline"
PKG_VERSION=0.9.94
PKG_VERSION_LATEST=3.14.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/jline/jline3.git"

# clone, build and test specified version
#cd $LOCAL_DIRECTORY
#git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
#cd $PKG_NAME-$PKG_VERSION/
#git checkout -b $PKG_VERSION tags/$PKG_NAME-parent-$PKG_VERSION
...
git checkout -b $PKG_VERSION_LATEST tags/$PKG_NAME-parent-$PKG_VERSION_LATEST
