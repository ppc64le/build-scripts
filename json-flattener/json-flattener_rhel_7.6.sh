...
# Version			: 0.4.0, 0.8.1
# Source repo		: https://github.com/wnameless/json-flattener
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="json-flattener"
PKG_VERSION=0.4.0
PKG_VERSION_LATEST=0.8.1
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/wnameless/json-flattener.git"
...
mvn -Dgpg.skip=true clean install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST.txt
