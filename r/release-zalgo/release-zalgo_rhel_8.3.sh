# -----------------------------------------------------------------------------
#
# Package	: release-zalgo
# Version	: 1.0.0
# Source repo	: https://github.com/novemberborn/release-zalgo
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=release-zalgo
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/novemberborn/release-zalgo
