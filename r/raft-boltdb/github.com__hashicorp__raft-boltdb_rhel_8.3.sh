...
# Source repo	: https://github.com/hashicorp/raft-boltdb
# Tested on	: RHEL 8.3
# Language      : GO
# Ci-Check  : False
...
PACKAGE_NAME=github.com/hashicorp/raft-boltdb
PACKAGE_VERSION=v0.0.0-20171010151810-6e5ba93211ea
PACKAGE_URL=https://github.com/hashicorp/raft-boltdb
