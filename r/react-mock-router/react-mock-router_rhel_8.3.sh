# -----------------------------------------------------------------------------
#
# Package	: react-mock-router
# Version	: 1.0.15
# Source repo	: https://github.com/rkoeze/react-mock-router
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=react-mock-router
PACKAGE_VERSION=1.0.15
PACKAGE_URL=https://github.com/rkoeze/react-mock-router
