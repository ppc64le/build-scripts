# -----------------------------------------------------------------------------
#
# Package	: request-progress
# Version	: 0.3.1
# Source repo	: https://github.com/IndigoUnited/node-request-progress
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=request-progress
PACKAGE_VERSION=0.3.1
PACKAGE_URL=https://github.com/IndigoUnited/node-request-progress
