...
# Package               : rb-fsevent
# Version               : v0.10.3
# Source repo           : https://github.com/guard/rb-fsevent.git
# Tested on             : UBI 8.4
# Language              : Ruby
# Travis-Check          : True
...
export PACKAGE_NAME=rb-fsevent
export PACKAGE_URL=https://github.com/guard/rb-fsevent.git

if [ -z "$1" ]; then
  export PACKAGE_VERSION=v0.10.3
else
...
# Observed 3 test case failures due to unavailability of xcode on Linux in parity with intel platform.
# rspec ./spec/rb-fsevent/fsevent_spec.rb:33 # FSEvent should catch new file
# rspec ./spec/rb-fsevent/fsevent_spec.rb:43 # FSEvent should catch file update
# rspec ./spec/rb-fsevent/fsevent_spec.rb:52 # FSEvent should catch files update
