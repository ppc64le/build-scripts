...
# Package          : referencing
# Version          : v0.36.2
# Source repo      : https://github.com/python-jsonschema/referencing
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v0.36.2}
PACKAGE_URL=https://github.com/python-jsonschema/referencing
PACKAGE_DIR=referencing
