...
# Version	: 8.3.2
# Source repo	: https://github.com/Andarist/react-textarea-autosize
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=react-textarea-autosize
PACKAGE_VERSION=8.3.2
PACKAGE_URL=https://github.com/Andarist/react-textarea-autosize
