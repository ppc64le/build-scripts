...
# Package       : robotstxt
# Version       : 8.x-1.4
# Source repo   : https://git.drupalcode.org/project/robotstxt.git
# Tested on     : UBI: 8.5
# Language      : PHP
# Travis-Check  : False
...
PACKAGE_URL=https://git.drupalcode.org/project/robotstxt.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/robotstxt/tests/; then
...
# robotstxt has 1 types of test Functional . 
