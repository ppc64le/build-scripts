...
PACKAGE_URL=https://github.com/requests/requests-oauthlib.git
...
pip3 install pytest requests_mock
...
#skipping tests as they are skipped on x86 as well
if ! pytest -k "not test_authorized_true_rsa and not test_signature_methods" ; then
