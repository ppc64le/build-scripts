# -----------------------------------------------------------------------------
#
# Package	: readline-utils
# Version	: 2.2.3
# Source repo	: https://github.com/enquirer/readline-utils
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=readline-utils
PACKAGE_VERSION=2.2.3
PACKAGE_URL=https://github.com/enquirer/readline-utils
