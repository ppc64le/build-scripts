...
# Package          : real_aes
# Version          : 8.x-2.3
# Source repo      : https://git.drupalcode.org/project/real_aes.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=real_aes
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/real_aes.git
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-2.3}
