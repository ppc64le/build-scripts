# -----------------------------------------------------------------------------
#
# Package	: regenerate-unicode-properties
# Version	: 8.2.0
# Source repo	: https://github.com/mathiasbynens/regenerate-unicode-properties
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=regenerate-unicode-properties
PACKAGE_VERSION=8.2.0
PACKAGE_URL=https://github.com/mathiasbynens/regenerate-unicode-properties
