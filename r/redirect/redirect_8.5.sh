...
# Please follow README file for more information to run /Functional test cases.and make the script Ci-Check false for Kernel/Functional/FunctionalJavascript test.