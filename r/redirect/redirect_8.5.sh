...
# Package          : redirect
# Version          : 8.x-1.6
# Source repo      : https://git.drupalcode.org/project/redirect.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/redirect.git
...
cd ../../
cd core/
if ! ../vendor/bin/phpunit ../modules/redirect/tests/src/Unit; then
...
#redirect has 4 types of test Unit/Kernel/Functional/FunctionalJavascript . Unit test don't need drupal framework and DB etc. So can be executed by given script.
# Please follow README file for more information to run /Functional test cases.and make the script travis-check false for Kernel/Functional/FunctionalJavascript test.