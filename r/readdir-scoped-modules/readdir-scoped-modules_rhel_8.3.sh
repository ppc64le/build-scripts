# -----------------------------------------------------------------------------
#
# Package	: readdir-scoped-modules
# Version	: 1.0.2
# Source repo	: https://github.com/npm/readdir-scoped-modules
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=readdir-scoped-modules
PACKAGE_VERSION=1.0.2
PACKAGE_URL=https://github.com/npm/readdir-scoped-modules
