# -----------------------------------------------------------------------------
#
# Package	: react-style-proptype
# Version	: 3.2.2
# Source repo	: https://github.com/brigand/react-style-proptype
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=react-style-proptype
PACKAGE_VERSION=3.2.2
PACKAGE_URL=https://github.com/brigand/react-style-proptype
