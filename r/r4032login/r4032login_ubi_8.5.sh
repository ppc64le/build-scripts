...
# Package          : r4032login
# Version          : 2.1.0
# Source repo      : https://git.drupalcode.org/project/r4032login
# Tested on        : UBI 8.5
# Language         : PHP
# Ci-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=r4032login
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/r4032login
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/r4032login/tests/src/Unit; then
...
# Please follow README file for more information to run /Functional test cases.and make the script Ci-Check false for Functional test.
