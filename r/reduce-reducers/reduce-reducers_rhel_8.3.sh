# -----------------------------------------------------------------------------
#
# Package	: reduce-reducers
# Version	: 0.4.3
# Source repo	: https://github.com/redux-utilities/reduce-reducers
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=reduce-reducers
PACKAGE_VERSION=0.4.3
PACKAGE_URL=https://github.com/redux-utilities/reduce-reducers
