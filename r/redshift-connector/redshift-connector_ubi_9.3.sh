...
# Version          : v2.0.917
# Source repo      : https://github.com/aws/amazon-redshift-python-driver
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v2.0.917}
PACKAGE_URL=https://github.com/aws/amazon-redshift-python-driver
PACKAGE_DIR=redshift-connector
