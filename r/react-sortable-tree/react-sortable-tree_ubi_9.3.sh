...
# -----------------------------------------------------------------------------
#
# Package	    : react-sortable-tree
# Version	    : v4.2.2
# Source repo	    : https://github.com/codemayonnaise/react-sortable-tree
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=react-sortable-tree
PACKAGE_VERSION=${1:-v4.2.2}
PACKAGE_URL=https://github.com/codemayonnaise/react-sortable-tree
