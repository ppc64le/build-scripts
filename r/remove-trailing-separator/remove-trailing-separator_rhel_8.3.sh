...
# Version	: 1.1.0
# Source repo	: https://github.com/darsain/remove-trailing-separator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=remove-trailing-separator
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/darsain/remove-trailing-separator
