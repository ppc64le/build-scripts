...
# -----------------------------------------------------------------------------
#
# Package	    : redux-socket.io
# Version	    : 789b91c
# Source repo	    : https://github.com/itaylor/redux-socket.io
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_VERSION=${1:-789b91c}
PACKAGE_URL=https://github.com/itaylor/redux-socket.io
