...
# -----------------------------------------------------------------------------
#
# Package          : requests-unixsocket
# Version          : v0.4.1
# Source repo      : https://github.com/msabramo/requests-unixsocket
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/msabramo/requests-unixsocket
PACKAGE_DIR=requests-unixsocket
