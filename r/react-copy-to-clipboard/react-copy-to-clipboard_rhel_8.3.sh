# -----------------------------------------------------------------------------
#
# Package	: react-copy-to-clipboard
# Version	: 5.0.3
# Source repo	: https://github.com/nkbt/react-copy-to-clipboard
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=react-copy-to-clipboard
PACKAGE_VERSION=5.0.3
PACKAGE_URL=https://github.com/nkbt/react-copy-to-clipboard
