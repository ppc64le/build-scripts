# -----------------------------------------------------------------------------
#
# Package	: referrer-policy
# Version	: 1.1.0
# Source repo	: https://github.com/helmetjs/referrer-policy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=referrer-policy
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/helmetjs/referrer-policy
