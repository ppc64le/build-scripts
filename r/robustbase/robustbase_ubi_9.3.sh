...
# Package          : robustbase
# Version          : 0.99-4-1
# Source repo      : https://github.com/cran/robustbase.git
# Tested on        : UBI:9.3
# Language         : R
# Ci-Check     : True
...
#variables
PACKAGE_NAME=robustbase
PACKAGE_VERSION=${1:-0.99-4-1}
PACKAGE_URL=https://github.com/cran/robustbase.git
...
dnf install -y geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel libgit2-devel libcurl-devel libarchive-devel librsvg2-devel procps-ng openssl-devel
