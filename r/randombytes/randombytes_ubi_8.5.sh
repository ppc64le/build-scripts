...
# Package          : randombytes
# Version          : v2.1.0
# Source repo      : https://github.com/crypto-browserify/randombytes
...
PACKAGE_URL=https://github.com/crypto-browserify/randombytes.git
...
if ! npm install --force && npm audit fix && npm audit fix --force; then
