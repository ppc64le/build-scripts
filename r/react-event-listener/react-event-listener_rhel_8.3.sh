# -----------------------------------------------------------------------------
#
# Package	: react-event-listener
# Version	: 0.6.6
# Source repo	: https://github.com/oliviertassinari/react-event-listener
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=react-event-listener
PACKAGE_VERSION=0.6.6
PACKAGE_URL=https://github.com/oliviertassinari/react-event-listener
