...
sudo dnf install -y gcc gcc-c++ git wget xz cmake make python3.8 openssl-devel

#Install R from Source

# Required repo to pickup additional EPEL package
sudo dnf install --nodocs -y https://dl.fedoraproject.org/pub/epel/epel-release-latest-8.noarch.rpm
sudo dnf update -y
#Install required dependencies
sudo dnf builddep R -y
