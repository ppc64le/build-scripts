...
# Version	    : v2.0.2
# Source repo	    : https://github.com/floatdrop/require-from-string
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_URL=https://github.com/floatdrop/require-from-string
...
# Tests commented because 2 tests cases are failing in parity with x86 execution. Command is npm test.
