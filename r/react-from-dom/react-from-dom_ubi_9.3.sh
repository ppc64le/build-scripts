...
# -----------------------------------------------------------------------------
#
# Package	    : react-from-dom
# Version	    : v0.6.2
# Source repo	    : https://github.com/gilbarbara/react-from-dom
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
# Script License    : Unilicense License
...
PACKAGE_NAME=react-from-dom
PACKAGE_VERSION=${1:-v0.6.2}
PACKAGE_URL=https://github.com/gilbarbara/react-from-dom
