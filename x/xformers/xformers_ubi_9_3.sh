...
dnf install -y https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm \
    git cmake ninja-build gcc gcc-c++ g++ rust cargo jq
...
pip install ninja cmake 'pytest==8.2.2' hydra-core
...
pip install meson ninja numpy 'setuptools<60.0' Cython
...
if ! pytest tests/test_unbind.py tests/test_rotary_embeddings.py tests/test_hydra_helper.py tests/test_compositional_attention.py tests/test_global_attention.py; then
