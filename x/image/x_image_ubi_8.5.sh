...
#
# ----------------------------------------------------------------------------
#Run the script:./x_image_ubi_8.5.sh c73c2afc3b81(version_to_test)
PACKAGE_NAME=image
PACKAGE_VERSION=${1:-c73c2afc3b81}
GO_VERSION=1.18.3
ARCH=ppc64le
PACKAGE_URL=https://go.googlesource.com/image
#Install dependency
