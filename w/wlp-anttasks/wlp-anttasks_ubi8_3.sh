...
#Variables
REPO=https://github.com/OpenLiberty/ci.ant.git
PACKAGE_VERSION=liberty-ant-tasks-1.9.4    

echo "Usage: $0 [-v <PACKAGE_VERSION>]"
echo "PACKAGE_VERSION is an optional paramater whose default value is liberty-ant-tasks-1.9.4"
