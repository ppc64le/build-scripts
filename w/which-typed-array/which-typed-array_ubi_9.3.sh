...
# Version	    : v1.1.15
# Source repo	    : https://github.com/inspect-js/which-typed-array
# Tested on	    : UBI 9.3
# Language          : Node
# Ci-Check      : True
...
PACKAGE_NAME=which-typed-array
PACKAGE_VERSION=${1:-v1.1.15}
PACKAGE_URL=https://github.com/inspect-js/which-typed-array
