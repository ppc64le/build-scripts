...
# Version	: 0.1.4
# Source repo	: https://github.com/faye/websocket-extensions-node
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=websocket-extensions
PACKAGE_VERSION=0.1.4
PACKAGE_URL=https://github.com/faye/websocket-extensions-node
