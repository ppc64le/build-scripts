# -----------------------------------------------------------------------------
#
# Package	: with-open-file
# Version	: 0.1.7
# Source repo	: https://github.com/raphinesse/with-open-file
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=with-open-file
PACKAGE_VERSION=0.1.7
PACKAGE_URL=https://github.com/raphinesse/with-open-file
