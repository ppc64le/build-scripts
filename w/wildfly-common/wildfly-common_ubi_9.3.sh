...
# Version          : 2.0.0
# Source repo      : https://github.com/wildfly/wildfly-common
# Tested on        : UBI:9.3
# Language         : Java
# Travis-Check     : True
...
PACKAGE_NAME=wildfly-common
PACKAGE_VERSION=${1:-1.5.4.Final}
PACKAGE_URL=https://github.com/wildfly/wildfly-common
