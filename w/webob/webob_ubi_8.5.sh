...
# Download the repo
wget https://files.pythonhosted.org/packages/c7/45/ee5f034fb4ebe3236fa49e5a4fcbc54444dd22ecf33079cf56f9606d479d/WebOb-1.8.7.tar.gz
tar -xzf WebOb-1.8.7.tar.gz

# Build and Test webobs
cd WebOb-1.8.7
