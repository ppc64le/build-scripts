...
#
# Package       : woodstox 
# Version       : woodstox-core-7.0.0
# Source repo   : https://github.com/FasterXML/woodstox 
# Tested on     : UBI: 9.3
# Language      : Java,Html
# Ci-Check  : True
...
set -e
PACKAGE_NAME=woodstox
PACKAGE_URL=https://github.com/FasterXML/woodstox.git
PACKAGE_VERSION=${1:-woodstox-core-7.0.0}
