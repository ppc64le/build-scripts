...
# Version	: 1.0.2
# Source repo	: https://github.com/inspect-js/which-boxed-primitive
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=which-boxed-primitive
PACKAGE_VERSION=1.0.2
PACKAGE_URL=https://github.com/inspect-js/which-boxed-primitive
