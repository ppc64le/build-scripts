# -----------------------------------------------------------------------------
#
# Package	: webmozart/path-util
# Version	: 2.1.0
# Source repo	: https://github.com/webmozart/path-util
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=webmozart/path-util
PACKAGE_VERSION=2.1.0
PACKAGE_URL=https://github.com/webmozart/path-util
