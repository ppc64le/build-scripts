# -----------------------------------------------------------------------------
#
# Package	: konsorten/go-windows-terminal-sequences
# Version	: 1.0.2
# Source repo	: https://github.com/konsorten/go-windows-terminal-sequences
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=konsorten/go-windows-terminal-sequences
PACKAGE_VERSION=1.0.2
PACKAGE_URL=https://github.com/konsorten/go-windows-terminal-sequences
