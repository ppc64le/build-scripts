...
#                 This script describes steps to build below packages
...
wget https://raw.githubusercontent.com/ppc64le/build-scripts/master/k/kotlin-stdlib/v1.5.21/kotlin.patch;
