...
# Package       : kingpin
# Version       : v2.2.6
# Source repo   : https://github.com/alecthomas/kingpin
# Tested on     : UBI: 8.5
# Language      : Go
# Travis-Check  : True
...
export PACKAGE_NAME=kingpin
export PACKAGE_VERSION=${1:-v2.2.6}
export PACKAGE_URL=https://github.com/alecthomas/kingpin
...
go mod init github.com/alecthomas/kingpin
go mod tidy
