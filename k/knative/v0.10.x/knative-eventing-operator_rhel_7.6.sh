# ----------------------------------------------------------------------------
#
# Package         : knative/eventing-operator
# Version         : v0.10.0
# Source repo     : https://github.com/knative/eventing-operator.git
# Tested on       : rhel_7.6
...
#Build knative-eventing-operator images
mkdir -p ${GOPATH}/src/knative.dev && cd $_
git clone --branch v0.10.0 https://github.com/knative/eventing-operator.git
cd eventing-operator
...
ko publish --platform=linux/ppc64le ./cmd/manager/
