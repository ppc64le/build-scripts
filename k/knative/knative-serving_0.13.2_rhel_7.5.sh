...
git clone --branch v0.13.2 https://github.com/knative/serving.git
cd serving
...
ko publish --platform=linux/ppc64le ./cmd/networking/certmanager/
ko publish --platform=linux/ppc64le ./cmd/networking/istio/
