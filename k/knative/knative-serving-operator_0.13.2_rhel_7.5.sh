# ----------------------------------------------------------------------------
#
# Package         : knative/serving-operator
# Version         : v0.13.2
# Source repo     : https://github.com/knative/serving-operator.git
# Tested on       : rhel_7.5
...
#Build knative-serving-operator images
mkdir -p ${GOPATH}/src/knative.dev && cd $_
git clone --branch v0.13.2 https://github.com/knative/serving-operator.git
cd serving-operator
