...
# Source repo     : https://github.com/knative/net-kourier.git
...
mkdir -p ${GOPATH}/src/knative && cd $_

git clone --branch v0.15.0 https://github.com/knative/net-kourier.git
...
ko publish --platform=linux/ppc64le ./cmd/kourier/
