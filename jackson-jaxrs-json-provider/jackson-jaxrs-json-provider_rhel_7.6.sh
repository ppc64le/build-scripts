#----------------------------------------------------------------------------
#
# Package			: jackson-jaxrs-json-provider
# Version			: 2.10.2
...
# variables
PKG_NAME="jackson-jaxrs-json-provider"
PKG_VERSION=2.10.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/FasterXML/jackson-jaxrs-providers.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/jackson-jaxrs-providers-$PKG_VERSION
cd json/
