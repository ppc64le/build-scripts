...
# -----------------------------------------------------------------------------
#
# Package          : flask-swagger-ui
# Version          : 4.11.1
# Source repo      : https://github.com/sveint/flask-swagger-ui
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/sveint/flask-swagger-ui
PACKAGE_DIR=flask-swagger-ui
