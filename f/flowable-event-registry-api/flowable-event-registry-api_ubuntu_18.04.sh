# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-api
# Version          : 6.6.0
...
## Build and test flowable-engine/modules/flowable-event-registry-api/
cd flowable-engine/modules/flowable-event-registry-api/
...
## Build and test flowable-event-registry-api
