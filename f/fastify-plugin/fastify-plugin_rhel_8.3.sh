# -----------------------------------------------------------------------------
#
# Package	: fastify-plugin
# Version	: 1.6.1
# Source repo	: https://github.com/fastify/fastify-plugin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fastify-plugin
PACKAGE_VERSION=1.6.1
PACKAGE_URL=https://github.com/fastify/fastify-plugin
