# -----------------------------------------------------------------------------
#
# Package	: form3tech-oss/jwt-go
# Version	: v3.2.2+incompatible
# Source repo	: https://github.com/form3tech-oss/jwt-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=form3tech-oss/jwt-go
PACKAGE_VERSION=v3.2.2+incompatible
PACKAGE_URL=https://github.com/form3tech-oss/jwt-go
