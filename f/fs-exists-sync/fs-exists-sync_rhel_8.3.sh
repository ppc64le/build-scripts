# -----------------------------------------------------------------------------
#
# Package	: fs-exists-sync
# Version	: 0.1.0
# Source repo	: https://github.com/jonschlinkert/fs-exists-sync
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fs-exists-sync
PACKAGE_VERSION=0.1.0
PACKAGE_URL=https://github.com/jonschlinkert/fs-exists-sync
