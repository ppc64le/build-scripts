# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-configurator
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-event-registry-configurator
...
## Build and test flowable-engine/modules/flowable-event-registry-configurator/
cd flowable-engine/modules/flowable-event-registry-configurator/
...
## Build and test flowable-event-registry-configurator
