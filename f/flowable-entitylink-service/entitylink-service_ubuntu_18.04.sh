# ----------------------------------------------------------------------------
#
# Package          : flowable-entitylink-service
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-entitylink-service
...
## Build and test flowable-engine/modules/flowable-entitylink-service/
cd flowable-engine/modules/flowable-entitylink-service/
...
## Build and test flowable-entitylink-service
