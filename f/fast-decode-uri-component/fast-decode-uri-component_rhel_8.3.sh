...
# Version	: 1.0.1
# Source repo	: https://github.com/delvedor/fast-decode-uri-component
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fast-decode-uri-component
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/delvedor/fast-decode-uri-component
