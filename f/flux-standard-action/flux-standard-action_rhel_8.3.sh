# -----------------------------------------------------------------------------
#
# Package	: flux-standard-action
# Version	: 0.6.1
# Source repo	: https://github.com/redux-utilities/flux-standard-action
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=flux-standard-action
PACKAGE_VERSION=0.6.1
PACKAGE_URL=https://github.com/redux-utilities/flux-standard-action
