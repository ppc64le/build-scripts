# -----------------------------------------------------------------------------
#
# Package	: fvbommel/sortorder
# Version	: v1.0.1
# Source repo	: https://github.com/fvbommel/sortorder
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fvbommel/sortorder
PACKAGE_VERSION=v1.0.1
PACKAGE_URL=https://github.com/fvbommel/sortorder
