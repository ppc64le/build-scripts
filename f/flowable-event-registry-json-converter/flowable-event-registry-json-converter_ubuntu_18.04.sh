# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-json-converter
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-event-registry-json-converter
...
## Build and test flowable-engine/modules/flowable-event-registry-json-converter/
cd flowable-engine/modules/flowable-event-registry-json-converter/
...
## Build and test flowable-event-registry-json-converter
