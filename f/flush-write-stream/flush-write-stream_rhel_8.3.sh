# -----------------------------------------------------------------------------
#
# Package	: flush-write-stream
# Version	: 1.1.1
# Source repo	: https://github.com/mafintosh/flush-write-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=flush-write-stream
PACKAGE_VERSION=1.1.1
PACKAGE_URL=https://github.com/mafintosh/flush-write-stream
