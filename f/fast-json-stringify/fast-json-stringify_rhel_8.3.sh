# -----------------------------------------------------------------------------
#
# Package	: fast-json-stringify
# Version	: 2.2.10
# Source repo	: https://github.com/fastify/fast-json-stringify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fast-json-stringify
PACKAGE_VERSION=2.2.10
PACKAGE_URL=https://github.com/fastify/fast-json-stringify
