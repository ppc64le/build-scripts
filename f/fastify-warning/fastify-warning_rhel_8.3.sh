# -----------------------------------------------------------------------------
#
# Package	: fastify-warning
# Version	: 0.2.0
# Source repo	: https://github.com/fastify/fastify-warning
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fastify-warning
PACKAGE_VERSION=0.2.0
PACKAGE_URL=https://github.com/fastify/fastify-warning
