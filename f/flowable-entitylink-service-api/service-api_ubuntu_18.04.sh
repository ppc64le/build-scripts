# ----------------------------------------------------------------------------
#
# Package          : flowable-entitylink-service-api
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-entitylink-service-api
...
## Build and test flowable-engine/modules/flowable-entitylink-service-api/
cd flowable-engine/modules/flowable-entitylink-service-api/
...
## Build and test flowable-entitylink-service-api
