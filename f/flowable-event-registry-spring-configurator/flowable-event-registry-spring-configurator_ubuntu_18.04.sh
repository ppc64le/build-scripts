# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-spring-configurator
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-event-registry-spring-configurator
...
## Build and test flowable-engine/modules/flowable-event-registry-spring-configurator/
cd flowable-engine/modules/flowable-event-registry-spring-configurator/
...
## Build and test flowable-event-registry-spring-configurator
