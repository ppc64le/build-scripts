# -----------------------------------------------------------------------------
#
# Package	: fastify-openapi-glue
# Version	: 1.5.1
# Source repo	: https://github.com/seriousme/fastify-openapi-glue
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fastify-openapi-glue
PACKAGE_VERSION=1.5.1
PACKAGE_URL=https://github.com/seriousme/fastify-openapi-glue
