# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-spring
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-event-registry-spring
...
## Build and test flowable-engine/modules/flowable-event-registry-spring/
cd flowable-engine/modules/flowable-event-registry-spring/
...
## Build and test flowable-event-registry-spring
