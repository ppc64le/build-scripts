...
# Package       : formatjs
# Version       : v2.0.0
# Source repo   : https://github.com/formatjs/formatjs
# Tested on     : UBI8.5
# Language      : Node
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/formatjs/formatjs
...
# Tests failing with "Error: Cannot find module 'type'" which is in parity with intel.
