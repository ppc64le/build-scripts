# -----------------------------------------------------------------------------
#
# Package	: github.com/gobuffalo/flect
# Version	: v0.2.1
# Source repo	: https://github.com/gobuffalo/flect
# Language      : GO
# Ci-Check  : False
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/gobuffalo/flect
PACKAGE_VERSION=v0.2.1
PACKAGE_URL=https://github.com/gobuffalo/flect
