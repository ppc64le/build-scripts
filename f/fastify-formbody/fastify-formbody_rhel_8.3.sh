# -----------------------------------------------------------------------------
#
# Package	: fastify-formbody
# Version	: 3.2.0
# Source repo	: https://github.com/fastify/fastify-formbody
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=fastify-formbody
PACKAGE_VERSION=3.2.0
PACKAGE_URL=https://github.com/fastify/fastify-formbody
