# -----------------------------------------------------------------------------
#
# Package	: functional-red-black-tree
# Version	: 1.0.1
# Source repo	: https://github.com/mikolalysenko/functional-red-black-tree
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=functional-red-black-tree
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/mikolalysenko/functional-red-black-tree
