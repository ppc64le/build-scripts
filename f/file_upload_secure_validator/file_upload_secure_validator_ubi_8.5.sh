#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : file_upload_secure_validator
# Version          : 8.x-1.4
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=file_upload_secure_validator
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/file_upload_secure_validator.git
...
cd ../../
cd core/
if ! ../vendor/bin/phpunit ../modules/file_upload_secure_validator/tests/src/Unit; then
