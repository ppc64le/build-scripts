...
# Package			: fst	
# Version			: 2.56
# Source repo		: https://github.com/RuedigerMoeller/fast-serialization
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="fst"
PKG_VERSION=2.57 # tag not available in repository
PKG_VERSION_LATEST=2.56
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/RuedigerMoeller/fast-serialization.git"
...
#mvn -Dmaven.javadoc.skip=true clean install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
...
mvn -Dmaven.javadoc.skip=true clean install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST.txt
#./gradlew build | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST-gradle.txt

# clone, build and test master
#cd $LOCAL_DIRECTORY
#git clone $REPOSITORY $PKG_NAME-master
#cd $PKG_NAME-master/
#mvn -Dmaven.javadoc.skip=true clean install | tee $LOGS_DIRECTORY/$PKG_NAME.txt
##./gradlew build | tee $LOGS_DIRECTORY/$PKG_NAME-gradle.txt
