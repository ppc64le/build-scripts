# ----------------------------------------------------------------------------
#
# Package          : flowable-event-registry-model
# Version          : 6.6.0
# Source repo      : https://github.com/flowable/flowable-engine/tree/master/modules/flowable-event-registry-model
...
## Build and test flowable-engine/modules/flowable-event-registry-model/
cd flowable-engine/modules/flowable-event-registry-model/
...
## Build and test flowable-event-registry-model
