...
# Version			: 2.7.5, 4.4.0
# Source repo		: https://github.com/ihsanbal/LoggingInterceptor
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="logging-interceptor"
PKG_VERSION=2.7.5
PKG_VERSION_LATEST=4.4.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/ihsanbal/LoggingInterceptor.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/parent-$PKG_VERSION
cd okhttp-logging-interceptor/
...
git checkout -b $PKG_VERSION_LATEST tags/parent-$PKG_VERSION_LATEST
cd okhttp-logging-interceptor/
