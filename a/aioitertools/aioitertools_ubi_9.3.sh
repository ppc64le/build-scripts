...
# Version          : v0.12.0
# Source repo      : https://github.com/omnilib/aioitertools
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/omnilib/aioitertools
PACKAGE_DIR=aioitertools

# Install dependencies
yum install -y git python3.11 python3.11-devel.ppc64le python3.11-pip gcc-toolset-13 make wget sudo cmake
python3.11 -m pip install coverage mypy
...
echo $pwd
python3.11 -m coverage run -m aioitertools.tests
python3.11 -m coverage report
python3.11 -m mypy -p aioitertools && test_status=0 || test_status=$?
