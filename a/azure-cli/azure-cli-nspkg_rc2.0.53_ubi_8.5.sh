...
PACKAGE_VERSION=${1:-rc2.0.53}
PACKAGE_URL=${2:-https://github.com/Azure/azure-cli}
PACKAGE_FOLDER=azure-cli/

yum install -y  python3 python3-devel  ncurses git gcc gcc-c++ rust-toolset libffi libffi-devel  make cmake openssl-devel
rm -rf /home/tester
mkdir -p /home/tester/output

python3 -m pip install pytest pytest-cov setuptools-rust mccabe==0.6.0
