# ----------------------------------------------------------------------------
#
# Package          : aopalliance-repackaged_2.4.0-b32
# Version          : 1.0.0
# Source repo      : https://github.com/Appdynamics/OSS
...
export REPO=https://github.com/Appdynamics/OSS

#no tag currently and using master by default
if [ -z "$1" ]; then
...
## Build and test   aopalliance-repackaged/2.4.0-b32/
cd  OSS/aopalliance-repackaged/2.4.0-b32/
