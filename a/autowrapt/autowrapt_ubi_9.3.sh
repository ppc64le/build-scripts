...
# Package          : autowrapt
# Version          : 1.0
# Source repo      : https://github.com/GrahamDumpleton/autowrapt
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=autowrapt
PACKAGE_VERSION=${1:-1.0}
PACKAGE_URL=https://github.com/GrahamDumpleton/autowrapt
PACKAGE_DIR=autowrapt
