# -----------------------------------------------------------------------------
#
# Package	: @apidevtools/swagger-methods
# Version	: 3.0.2
# Source repo	: https://github.com/APIDevTools/swagger-methods
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@apidevtools/swagger-methods
PACKAGE_VERSION=3.0.2
PACKAGE_URL=https://github.com/APIDevTools/swagger-methods
