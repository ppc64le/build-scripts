...
# Version	: 0.2.1
# Source repo	: https://github.com/asyncapi/avro-schema-parser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@asyncapi/avro-schema-parser
PACKAGE_VERSION=0.2.1
PACKAGE_URL=https://github.com/asyncapi/avro-schema-parser
