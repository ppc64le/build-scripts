# -----------------------------------------------------------------------------
#
# Package	: ansi-bgwhite
# Version	: 0.1.1
# Source repo	: https://github.com/jonschlinkert/ansi-bgwhite
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=ansi-bgwhite
PACKAGE_VERSION=0.1.1
PACKAGE_URL=https://github.com/jonschlinkert/ansi-bgwhite
