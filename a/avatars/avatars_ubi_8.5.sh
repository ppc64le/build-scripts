...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=avatars
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/avatars.git
...
composer require 'drupal/unlimited_number:2.0.0'
cd modules/
...
cd ../../
cd core/
if ! ../vendor/bin/phpunit ../modules/avatars/tests; then
