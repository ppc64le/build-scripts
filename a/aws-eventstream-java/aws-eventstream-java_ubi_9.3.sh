...
# ----------------------------------------------------------------------------
#
# Package       : aws-eventstream-java
# Version       : 1e76ef4
# Source repo   : https://github.com/awslabs/aws-eventstream-java
# Tested on     : UBI 9.3
# Language      : Java
# Travis-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=aws-eventstream-java
PACKAGE_URL=https://github.com/awslabs/aws-eventstream-java.git
PACKAGE_VERSION=${1:-1e76ef4}
