...
# Version	    : v3.0.0
# Source repo	    : https://github.com/mysticatea/abort-controller
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=abort-controller
PACKAGE_VERSION=${1:-v3.0.0}
PACKAGE_URL=https://github.com/mysticatea/abort-controller
