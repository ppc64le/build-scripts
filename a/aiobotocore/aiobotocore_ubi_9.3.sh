...
# Package          : aiobotocore
# Version          : 2.19.0
# Source repo      : https://github.com/aio-libs/aiobotocore
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-2.19.0}
PACKAGE_URL=https://github.com/aio-libs/aiobotocore
PACKAGE_DIR=aiobotocore
...
# no tests run - testing requires aws keys, secrets, and accounts
