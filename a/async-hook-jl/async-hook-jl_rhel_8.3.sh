# -----------------------------------------------------------------------------
#
# Package	: async-hook-jl
# Version	: 1.7.6
# Source repo	: https://github.com/jeff-lewis/async-hook-jl
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=async-hook-jl
PACKAGE_VERSION=1.7.6
PACKAGE_URL=https://github.com/jeff-lewis/async-hook-jl
