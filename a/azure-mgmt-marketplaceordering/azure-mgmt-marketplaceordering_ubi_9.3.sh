...
# Version          : azure-mgmt-marketplaceordering_1.2.0b2
...
PACKAGE_VERSION=${1:-azure-mgmt-marketplaceordering_1.2.0b2}
PACKAGE_URL=https://github.com/Azure/azure-sdk-for-python
PACKAGE_DIR=azure-sdk-for-python/sdk/marketplaceordering/azure-mgmt-marketplaceordering
CURRENT_DIR=$(pwd)
