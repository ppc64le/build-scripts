...
# Version          : azure-mgmt-containerservice_36.0.0
...
PACKAGE_VERSION=${1:-azure-mgmt-containerservice_36.0.0}
PACKAGE_URL=https://github.com/Azure/azure-sdk-for-python
PACKAGE_DIR=azure-sdk-for-python/sdk/containerservice/azure-mgmt-containerservice
