# -----------------------------------------------------------------------------
#
# Package	: aws/aws-lambda-go
# Version	: v1.13.3
# Source repo	: https://github.com/aws/aws-lambda-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=aws/aws-lambda-go
PACKAGE_VERSION=v1.13.3
PACKAGE_URL=https://github.com/aws/aws-lambda-go
