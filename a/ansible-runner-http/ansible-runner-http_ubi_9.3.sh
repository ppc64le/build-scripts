...
# -----------------------------------------------------------------------------
#
# Package          : ansible-runner-http
# Version          : 1.0.0
# Source repo      : https://github.com/ansible/ansible-runner-http
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=ansible-runner-http
PACKAGE_VERSION=master
PACKAGE_URL=https://github.com/ansible/ansible-runner-http
PACKAGE_DIR=ansible-runner-http
