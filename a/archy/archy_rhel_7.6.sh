...
# Package       : archy
# Version       : 1.0.0
# Source        : https://github.com/substack/node-archy.git 
# Tested on     : RHEL 7.6
...
git clone https://github.com/substack/node-archy.git && cd node-archy
git checkout $PACKAGE_VERSION


npm install npm@6.14.5
npm install
sed -i -e 's/tap test/tap test\/*/g'  package.json
npm test
