# -----------------------------------------------------------------------------
#
# Package	: abstract-logging
# Version	: 2.0.1
# Source repo	: https://github.com/jsumners/abstract-logging
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=abstract-logging
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/jsumners/abstract-logging
