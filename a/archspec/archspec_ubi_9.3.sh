...
# Package          : archspec
# Version          : v0.2.3
# Source repo      : https://github.com/archspec/archspec
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=archspec
PACKAGE_VERSION=${1:-v0.2.3}
PACKAGE_URL=https://github.com/archspec/archspec
PACKAGE_DIR=archspec
