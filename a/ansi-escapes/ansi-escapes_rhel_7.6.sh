...
# Version       : v4.3.1
# Source        : https://github.com/sindresorhus/ansi-escapes.git
# Tested on     : RHEL 7.6
...
git clone https://github.com/sindresorhus/ansi-escapes.git && cd ansi-escapes
git checkout $PACKAGE_VERSION


npm install npm@6.14.5
sed -i -e 's/Buffer.from(1)/Buffer.from(\"1\")/g'  index.test-d.ts
npm install
npm test
