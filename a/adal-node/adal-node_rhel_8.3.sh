...
# Package	: adal-node
# Version	: 0.1.28
# Source repo	: https://github.com/AzureAD/azure-activedirectory-library-for-nodejs
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=adal-node
PACKAGE_VERSION=0.1.28
PACKAGE_URL=https://github.com/AzureAD/azure-activedirectory-library-for-nodejs
