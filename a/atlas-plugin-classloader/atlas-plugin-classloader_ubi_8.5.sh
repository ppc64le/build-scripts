# ----------------------------------------------------------------------------
#
# Package       : atlas-plugin-classloader
# Version       : branch-2.0
...
PACKAGE_NAME=atlas/plugin-classloader
...
#Install atlas-common as a dependency
cd $WORKDIR/atlas/common
mvn install

#Build and test atlas plugin-classloader
