...
# Version          : aazure-mgmt-iothub_4.0.0
...
PACKAGE_VERSION=${1:-azure-mgmt-iothub_4.0.0}
PACKAGE_URL=https://github.com/Azure/azure-sdk-for-python
PACKAGE_DIR=azure-sdk-for-python/sdk/iothub/azure-mgmt-iothub
...
if ! pytest --ignore=tests/test_mgmt_iothub_test.py ; then
