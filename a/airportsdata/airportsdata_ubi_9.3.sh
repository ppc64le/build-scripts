...
# Version          : v20250224
# Source repo      : https://github.com/mborsetti/airportsdata
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=airportsdata
PACKAGE_VERSION=${1:-v20250224}
PACKAGE_URL=https://github.com/mborsetti/airportsdata
PACKAGE_DIR=airportsdata
