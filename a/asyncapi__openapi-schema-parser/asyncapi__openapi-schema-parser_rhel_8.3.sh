# -----------------------------------------------------------------------------
#
# Package	: @asyncapi/openapi-schema-parser
# Version	: 2.0.1
# Source repo	: https://github.com/asyncapi/openapi-schema-parser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@asyncapi/openapi-schema-parser
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/asyncapi/openapi-schema-parser
