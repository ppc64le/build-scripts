...
# Version			: 2.1.9
# Source repo		: https://github.com/HdrHistogram/HdrHistogram
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="HdrHistogram"
PKG_VERSION=2.1.9
PKG_VERSION_LATEST=2.1.12
LOGS_DIRECTORY=/logs
...
#git checkout -b $PKG_VERSION tags/$PKG_NAME-$PKG_VERSION_LATEST
