...
# Version	: 2.3.8
# Source repo	: https://github.com/webpack-contrib/terser-webpack-plugin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=terser-webpack-plugin
PACKAGE_VERSION=2.3.8
PACKAGE_URL=https://github.com/webpack-contrib/terser-webpack-plugin
