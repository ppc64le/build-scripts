...
# -----------------------------------------------------------------------------
#
# Package          : typing-inspect
# Version          : 0.9.0
# Source repo      : https://github.com/ilevkivskyi/typing_inspect
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/ilevkivskyi/typing_inspect
PACKAGE_DIR=typing-inspect
