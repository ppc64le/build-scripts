...
# Package       : terra
# Version       : 1.7-78
# Source repo   : https://github.com/cran/terra
# Tested on     : UBI:9.3
# Language      : R
# Travis-Check  : True
...
dnf install -y gcc gcc-c++ gcc-gfortran git xz cmake make openssl-devel yum-utils sudo llvm -y
...
dnf install -y geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel libgit2-devel netcdf-devel netcdf
mkdir -p ~/.R
