# -----------------------------------------------------------------------------
#
# Package	: through2-filter
# Version	: 3.0.0
# Source repo	: https://github.com/brycebaril/through2-filter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=through2-filter
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/brycebaril/through2-filter
