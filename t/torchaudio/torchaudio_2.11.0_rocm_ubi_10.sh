...
#
# Usage:
#   ./torchaudio_2.11.0_rocm_ubi_10.sh [--torch-install-mode devpi|local]
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        *)
            ...
            echo "Usage: $0 [--torch-install-mode devpi|local] [--rocm-install-mode rpms|path] [--version v2.11.0]"
            exit 1
            ;;
    esac
done
