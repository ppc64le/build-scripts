...
# Version          : v0.21.0
# Source repo      : https://github.com/tensorflow/addons
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=tensorflow-addons
PACKAGE_VERSION=${1:-v0.21.0}
PACKAGE_URL=https://github.com/tensorflow/addons
PACKAGE_DIR=tensorflow-addons
