...
# Version          : v3.1.0
# Source repo      : https://github.com/pinojs/thread-stream
# Tested on	   : UBI:9.3
# Language         : Javascript
# Travis-Check     : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=thread-stream
PACKAGE_VERSION=${1:-v3.1.0}
PACKAGE_URL=https://github.com/pinojs/thread-stream
