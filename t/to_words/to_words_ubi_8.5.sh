...
# Package               : to_words
# Version               : v1.0.1
# Source repo           : https://github.com/taimur-akhtar/to_words.git
# Tested on             : UBI 8.5
# Language              : Ruby
# Travis-Check          : True
...
export PACKAGE_NAME=to_words
export PACKAGE_URL=https://github.com/taimur-akhtar/to_words.git

if [ -z "$1" ]; then
  export PACKAGE_VERSION=v1.0.1
else
