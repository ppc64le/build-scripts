...
# Apply the patch
echo "------------------------Applying patch-------------------"
wget https://raw.githubusercontent.com.mcas.ms/ppc64le/build-scripts/refs/heads/master/t/tensorflow/tf_2.14.1_fix.patch
...
wget https://raw.githubusercontent.com.mcas.ms/ppc64le/build-scripts/refs/heads/master/t/tensorflow-io-gcs-filesystem/tf-io-gcs-filesystem.patch
...
python setup.py bdist_wheel --data bazel-bin --project tensorflow-io-gcs-filesystem --dist-dir $CURRENT_DIR
