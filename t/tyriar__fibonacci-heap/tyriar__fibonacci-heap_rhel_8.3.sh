# -----------------------------------------------------------------------------
#
# Package	: @tyriar/fibonacci-heap
# Version	: 2.0.7
# Source repo	: https://github.com/gwtw/ts-fibonacci-heap
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@tyriar/fibonacci-heap
PACKAGE_VERSION=2.0.7
PACKAGE_URL=https://github.com/gwtw/ts-fibonacci-heap
