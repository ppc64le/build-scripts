#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : term_csv_export_import
# Version          : 8.x-3.0-alpha2
# Source repo      : https://git.drupalcode.org/project/term_csv_export_import.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=term_csv_export_import
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/term_csv_export_import.git
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-3.0-alpha2}
