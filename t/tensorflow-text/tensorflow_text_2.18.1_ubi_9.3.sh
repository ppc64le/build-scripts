...
wget https://raw.githubusercontent.com/ppc64le/build-scripts/refs/heads/python-ecosystem/t/tensorflow-text/0001-update-pins-and-fix-build-failures.patch
