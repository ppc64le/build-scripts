...
#       (CPU-only build). numpy 2.5.1 is sourced from the same index
#       as there is no ppc64le numpy wheel on PyPI.
...
# ---------------------------------------------------------------------------
# Install numpy 2.5.1 from IBM DeveloperFirst index (no ppc64le wheel on PyPI)
# ---------------------------------------------------------------------------
