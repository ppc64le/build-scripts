...
# Version          : v0.23.5
# Source repo      : https://github.com/tree-sitter/tree-sitter-java
# Tested on     : UBI:9.3
# Language      : Python
# Ci-Check  : True
...
PACKAGE_VERSION=${1:-v0.23.5}
PACKAGE_URL=https://github.com/tree-sitter/tree-sitter-java
PACKAGE_DIR=tree-sitter-java
