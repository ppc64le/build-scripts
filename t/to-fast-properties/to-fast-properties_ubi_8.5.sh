...
# Source repo      : https://github.com/sindresorhus/to-fast-properties
...
PACKAGE_NAME=to-fast-properties
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-v2.0.0}
PACKAGE_URL=https://github.com/sindresorhus/to-fast-properties.git
