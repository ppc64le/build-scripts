...
# -----------------------------------------------------------------------------
#
# Package	    : theme-one-dark
# Version	    : 6.1.2
# Source repo	    : https://github.com/codemirror/theme-one-dark
# Tested on	    : UBI 9.3
# Language          : Node
# Ci-Check      : True
...
PACKAGE_NAME=theme-one-dark
PACKAGE_VERSION=${1:-6.1.2}
PACKAGE_URL=https://github.com/codemirror/theme-one-dark
