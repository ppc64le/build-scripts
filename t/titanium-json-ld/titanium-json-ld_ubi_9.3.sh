...
# -----------------------------------------------------------------------------
#
# Package          : titanium-json-ld
# Version          : v1.4.1
# Source repo      : https://github.com/filip26/titanium-json-ld
# Tested on        : UBI:9.3
# Language         : Java
# Travis-Check     : True
...
PACKAGE_NAME=titanium-json-ld
PACKAGE_URL=https://github.com/filip26/titanium-json-ld
