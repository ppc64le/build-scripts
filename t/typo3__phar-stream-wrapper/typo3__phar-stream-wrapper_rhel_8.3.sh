# -----------------------------------------------------------------------------
#
# Package	: typo3/phar-stream-wrapper
# Version	: 3.1.4
# Source repo	: https://github.com/TYPO3/phar-stream-wrapper
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=typo3/phar-stream-wrapper
PACKAGE_VERSION=3.1.4
PACKAGE_URL=https://github.com/TYPO3/phar-stream-wrapper
