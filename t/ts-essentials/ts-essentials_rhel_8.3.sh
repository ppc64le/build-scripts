# -----------------------------------------------------------------------------
#
# Package	: ts-essentials
# Version	: 2.0.12
# Source repo	: https://github.com/krzkaczor/ts-essentials
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=ts-essentials
PACKAGE_VERSION=2.0.12
PACKAGE_URL=https://github.com/krzkaczor/ts-essentials
