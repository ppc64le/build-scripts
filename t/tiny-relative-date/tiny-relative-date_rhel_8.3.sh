# -----------------------------------------------------------------------------
#
# Package	: tiny-relative-date
# Version	: 1.3.0
# Source repo	: https://github.com/wildlyinaccurate/relative-date
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=tiny-relative-date
PACKAGE_VERSION=1.3.0
PACKAGE_URL=https://github.com/wildlyinaccurate/relative-date
