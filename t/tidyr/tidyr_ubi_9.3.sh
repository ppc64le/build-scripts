...
# Package          : tidyr
# Version          : 1.3.1
# Source repo      : https://github.com/cran/tidyr.git
# Tested on        : UBI:9.3
# Language         : R
# Travis-Check     : True
...
PACKAGE_URL=https://github.com/cran/tidyr.git

#install dependencies
dnf install -y gcc gcc-c++ gcc-gfortran git wget xz cmake make yum-utils sudo llvm -y
