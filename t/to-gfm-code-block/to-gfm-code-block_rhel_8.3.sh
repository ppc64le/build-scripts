# -----------------------------------------------------------------------------
#
# Package	: to-gfm-code-block
# Version	: 0.1.1
# Source repo	: https://github.com/jonschlinkert/to-gfm-code-block
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=to-gfm-code-block
PACKAGE_VERSION=0.1.1
PACKAGE_URL=https://github.com/jonschlinkert/to-gfm-code-block
