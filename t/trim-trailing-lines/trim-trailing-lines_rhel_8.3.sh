# -----------------------------------------------------------------------------
#
# Package	: trim-trailing-lines
# Version	: 1.1.4
# Source repo	: https://github.com/wooorm/trim-trailing-lines
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=trim-trailing-lines
PACKAGE_VERSION=1.1.4
PACKAGE_URL=https://github.com/wooorm/trim-trailing-lines
