...
cd $CURRENT_DIR
pip install pytest dill pyyaml cloudpickle pydub tensorflow_docs google-auth gcsfs conllu bs4 pretty_midi tifffile tldextract langdetect lxml mwparserfromhell nltk==3.8.1
...
pip install gcld3 --no-cache-dir --use-pep517
...
pip install setuptools-scm Cython numpy==2.0.2
...
pip install "gcsfs==2023.6.0" "google-auth==2.20.0" "datasets==2.14.0"


#installing dependency for test
