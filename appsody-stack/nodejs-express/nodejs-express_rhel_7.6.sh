# ----------------------------------------------------------------------------
#
# Package	: appsody/stacks/incubator/nodejs-express
# Version	: latest (0.4.2)
# Source repo	: https://github.com/appsody/stacks/tree/master/incubator/nodejs-express
# Tested on	: rhel_7.6
...
echo "Appsody stack - nodejs-express is validated !"