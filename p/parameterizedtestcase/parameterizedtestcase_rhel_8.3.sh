# -----------------------------------------------------------------------------
#
# Package	: parameterizedtestcase
# Version	: 0.1.0
# Source repo	: https://github.com/msabramo/python_unittest_parameterized_test_case
# Tested on	: RHEL 8.3
...
PACKAGE_URL=https://github.com/msabramo/python_unittest_parameterized_test_case
