...
# Version          : 1.1.20
# Source repo      : https://github.com/mglaman/phpstan-drupal
# Tested on        : UBI 8.5
# Language         : PHP
# Ci-Check     : True
...
# Variables
PACKAGE_NAME=phpstan-drupal
PACKAGE_URL=https://github.com/mglaman/phpstan-drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-1.1.20}
