...
# -----------------------------------------------------------------------------
#
# Package          : python-flatbuffers
# Version          : 24.12.23
# Source repo      : https://pypi.io/packages/source/f/flatbuffers/flatbuffers-24.12.23.tar.gz
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=python-flatbuffers
PACKAGE_VERSION=${1:-24.12.23}
PACKAGE_URL=https://pypi.io/packages/source/f/flatbuffers/flatbuffers-24.12.23.tar.gz
PACKAGE_DIR=python-flatbuffers
