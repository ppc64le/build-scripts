...
#
# Package          : pycparser
# Version          : release_v2.22
# Source repo      : https://github.com/eliben/pycparser
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-release_v2.22}
PACKAGE_URL=https://github.com/eliben/pycparser
PACKAGE_DIR=pycparser
