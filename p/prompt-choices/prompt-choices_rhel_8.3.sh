# -----------------------------------------------------------------------------
#
# Package	: prompt-choices
# Version	: 4.1.0
# Source repo	: https://github.com/enquirer/prompt-choices
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=prompt-choices
PACKAGE_VERSION=4.1.0
PACKAGE_URL=https://github.com/enquirer/prompt-choices
