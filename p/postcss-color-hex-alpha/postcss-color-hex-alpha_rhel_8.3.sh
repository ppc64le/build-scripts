...
# Version	: 5.0.3
# Source repo	: https://github.com/postcss/postcss-color-hex-alpha
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-color-hex-alpha
PACKAGE_VERSION=5.0.3
PACKAGE_URL=https://github.com/postcss/postcss-color-hex-alpha
