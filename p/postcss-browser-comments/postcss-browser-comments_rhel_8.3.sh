# -----------------------------------------------------------------------------
#
# Package	: postcss-browser-comments
# Version	: 3.0.0
# Source repo	: https://github.com/csstools/postcss-browser-comments
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-browser-comments
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/csstools/postcss-browser-comments
