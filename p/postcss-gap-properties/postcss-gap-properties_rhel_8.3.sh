# -----------------------------------------------------------------------------
#
# Package	: postcss-gap-properties
# Version	: 2.0.0
# Source repo	: https://github.com/jonathantneal/postcss-gap-properties
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-gap-properties
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/jonathantneal/postcss-gap-properties
