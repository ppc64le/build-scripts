...
# -----------------------------------------------------------------------------
#
# Package          : presto-python-client
# Version          : 0.8.4
# Source repo      : https://github.com/prestodb/presto-python-client
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-0.8.4}
PACKAGE_URL=https://github.com/prestodb/presto-python-client
PACKAGE_DIR=presto-python-client

# Install dependencies
yum install -y git python3 python3-devel.ppc64le gcc-toolset-13 make wget sudo cmake openssl-devel krb5-devel
pip3 install pytest
...
echo "Running pytest..."
(python3 -m pytest tests) && test_status=0 || test_status=$?
