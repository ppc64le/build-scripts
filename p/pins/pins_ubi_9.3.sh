...
# Package       : pins
# Version       : 1.3.0
# Source repo   : https://github.com/cran/pins
# Tested on     : UBI:9.3
# Language      : R
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/cran/pins
...
yum install -y openssl-devel libsodium libsodium-devel libarchive-devel
...
R -e "install.packages('ellipsis', dependencies = TRUE, repos = 'http://cran.rstudio.com/')"
...
#skipping test as it is in parity with intel
