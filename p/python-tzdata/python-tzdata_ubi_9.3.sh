...
# Version          : 2024.2
# Source repo      : https://pypi.io/packages/source/t/tzdata/tzdata-2024.2.tar.gz
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=python-tzdata
PACKAGE_VERSION=${1:-2024.2}
PACKAGE_URL=https://pypi.io/packages/source/t/tzdata/tzdata-2024.2.tar.gz
PACKAGE_DIR=python-tzdata
