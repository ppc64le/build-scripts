# -----------------------------------------------------------------------------
#
# Package	: pelletier/go-buffruneio
# Version	: 0.2.0
# Source repo	: https://github.com/pelletier/go-buffruneio
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=pelletier/go-buffruneio
PACKAGE_VERSION=0.2.0
PACKAGE_URL=https://github.com/pelletier/go-buffruneio
