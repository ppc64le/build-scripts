...
# Version          : 1.5.5
# Source repo      : https://github.com/mdbootstrap/perfect-scrollbar
...
PACKAGE_NAME=perfect-scrollbar
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-1.5.5}
PACKAGE_URL=https://github.com/mdbootstrap/perfect-scrollbar.git
