# -----------------------------------------------------------------------------
#
# Package	: prompt-question
# Version	: 5.0.2
# Source repo	: https://github.com/enquirer/prompt-question
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=prompt-question
PACKAGE_VERSION=5.0.2
PACKAGE_URL=https://github.com/enquirer/prompt-question
