...
# -----------------------------------------------------------------------------
#
# Package	    : promise-pool
# Version	    : v3.2.0
# Source repo	    : https://github.com/supercharge/promise-pool
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=promise-pool
PACKAGE_VERSION=${1:-v3.2.0}
PACKAGE_URL=https://github.com/supercharge/promise-pool
