# -----------------------------------------------------------------------------
#
# Package	: paged-request
# Version	: 2.0.2
# Source repo	: https://github.com/jonschlinkert/paged-request
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=paged-request
PACKAGE_VERSION=2.0.2
PACKAGE_URL=https://github.com/jonschlinkert/paged-request
