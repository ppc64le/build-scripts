# -----------------------------------------------------------------------------
#
# Package	: phpunit/php-token-stream
# Version	: 3.1.2
# Source repo	: https://github.com/sebastianbergmann/php-token-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=phpunit/php-token-stream
PACKAGE_VERSION=3.1.2
PACKAGE_URL=https://github.com/sebastianbergmann/php-token-stream
