...
# Version	: 4.0.0
# Source repo	: https://github.com/postcss/postcss-selector-matches
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-selector-matches
PACKAGE_VERSION=4.0.0
PACKAGE_URL=https://github.com/postcss/postcss-selector-matches
