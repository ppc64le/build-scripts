...
# Version	: 5.1.2
# Source repo	: https://github.com/postcss/postcss-custom-selectors
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-custom-selectors
PACKAGE_VERSION=5.1.2
PACKAGE_URL=https://github.com/postcss/postcss-custom-selectors
