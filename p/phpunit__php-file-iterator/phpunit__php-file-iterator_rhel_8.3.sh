...
# Version	: 2.0.1
# Source repo	: https://github.com/sebastianbergmann/php-file-iterator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=phpunit/php-file-iterator
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/sebastianbergmann/php-file-iterator
