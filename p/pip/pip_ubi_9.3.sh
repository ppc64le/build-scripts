...
# Package       : pip
# Version       : 23.3
# Source repo   : https://github.com/pypa/pip
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=pip
PACKAGE_VERSION=${1:-"23.3"}
PACKAGE_URL=https://github.com/pypa/pip.git
...
pip3 install pytest installer scripttest virtualenv werkzeug tomli_w freezegun nox
...
if ! nox -s test-$PYTHON_VERSION -- -m unit --verbose --numprocesses auto --showlocals ; then
