...
# cp "$POLARSCOMPAT_WHEEL" "$BUILD_HOME/"
...
# uv pip install $POLARSCOMPAT_WHEEL $PYPOLARS_WHEEL --system
# uv pip uninstall polars-runtime-32 polars-runtime-64 --system
# cd py-polars
