...
# -----------------------------------------------------------------------------
#
# Package          : pytest-durations
# Version          : v1.4.0
# Source repo      : https://github.com/blake-r/pytest-durations
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=pytest-durations
PACKAGE_VERSION=${1:-v1.4.0}
PACKAGE_URL=https://github.com/blake-r/pytest-durations
PACKAGE_DIR=pytest-durations
