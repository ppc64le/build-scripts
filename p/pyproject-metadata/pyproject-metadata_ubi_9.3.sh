...
# -----------------------------------------------------------------------------
#
# Package          : pyproject-metadata
# Version          : 0.9.1
# Source repo      : https://github.com/pypa/pyproject-metadata
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/pypa/pyproject-metadata
PACKAGE_DIR=pyproject-metadata
