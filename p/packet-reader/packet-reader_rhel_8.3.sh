# -----------------------------------------------------------------------------
#
# Package	: packet-reader
# Version	: 1.0.0
# Source repo	: https://github.com/brianc/node-packet-reader
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=packet-reader
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/brianc/node-packet-reader
