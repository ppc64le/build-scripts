# -----------------------------------------------------------------------------
#
# Package	: postcss-nesting
# Version	: 7.0.1
# Source repo	: https://github.com/csstools/postcss-nesting
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-nesting
PACKAGE_VERSION=7.0.1
PACKAGE_URL=https://github.com/csstools/postcss-nesting
