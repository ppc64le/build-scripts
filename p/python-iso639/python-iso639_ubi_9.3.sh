...
# -----------------------------------------------------------------------------
#
# Package          : python-iso639
# Version          : v2025.2.18
# Source repo      : https://github.com/jacksonllee/iso639
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=python-iso639
PACKAGE_VERSION=${1:-v2025.2.18}
PACKAGE_URL=https://github.com/jacksonllee/iso639
PACKAGE_DIR=python-iso639
