# -----------------------------------------------------------------------------
#
# Package	: postcss-color-mod-function
# Version	: 3.0.3
# Source repo	: https://github.com/jonathantneal/postcss-color-mod-function
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-color-mod-function
PACKAGE_VERSION=3.0.3
PACKAGE_URL=https://github.com/jonathantneal/postcss-color-mod-function
