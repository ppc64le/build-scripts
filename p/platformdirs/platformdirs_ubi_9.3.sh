...
# Version        : 2.5.2
# Source repo    : https://github.com/tox-dev/platformdirs.git
# Tested on      : UBI 9.3
# Language       : Python
# Travis-Check   : True
...
PACKAGE_VERSION=${1:-2.5.2}
PACKAGE_URL=https://github.com/tox-dev/platformdirs.git
...
pip3 install pytest pytest_mock appdirs
