...
# Note: Python packages are installed by the GHA wrapper script, not here
yum install -y git make wget pkgconfig atlas
...
python3.12 -m pip install openblas==0.3.33+ppc64le1 \
  --prefer-binary \
