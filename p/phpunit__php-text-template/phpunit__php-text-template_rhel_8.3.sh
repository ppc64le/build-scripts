...
# Version	: 1.2.1
# Source repo	: https://github.com/sebastianbergmann/php-text-template
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=phpunit/php-text-template
PACKAGE_VERSION=1.2.1
PACKAGE_URL=https://github.com/sebastianbergmann/php-text-template
