...
# Version	: 3.0.0
# Source repo	: https://github.com/css-modules/postcss-modules-values
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-modules-values
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/css-modules/postcss-modules-values
