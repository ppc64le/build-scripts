...
# Version          : 3.0.50
# Source repo      : https://pypi.io/packages/source/p/prompt_toolkit/prompt_toolkit-3.0.50.tar.gz
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-3.0.50}
PACKAGE_URL=https://pypi.io/packages/source/p/prompt_toolkit/prompt_toolkit-3.0.50.tar.gz
PACKAGE_DIR=prompt_toolkit
