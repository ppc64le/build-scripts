...
# ------------ Applying patch ---------------
wget https://raw.githubusercontent.com/ppc64le/build-scripts/refs/heads/master/p/pyav/pyav-cython-changes.patch
git apply pyav-cython-changes.patch
