# -----------------------------------------------------------------------------
#
# Package	: postcss-image-set-function
# Version	: 3.0.1
# Source repo	: https://github.com/jonathantneal/postcss-image-set-function
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-image-set-function
PACKAGE_VERSION=3.0.1
PACKAGE_URL=https://github.com/jonathantneal/postcss-image-set-function
