...
# Package       : pooch
# Version       : 1.4.0
# Source repo   : https://github.com/fatiando/pooch
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/fatiando/pooch.git
...
#skipping one test as it fails on x86 as well
if ! make test PYTEST_ARGS="--cov-config=../.coveragerc --cov-report=term-missing --cov=pooch --doctest-modules -v --pyargs pooch -k 'not test_check_availability_on_ftp'" ; then
