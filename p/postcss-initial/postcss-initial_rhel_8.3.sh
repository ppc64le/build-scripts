# -----------------------------------------------------------------------------
#
# Package	: postcss-initial
# Version	: 3.0.4
# Source repo	: https://github.com/maximkoretskiy/postcss-initial
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-initial
PACKAGE_VERSION=3.0.4
PACKAGE_URL=https://github.com/maximkoretskiy/postcss-initial
