...
# Version          : 0.4.27
# Source repo      : http://github.com/ahupp/python-magic
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-0.4.27}
PACKAGE_URL=http://github.com/ahupp/python-magic
PACKAGE_DIR=python-magic
