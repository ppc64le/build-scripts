# -----------------------------------------------------------------------------
#
# Package	: postcss-page-break
# Version	: 2.0.0
# Source repo	: https://github.com/shrpne/postcss-page-break
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-page-break
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/shrpne/postcss-page-break
