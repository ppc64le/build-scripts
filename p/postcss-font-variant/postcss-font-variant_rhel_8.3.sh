# -----------------------------------------------------------------------------
#
# Package	: postcss-font-variant
# Version	: 4.0.1
# Source repo	: https://github.com/postcss/postcss-font-variant
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-font-variant
PACKAGE_VERSION=4.0.1
PACKAGE_URL=https://github.com/postcss/postcss-font-variant
