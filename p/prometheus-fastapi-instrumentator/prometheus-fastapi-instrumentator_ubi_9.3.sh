...
# Version          : v7.1.0
# Source repo      : https://github.com/trallnag/prometheus-fastapi-instrumentator
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=prometheus-fastapi-instrumentator
PACKAGE_VERSION=${1:-v7.1.0}
PACKAGE_URL=https://github.com/trallnag/prometheus-fastapi-instrumentator
PACKAGE_DIR=prometheus-fastapi-instrumentator
