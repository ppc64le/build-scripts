# -----------------------------------------------------------------------------
#
# Package	: postcss-color-functional-notation
# Version	: 2.0.1
# Source repo	: https://github.com/csstools/postcss-color-functional-notation
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-color-functional-notation
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/csstools/postcss-color-functional-notation
