# -----------------------------------------------------------------------------
#
# Package	: postcss-env-function
# Version	: 2.0.2
# Source repo	: https://github.com/csstools/postcss-env-function
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-env-function
PACKAGE_VERSION=2.0.2
PACKAGE_URL=https://github.com/csstools/postcss-env-function
