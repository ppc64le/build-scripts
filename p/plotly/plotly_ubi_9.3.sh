...
# Package          : plotly
# Version          : 4.10.4
# Source repo      : https://github.com/cran/plotly.git
# Tested on        : UBI:9.3
# Language         : R
# Travis-Check     : True
...
PACKAGE_URL=https://github.com/cran/plotly.git
...
dnf install -y geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel libgit2-devel libcurl-devel libarchive-devel librsvg2-devel openssl-devel
