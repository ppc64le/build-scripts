# -----------------------------------------------------------------------------
#
# Package	: postcss-double-position-gradients
# Version	: 1.0.0
# Source repo	: https://github.com/csstools/postcss-double-position-gradients
# Tested on	: RHEL 8.3
...
PACKAGE_URL=https://github.com/csstools/postcss-double-position-gradients
