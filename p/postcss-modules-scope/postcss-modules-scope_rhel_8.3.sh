...
# Version	: 2.2.0
# Source repo	: https://github.com/css-modules/postcss-modules-scope
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-modules-scope
PACKAGE_VERSION=2.2.0
PACKAGE_URL=https://github.com/css-modules/postcss-modules-scope
