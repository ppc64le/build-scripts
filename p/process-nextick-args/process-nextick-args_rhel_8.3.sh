...
# Version	: 2.0.0
# Source repo	: https://github.com/calvinmetcalf/process-nextick-args
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=process-nextick-args
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/calvinmetcalf/process-nextick-args
