# -----------------------------------------------------------------------------
#
# Package	: prompt-password
# Version	: 1.2.0
# Source repo	: https://github.com/enquirer/prompt-password
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=prompt-password
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/enquirer/prompt-password
