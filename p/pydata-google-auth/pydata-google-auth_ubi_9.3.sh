...
# -----------------------------------------------------------------------------
#
# Package          : pydata-google-auth
# Version          : 1.9.1
# Source repo      : https://github.com/pydata/pydata-google-auth
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/pydata/pydata-google-auth
PACKAGE_DIR=pydata-google-auth
