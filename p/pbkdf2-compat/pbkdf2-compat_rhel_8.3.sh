# -----------------------------------------------------------------------------
#
# Package	: pbkdf2-compat
# Version	: 2.0.1
# Source repo	: https://github.com/crypto-browserify/pbkdf2-compat
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=pbkdf2-compat
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/crypto-browserify/pbkdf2-compat
