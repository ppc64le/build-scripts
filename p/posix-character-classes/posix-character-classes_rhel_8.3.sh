...
# Version	: 0.1.1
# Source repo	: https://github.com/jonschlinkert/posix-character-classes
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=posix-character-classes
PACKAGE_VERSION=0.1.1
PACKAGE_URL=https://github.com/jonschlinkert/posix-character-classes
