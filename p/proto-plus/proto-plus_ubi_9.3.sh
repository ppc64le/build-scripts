...
# Package          : proto-plus
# Version          : v1.26.1
# Source repo      : https://github.com/googleapis/proto-plus-python
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v1.26.1}
PACKAGE_URL=https://github.com/googleapis/proto-plus-python
PACKAGE_DIR=proto-plus
