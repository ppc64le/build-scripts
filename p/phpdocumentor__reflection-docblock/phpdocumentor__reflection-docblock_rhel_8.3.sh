...
# Version	: 4.3.4
# Source repo	: https://github.com/phpDocumentor/ReflectionDocBlock
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=phpdocumentor/reflection-docblock
PACKAGE_VERSION=4.3.4
PACKAGE_URL=https://github.com/phpDocumentor/ReflectionDocBlock
