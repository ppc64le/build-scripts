# -----------------------------------------------------------------------------
#
# Package	: pause-stream
# Version	: 0.0.11
# Source repo	: https://github.com/dominictarr/pause-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=pause-stream
PACKAGE_VERSION=0.0.11
PACKAGE_URL=https://github.com/dominictarr/pause-stream
