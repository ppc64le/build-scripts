...
# Version	: 6.0.0
# Source repo	: https://github.com/jonathantneal/postcss-pseudo-class-any-link
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-pseudo-class-any-link
PACKAGE_VERSION=6.0.0
PACKAGE_URL=https://github.com/jonathantneal/postcss-pseudo-class-any-link
