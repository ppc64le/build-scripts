# -----------------------------------------------------------------------------
#
# Package	: postcss-custom-properties
# Version	: 8.0.11
# Source repo	: https://github.com/postcss/postcss-custom-properties
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-custom-properties
PACKAGE_VERSION=8.0.11
PACKAGE_URL=https://github.com/postcss/postcss-custom-properties
