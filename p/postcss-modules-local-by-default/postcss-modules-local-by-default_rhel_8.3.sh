...
# Version	: 3.0.3
# Source repo	: https://github.com/css-modules/postcss-modules-local-by-default
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-modules-local-by-default
PACKAGE_VERSION=3.0.3
PACKAGE_URL=https://github.com/css-modules/postcss-modules-local-by-default
