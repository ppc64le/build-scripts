# -----------------------------------------------------------------------------
#
# Package	: postcss-logical
# Version	: 3.0.0
# Source repo	: https://github.com/csstools/postcss-logical
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-logical
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/csstools/postcss-logical
