# -----------------------------------------------------------------------------
#
# Package	: pear/pear-core-minimal
# Version	: 1.10.10
# Source repo	: https://github.com/pear/pear-core-minimal
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=pear/pear-core-minimal
PACKAGE_VERSION=1.10.10
PACKAGE_URL=https://github.com/pear/pear-core-minimal
