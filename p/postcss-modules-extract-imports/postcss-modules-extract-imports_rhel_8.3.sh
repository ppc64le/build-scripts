...
# Version	: 2.0.0
# Source repo	: https://github.com/css-modules/postcss-modules-extract-imports
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-modules-extract-imports
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/css-modules/postcss-modules-extract-imports
