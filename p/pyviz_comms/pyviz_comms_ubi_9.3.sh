...
# Package          : pyviz_comms
# Version          : v3.0.4
# Source repo      : https://github.com/holoviz/pyviz_comms
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=pyviz_comms
PACKAGE_VERSION=${1:-v3.0.4}
PACKAGE_URL=https://github.com/holoviz/pyviz_comms
PACKAGE_DIR=pyviz_comms
