...
# Version          : v2.0.0
# Source repo      : https://github.com/pinojs/pino-abstract-transport.git
# Tested on        : UBI:9.3
# Language         : JavaScript
# Travis-Check     : True
...
#install variable
PACKAGE_NAME=pino-abstract-transport
PACKAGE_VERSION=${1:-v2.0.0}
PACKAGE_URL=https://github.com/pinojs/pino-abstract-transport.git
