# -----------------------------------------------------------------------------
#
# Package	: postcss-focus-within
# Version	: 3.0.0
# Source repo	: https://github.com/csstools/postcss-focus-within
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-focus-within
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/csstools/postcss-focus-within
