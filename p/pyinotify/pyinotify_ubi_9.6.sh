...
# Package          : pyinotify
# Version          : 0.9.6
# Source repo      : http://github.com/seb-m/pyinotify
# Tested on     : UBI:9.6
# Language      : Python
# Ci-Check  : True
...
PACKAGE_URL=http://github.com/seb-m/pyinotify
PACKAGE_DIR=pyinotify
...
# No test cases found in the repository; skipping test execution step
