# -----------------------------------------------------------------------------
#
# Package	: postcss-custom-media
# Version	: 7.0.8
# Source repo	: https://github.com/postcss/postcss-custom-media
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-custom-media
PACKAGE_VERSION=7.0.8
PACKAGE_URL=https://github.com/postcss/postcss-custom-media
