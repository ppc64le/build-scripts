...
#
# Package       : parseqs
# Version       : master(4d037fc)
# Source        : https://github.com/galkn/querystring.git
# Tested on     : RHEL 7.6
...
git clone https://github.com/galkn/querystring.git && cd querystring
