# -----------------------------------------------------------------------------
#
# Package	: postcss-dir-pseudo-class
# Version	: 5.0.0
# Source repo	: https://github.com/jonathantneal/postcss-dir-pseudo-class
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-dir-pseudo-class
PACKAGE_VERSION=5.0.0
PACKAGE_URL=https://github.com/jonathantneal/postcss-dir-pseudo-class
