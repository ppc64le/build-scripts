# -----------------------------------------------------------------------------
#
# Package	: postcss-focus-visible
# Version	: 4.0.0
# Source repo	: https://github.com/csstools/postcss-focus-visible
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=postcss-focus-visible
PACKAGE_VERSION=4.0.0
PACKAGE_URL=https://github.com/csstools/postcss-focus-visible
