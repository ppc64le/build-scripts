...
# Version	: 2.2
# Source repo	: https://github.com/phpDocumentor/ReflectionCommon
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=phpdocumentor/reflection-common
PACKAGE_VERSION=2.2
PACKAGE_URL=https://github.com/phpDocumentor/ReflectionCommon
