...
# Variables
PACKAGE_NAME=cssnano
PACKAGE_VERSION=v1.0.1
PACKAGE_URL="https://github.com/cssnano/cssnano.git"

echo "Usage: $0 [r<PKG_VERSION>]"
echo "       PKG_VERSION is an optional paramater whose default value is v1.0.1"
PKG_VERSION="${1:-$PKG_VERSION}"

#install dependencies
apt update && apt install -y git wget  unzip python3 
...
if ! npm install postcss-reduce-initial --save; then
...
cd /home/tester/$PACKAGE_NAME
if ! npm install postcss-reduce-initial test --save; then
