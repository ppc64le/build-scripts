...
# -----------------------------------------------------------------------------
#
# Package          : parameters-validation
# Version          : 1.2.0
# Source repo      : https://github.com/allrod5/parameters-validation
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/allrod5/parameters-validation
PACKAGE_DIR=parameters-validation
