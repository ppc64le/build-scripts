...
# variables
PKG_NAME="jakarta.activation-api"
PKG_VERSION=1.2.1
PKG_VERSION_LATEST=1.2.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/eclipse-ee4j/jaf.git"
...
git checkout -b $PKG_VERSION tags/$PKG_VERSION_LATEST
