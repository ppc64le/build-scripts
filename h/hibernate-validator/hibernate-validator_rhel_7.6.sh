...
# variables
PKG_NAME="hibernate-validator"
PKG_VERSION=6.1.0
PKG_VERSION_LATEST=6.1.3
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/hibernate/hibernate-validator.git"
...
git checkout -b $PKG_VERSION tags/$PKG_VERSION.Final
...
git checkout -b $PKG_VERSION_LATEST tags/$PKG_VERSION_LATEST.Final
