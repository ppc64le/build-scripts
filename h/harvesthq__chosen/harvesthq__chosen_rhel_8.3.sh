# -----------------------------------------------------------------------------
#
# Package	: harvesthq/chosen
# Version	: 1.8.7
# Source repo	: https://github.com/harvesthq/chosen-package
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=harvesthq/chosen
PACKAGE_VERSION=1.8.7
PACKAGE_URL=https://github.com/harvesthq/chosen-package
