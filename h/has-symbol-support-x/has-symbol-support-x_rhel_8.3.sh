# -----------------------------------------------------------------------------
#
# Package	: has-symbol-support-x
# Version	: 1.4.2
# Source repo	: https://github.com/Xotic750/has-symbol-support-x
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=has-symbol-support-x
PACKAGE_VERSION=1.4.2
PACKAGE_URL=https://github.com/Xotic750/has-symbol-support-x
