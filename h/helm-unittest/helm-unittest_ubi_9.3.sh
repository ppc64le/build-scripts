...
# -----------------------------------------------------------------------------
#
# Package       : helm-unittest
# Version       : ${1:-v0.5.2}
# Source repo   : https://github.com/helm-unittest/helm-unittest
# Tested on     : UBI:9.3 
# Language      : GO
# Ci-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=helm-unittest
PACKAGE_VERSION=v0.5.2
PACKAGE_URL=https://github.com/helm-unittest/helm-unittest
