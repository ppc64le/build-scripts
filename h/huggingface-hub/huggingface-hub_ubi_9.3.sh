...
# Version          : v0.31.1
# Source repo      : https://github.com/huggingface/huggingface_hub
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v0.31.1}
PACKAGE_URL=https://github.com/huggingface/huggingface_hub
PACKAGE_DIR=huggingface-hub
