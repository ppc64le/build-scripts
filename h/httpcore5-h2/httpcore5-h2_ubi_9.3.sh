...
# ----------------------------------------------------------------------------
#
# Package       : httpcore5-h2
# Version       : rel/v5.2.1
# Source repo   : https://github.com/apache/httpcomponents-core 
# Tested on     : UBI: 9.3
# Language      : Java
# Travis-Check  : True
...
set -e
PACKAGE_NAME=httpcore5-h2
PACKAGE_URL=https://github.com/apache/httpcomponents-core.git
PACKAGE_VERSION=${1:-rel/v5.2.1}
