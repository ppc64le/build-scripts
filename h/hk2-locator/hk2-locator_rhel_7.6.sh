...
#
# Package			: hk2-locator
# Version			: 2.5.0-b32, 2.5.0-b62
# Source repo		: https://github.com/javaee/hk2
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="hk2-locator"
PKG_VERSION="2.5.0-b32"
PKG_VERSION_LATEST="2.5.0-b62"
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/javaee/hk2.git"
...
cd hk2-locator/
mvn -Dgpg.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST.txt
...
#cd $PKG_NAME-master/
#cd hk2-locator/
#mvn -Dgpg.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME.txt
