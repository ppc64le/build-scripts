...
# Version       : high-scale-lib-parent-1.1.4
# Source repo   : https://github.com/stephenc/high-scale-lib 
# Tested on     : UBI: 9.3
# Language      : Java
# Ci-Check  : True
...
set -e
PACKAGE_NAME=high-scale-lib
PACKAGE_URL=https://github.com/stephenc/high-scale-lib.git
PACKAGE_VERSION=${1:-high-scale-lib-parent-1.1.4}
