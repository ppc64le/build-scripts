# -----------------------------------------------------------------------------
#
# Package	: hide-powered-by
# Version	: 1.0.0
# Source repo	: https://github.com/helmetjs/hide-powered-by
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=hide-powered-by
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/helmetjs/hide-powered-by
