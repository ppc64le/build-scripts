# -----------------------------------------------------------------------------
#
# Package	: html-parse-stringify
# Version	: 3.0.1
# Source repo	: https://github.com/henrikjoreteg/html-parse-stringify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=html-parse-stringify
PACKAGE_VERSION=3.0.1
PACKAGE_URL=https://github.com/henrikjoreteg/html-parse-stringify
