# -----------------------------------------------------------------------------
#
# Package	: helmet-crossdomain
# Version	: 0.3.0
# Source repo	: https://github.com/helmetjs/crossdomain
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=helmet-crossdomain
PACKAGE_VERSION=0.3.0
PACKAGE_URL=https://github.com/helmetjs/crossdomain
