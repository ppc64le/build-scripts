# -----------------------------------------------------------------------------
#
# Package	: has-to-string-tag-x
# Version	: 1.4.1
# Source repo	: https://github.com/Xotic750/has-to-string-tag-x
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=has-to-string-tag-x
PACKAGE_VERSION=1.4.1
PACKAGE_URL=https://github.com/Xotic750/has-to-string-tag-x
