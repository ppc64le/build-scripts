...
# Version	: 0.14.3
# Source repo	: https://github.com/remarkablemark/html-react-parser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=html-react-parser
PACKAGE_VERSION=0.14.3
PACKAGE_URL=https://github.com/remarkablemark/html-react-parser
