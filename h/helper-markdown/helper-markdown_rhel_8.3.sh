# -----------------------------------------------------------------------------
#
# Package	: helper-markdown
# Version	: 0.2.2
# Source repo	: https://github.com/helpers/helper-markdown
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=helper-markdown
PACKAGE_VERSION=0.2.2
PACKAGE_URL=https://github.com/helpers/helper-markdown
