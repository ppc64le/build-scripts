# -----------------------------------------------------------------------------
#
# Package	: unicode-match-property-value-ecmascript
# Version	: 1.2.0
# Source repo	: https://github.com/mathiasbynens/unicode-match-property-value-ecmascript
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=unicode-match-property-value-ecmascript
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/mathiasbynens/unicode-match-property-value-ecmascript
