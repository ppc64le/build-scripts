...
# -----------------------------------------------------------------------------
#
# Package          : unist-util-is
# Version          : 6.0.0
# Source repo      : https://github.com/syntax-tree/unist-util-is
# Tested on	: UBI 9.3
# Language      : Node
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=unist-util-is
PACKAGE_VERSION=${1:-6.0.0}
PACKAGE_URL=https://github.com/syntax-tree/unist-util-is
