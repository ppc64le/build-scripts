...
# Version	: 1.3.0
# Source repo	: https://github.com/janlelis/unicode-display_width
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=unicode-display_width
PACKAGE_VERSION=1.3.0
PACKAGE_URL=https://github.com/janlelis/unicode-display_width
