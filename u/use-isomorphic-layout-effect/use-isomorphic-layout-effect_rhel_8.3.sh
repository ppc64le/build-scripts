...
# Version	: 1.1.1
# Source repo	: https://github.com/Andarist/use-isomorphic-layout-effect
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=use-isomorphic-layout-effect
PACKAGE_VERSION=1.1.1
PACKAGE_URL=https://github.com/Andarist/use-isomorphic-layout-effect
