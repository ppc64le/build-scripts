# -----------------------------------------------------------------------------
#
# Package	: use-composed-ref
# Version	: 1.1.0
# Source repo	: https://github.com/Andarist/use-composed-ref
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=use-composed-ref
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/Andarist/use-composed-ref
