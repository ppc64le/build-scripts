...
# -----------------------------------------------------------------------------
#
# Package          : unist-util-visit
# Version          : 5.0.0
# Source repo      : https://github.com/syntax-tree/unist-util-visit
# Tested on	: UBI 9.3
# Language      : Node
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=unist-util-visit
PACKAGE_VERSION=${1:-5.0.0}
PACKAGE_URL=https://github.com/syntax-tree/unist-util-visit
