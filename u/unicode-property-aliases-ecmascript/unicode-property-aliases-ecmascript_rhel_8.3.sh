# -----------------------------------------------------------------------------
#
# Package	: unicode-property-aliases-ecmascript
# Version	: 1.1.0
# Source repo	: https://github.com/mathiasbynens/unicode-property-aliases-ecmascript
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=unicode-property-aliases-ecmascript
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/mathiasbynens/unicode-property-aliases-ecmascript
