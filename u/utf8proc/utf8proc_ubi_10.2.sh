...
PACKAGE_VERSION=${1:-v2.11.3}
PACKAGE_URL=https://github.com/JuliaStrings/utf8proc.git
PACKAGE_DIR=utf8proc
WORK_DIR=$(pwd)

# Install dependencies and tools
yum install -y wget git cmake python3.14-devel python3.14-pip 
...
echo "Building wheel..."
python3.14 -m pip wheel --wheel-dir ${WORK_DIR} -vv --no-build-isolation --no-deps .
...
echo "There are no test cases available. Manually tested and skipping the test cases."
