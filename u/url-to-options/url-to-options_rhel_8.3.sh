# -----------------------------------------------------------------------------
#
# Package	: url-to-options
# Version	: 1.0.1
# Source repo	: https://github.com/stevenvachon/url-to-options
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=url-to-options
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/stevenvachon/url-to-options
