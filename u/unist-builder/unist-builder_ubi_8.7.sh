...
# -----------------------------------------------------------------------------
#
# Package          : unist-builder
# Version          : 4.0.0
# Source repo      : https://github.com/syntax-tree/unist-builder
# Tested on	: UBI 8.7
# Language      : Node
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=unist-builder
PACKAGE_VERSION=${1:-4.0.0}
PACKAGE_URL=https://github.com/syntax-tree/unist-builder
