...
# Package			: opencsv	
# Version			: 1.7
# Source repo		: https://github.com/jlawrie/opencsv
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="opencsv"
PKG_VERSION=4.6 # tag not available in repository
PKG_VERSION_LATEST=1.7
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/jlawrie/opencsv.git"

# clone, build and test latest version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION_LATEST
cd $PKG_NAME-$PKG_VERSION_LATEST/
git checkout -b $PKG_VERSION_LATEST tags/OPENCSV_1_7
ant | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST.txt
...
##mvn clean install | tee $LOGS_DIRECTORY/$PKG_NAME-mvn.txt
