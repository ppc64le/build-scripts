# -----------------------------------------------------------------------------
#
# Package	: laminas/laminas-stdlib
# Version	: 3.3.1
# Source repo	: https://github.com/laminas/laminas-stdlib
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=laminas/laminas-stdlib
PACKAGE_VERSION=3.3.1
PACKAGE_URL=https://github.com/laminas/laminas-stdlib
