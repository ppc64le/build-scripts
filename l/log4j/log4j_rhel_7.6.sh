...
# Package			: log4j
# Version			: 1.2.17
# Source repo		: https://github.com/apache/log4j
# Tested on			: RHEL 7.6
...
REPOSITORY="https://github.com/apache/log4j.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/v1_2_17
ant build jar | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
...
#ant build jar | tee $LOGS_DIRECTORY/$PKG_NAME.txt
