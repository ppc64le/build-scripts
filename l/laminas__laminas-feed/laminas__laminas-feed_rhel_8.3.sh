# -----------------------------------------------------------------------------
#
# Package	: laminas/laminas-feed
# Version	: 2.14.0
# Source repo	: https://github.com/laminas/laminas-feed
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=laminas/laminas-feed
PACKAGE_VERSION=2.14.0
PACKAGE_URL=https://github.com/laminas/laminas-feed
