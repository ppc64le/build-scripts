...
# Version          : v0.10.11
# Source repo      : https://github.com/noamgat/lm-format-enforcer
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=lm-format-enforcer
PACKAGE_VERSION=${1:-v0.10.11}
PACKAGE_URL=https://github.com/noamgat/lm-format-enforcer
PACKAGE_DIR=lm-format-enforcer
