# -----------------------------------------------------------------------------
#
# Package	: listenercount
# Version	: 1.0.1
# Source repo	: https://github.com/jden/node-listenercount
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=listenercount
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/jden/node-listenercount
