...
# Package          : lme4
# Version          : 1.1-35.5
# Source repo      : https://github.com/cran/lme4
# Tested on        : UBI:9.3
# Language         : R
# Travis-Check     : True
...
#variables
PACKAGE_NAME=lme4
PACKAGE_VERSION=${1:-1.1-35.5}
PACKAGE_URL=https://github.com/cran/lme4.git
...
dnf install geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel -y
