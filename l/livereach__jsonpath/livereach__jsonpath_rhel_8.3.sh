# -----------------------------------------------------------------------------
#
# Package	: @livereach/jsonpath
# Version	: 1.2.2
# Source repo	: https://github.com/livereach/jsonpath
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@livereach/jsonpath
PACKAGE_VERSION=1.2.2
PACKAGE_URL=https://github.com/livereach/jsonpath
