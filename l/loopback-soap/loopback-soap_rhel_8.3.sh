# -----------------------------------------------------------------------------
#
# Package	: loopback-soap
# Version	: 1.3.2
# Source repo	: https://github.com/strongloop/loopback-soap
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-soap
PACKAGE_VERSION=1.3.2
PACKAGE_URL=https://github.com/strongloop/loopback-soap
