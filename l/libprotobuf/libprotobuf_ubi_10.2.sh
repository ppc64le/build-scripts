...
wget https://raw.githubusercontent.com/ppc64le/build-scripts/refs/heads/main/l/libprotobuf/protobuf-ubi10.2-6.31.1.patch
git apply protobuf-ubi10.2-6.31.1.patch
