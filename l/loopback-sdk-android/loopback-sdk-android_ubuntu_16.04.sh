# ----------------------------------------------------------------------------
#
# Package	: loopback-sdk-android
# Version	: 1.6.0
# Source repo	: https://github.com/strongloop/loopback-sdk-android.git
...
cd $WDIR
git clone https://github.com/strongloop/loopback-sdk-android.git
