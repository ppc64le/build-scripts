...
# Package          : leafem
# Version          : 0.2.3
# Source repo      : https://github.com/cran/leafem
# Tested on        : UBI:9.3
# Language         : R
# Travis-Check     : True
...
PACKAGE_URL=https://github.com/cran/leafem.git
...
dnf install geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel -y
