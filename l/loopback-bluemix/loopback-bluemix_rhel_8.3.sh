# -----------------------------------------------------------------------------
#
# Package	: loopback-bluemix
# Version	: 3.1.1
# Source repo	: https://github.com/strongloop/loopback-bluemix
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-bluemix
PACKAGE_VERSION=3.1.1
PACKAGE_URL=https://github.com/strongloop/loopback-bluemix
