# -----------------------------------------------------------------------------
#
# Package	: loopback-context
# Version	: 1.0.0
# Source repo	: https://github.com/strongloop/loopback-context
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-context
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/strongloop/loopback-context
