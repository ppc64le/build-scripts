# -----------------------------------------------------------------------------
#
# Package	: laminas/laminas-escaper
# Version	: 2.7.0
# Source repo	: https://github.com/laminas/laminas-escaper
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=laminas/laminas-escaper
PACKAGE_VERSION=2.7.0
PACKAGE_URL=https://github.com/laminas/laminas-escaper
