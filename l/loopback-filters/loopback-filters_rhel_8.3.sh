# -----------------------------------------------------------------------------
#
# Package	: loopback-filters
# Version	: 1.1.0
# Source repo	: https://github.com/strongloop/loopback-filters
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-filters
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/strongloop/loopback-filters
