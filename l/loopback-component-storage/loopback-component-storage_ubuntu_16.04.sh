# ----------------------------------------------------------------------------
#
# Package	: loopback-component-storage
# Version	: 3.2.0
# Source repo	: https://github.com/strongloop/loopback-component-storage.git
...
git clone https://github.com/strongloop/loopback-component-storage.git
