...
# -----------------------------------------------------------------------------
#
# Package          : lightning-utilities
# Version          : v0.11.9
# Source repo      : https://github.com/Lightning-AI/utilities
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=lightning-utilities
PACKAGE_VERSION=${1:-v0.11.9}
PACKAGE_URL=https://github.com/Lightning-AI/utilities
PACKAGE_DIR=lightning-utilities
