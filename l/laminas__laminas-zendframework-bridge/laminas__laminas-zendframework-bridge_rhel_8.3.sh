# -----------------------------------------------------------------------------
#
# Package	: laminas/laminas-zendframework-bridge
# Version	: 1.2.0
# Source repo	: https://github.com/laminas/laminas-zendframework-bridge
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=laminas/laminas-zendframework-bridge
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/laminas/laminas-zendframework-bridge
