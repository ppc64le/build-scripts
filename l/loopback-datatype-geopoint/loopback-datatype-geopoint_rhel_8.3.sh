# -----------------------------------------------------------------------------
#
# Package	: loopback-datatype-geopoint
# Version	: 1.0.0
# Source repo	: https://github.com/strongloop/loopback-datatype-geopoint
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-datatype-geopoint
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/strongloop/loopback-datatype-geopoint
