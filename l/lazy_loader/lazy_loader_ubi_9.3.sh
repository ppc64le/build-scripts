...
# Package          : lazy_loader
# Version          : v0.4
# Source repo      : https://github.com/scientific-python/lazy_loader
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=lazy_loader
PACKAGE_VERSION=${1:-v0.4}
PACKAGE_URL=https://github.com/scientific-python/lazy_loader
PACKAGE_DIR=lazy_loader
