# -----------------------------------------------------------------------------
#
# Package	: github.com/gobuffalo/logger
# Version	: v1.0.1
# Source repo	: https://github.com/gobuffalo/logger
# Language      : GO
# Ci-Check  : False
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/gobuffalo/logger
PACKAGE_VERSION=v1.0.1
PACKAGE_URL=https://github.com/gobuffalo/logger
