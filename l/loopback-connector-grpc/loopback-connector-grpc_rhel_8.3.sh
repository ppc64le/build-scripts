# -----------------------------------------------------------------------------
#
# Package	: loopback-connector-grpc
# Version	: 2.0.0
# Source repo	: https://github.com/strongloop/loopback-connector-grpc
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=loopback-connector-grpc
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/strongloop/loopback-connector-grpc
