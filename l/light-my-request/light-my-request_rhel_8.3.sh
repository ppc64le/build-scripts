# -----------------------------------------------------------------------------
#
# Package	: light-my-request
# Version	: 4.3.0
# Source repo	: https://github.com/fastify/light-my-request
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=light-my-request
PACKAGE_VERSION=4.3.0
PACKAGE_URL=https://github.com/fastify/light-my-request
