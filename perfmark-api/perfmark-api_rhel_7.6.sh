# ----------------------------------------------------------------------------
#
# Package			: perfmark-api
# Version			: 0.19.0, 0.21.0
# Source repo		: https://github.com/perfmark/perfmark.git
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="perfmark-api"
PKG_VERSION=0.19.0
PKG_VERSION_LATEST=0.21.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/perfmark/perfmark.git"
