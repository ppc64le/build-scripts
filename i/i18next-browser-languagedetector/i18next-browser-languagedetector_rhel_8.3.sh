...
# Version	: 6.1.0
# Source repo	: https://github.com/i18next/i18next-browser-languageDetector
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=i18next-browser-languagedetector
PACKAGE_VERSION=6.1.0
PACKAGE_URL=https://github.com/i18next/i18next-browser-languageDetector
