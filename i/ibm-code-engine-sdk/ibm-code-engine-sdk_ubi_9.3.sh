...
# Version          : v4.20.0
# Source repo      : https://github.com/IBM/code-engine-python-sdk
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v4.20.0}
PACKAGE_URL=https://github.com/IBM/code-engine-python-sdk
PACKAGE_DIR=ibm-code-engine-sdk
