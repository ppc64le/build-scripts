...
# Version	: 1.0.0
# Source repo	: https://github.com/jonschlinkert/is-accessor-descriptor
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-accessor-descriptor
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/jonschlinkert/is-accessor-descriptor
