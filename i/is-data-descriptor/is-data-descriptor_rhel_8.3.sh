...
# Version	: 1.0.0
# Source repo	: https://github.com/jonschlinkert/is-data-descriptor
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-data-descriptor
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/jonschlinkert/is-data-descriptor
