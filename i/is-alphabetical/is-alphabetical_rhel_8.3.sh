# -----------------------------------------------------------------------------
#
# Package	: is-alphabetical
# Version	: 1.0.4
# Source repo	: https://github.com/wooorm/is-alphabetical
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-alphabetical
PACKAGE_VERSION=1.0.4
PACKAGE_URL=https://github.com/wooorm/is-alphabetical
