...
# Version	: 1.0.8
# Source repo	: https://github.com/inspect-js/is-generator-function
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-generator-function
PACKAGE_VERSION=1.0.8
PACKAGE_URL=https://github.com/inspect-js/is-generator-function
