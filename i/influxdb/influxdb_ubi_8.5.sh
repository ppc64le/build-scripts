...
#    influxdb_test.go:751: unexpected error. expected 'request canceled' error, got Post "http://127.0.0.1:46425/query?db=&q=": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
#2022/06/13 11:14:35 http: TLS handshake error from 127.0.0.1:40292: remote error: tls: bad certificate
