# -----------------------------------------------------------------------------
#
# Package	: is-whitespace-character
# Version	: 1.0.4
# Source repo	: https://github.com/wooorm/is-whitespace-character
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-whitespace-character
PACKAGE_VERSION=1.0.4
PACKAGE_URL=https://github.com/wooorm/is-whitespace-character
