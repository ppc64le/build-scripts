# -----------------------------------------------------------------------------
#
# Package	: istanbul-lib-processinfo
# Version	: 2.0.2
# Source repo	: https://github.com/istanbuljs/istanbul-lib-processinfo
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=istanbul-lib-processinfo
PACKAGE_VERSION=2.0.2
PACKAGE_URL=https://github.com/istanbuljs/istanbul-lib-processinfo
