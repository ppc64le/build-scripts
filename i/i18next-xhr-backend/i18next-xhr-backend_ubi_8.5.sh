...
# -----------------------------------------------------------------------------
#
# Package          : i18next-xhr-backend
# Version          : v3.2.2
# Source repo      : https://github.com/i18next/i18next-xhr-backend
...
PACKAGE_NAME=i18next-xhr-backend
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-v3.2.2}
PACKAGE_URL=https://github.com/i18next/i18next-xhr-backend.git
