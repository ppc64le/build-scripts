...
# Version       : 4.2.0
# Source repo   : https://github.com/eclipse-ee4j/jaxb-istack-commons/tree/master/istack-commons
# Tested on     : UBI 9.3
# Language      : Java
# Travis-Check  : True
...
cd jaxb-istack-commons/$PACKAGE_NAME
