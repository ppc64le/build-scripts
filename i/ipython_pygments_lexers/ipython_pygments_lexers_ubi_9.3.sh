...
# -----------------------------------------------------------------------------
#
# Package          : ipython_pygments_lexers
# Version          : 1.1.1
# Source repo      : https://github.com/ipython/ipython-pygments-lexers
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/ipython/ipython-pygments-lexers
PACKAGE_DIR=ipython_pygments_lexers
