...
# Variables
export PACKAGE_VERSION=${1:-"incremental-22.10.0"}
export PACKAGE_NAME=incremental
export PACKAGE_URL=https://github.com/twisted/incremental
