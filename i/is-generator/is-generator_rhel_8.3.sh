# -----------------------------------------------------------------------------
#
# Package	: is-generator
# Version	: 1.0.3
# Source repo	: https://github.com/blakeembrey/is-generator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-generator
PACKAGE_VERSION=1.0.3
PACKAGE_URL=https://github.com/blakeembrey/is-generator
