...
# Package        : istio-proxy
# Version        : 1.4.3
# Source repo    : https://github.com/istio/proxy.git
# Tested on      : RHEL 7.6
...
# Clone istio-proxy, build and execute tests
cd $SOURCE_ROOT
...
make -f Makefile.core.mk BUILD_WITH_CONTAINER=0 BAZEL_ENVOY_PATH="/root/istio_build/proxy/bazel-bin/src/envoy/envoy" test
