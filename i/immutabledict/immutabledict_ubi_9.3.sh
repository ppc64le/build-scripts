...
# Version          : v4.2.1
# Source repo      : https://github.com/corenting/immutabledict
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=immutabledict
PACKAGE_VERSION=${1:-v4.2.1}
PACKAGE_URL=https://github.com/corenting/immutabledict
PACKAGE_DIR=immutabledict
