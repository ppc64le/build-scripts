# -----------------------------------------------------------------------------
#
# Package	: is-alphanumerical
# Version	: 1.0.4
# Source repo	: https://github.com/wooorm/is-alphanumerical
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=is-alphanumerical
PACKAGE_VERSION=1.0.4
PACKAGE_URL=https://github.com/wooorm/is-alphanumerical
