...
# Version	: 0.1.1
# Source repo	: https://github.com/remarkablemark/inline-style-parser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=inline-style-parser
PACKAGE_VERSION=0.1.1
PACKAGE_URL=https://github.com/remarkablemark/inline-style-parser
