...
# Package          : ibm-db-sa
# Version          : 0.3.9
# Source repo      : https://github.com/ibmdb/python-ibmdbsa
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=ibm-db-sa
PACKAGE_VERSION=${1:-0.3.9}
PACKAGE_URL=https://github.com/ibmdb/python-ibmdbsa
PACKAGE_DIR=ibm-db-sa
