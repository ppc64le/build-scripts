...
# Version          : v6.11.0
# Source repo      : https://github.com/python/importlib_metadata
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v6.11.0}
PACKAGE_URL=https://github.com/python/importlib_metadata
PACKAGE_DIR=importlib-metadata
