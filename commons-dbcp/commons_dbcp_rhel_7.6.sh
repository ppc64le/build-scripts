...
# Version			: 2.6.0, 2.7.0
# Source repo		: http://git-wip-us.apache.org/repos/asf/commons-dbcp
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="commons-dbcp"
PKG_VERSION=2.6.0
PKG_VERSION_LATEST=2.7.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="http://git-wip-us.apache.org/repos/asf/commons-dbcp.git"
