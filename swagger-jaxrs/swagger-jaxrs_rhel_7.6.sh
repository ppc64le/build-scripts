...
# variables
PKG_NAME="swagger-jaxrs"
PKG_VERSION=1.5.20
PKG_VERSION_LATEST=2.1.1
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/swagger-api/swagger-core.git"
