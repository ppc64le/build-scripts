...
# Version       : jackson-datatype-joda-2.17.2
# Source repo   : https://github.com/FasterXML/jackson-datatype-joda 
# Tested on     : UBI: 9.3
# Language      : Java,Logos
# Travis-Check  : True
...
set -e
PACKAGE_NAME=jackson-datatype-joda
PACKAGE_URL=https://github.com/FasterXML/jackson-datatype-joda.git
PACKAGE_VERSION=${1:-jackson-datatype-joda-2.17.2}
