#----------------------------------------------------------------------------
#
# Package			: janusgraph-berkeleyje
# Version			: 0.5.1
# Source repo		: https://github.com/JanusGraph/janusgraph
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="janusgraph-berkeleyje"
PKG_VERSION=0.3.1
PKG_VERSION_LATEST=0.5.1
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/JanusGraph/janusgraph.git"
