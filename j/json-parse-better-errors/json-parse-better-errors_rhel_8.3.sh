# -----------------------------------------------------------------------------
#
# Package	: json-parse-better-errors
# Version	: 1.0.1
# Source repo	: https://github.com/zkat/json-parse-better-errors
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=json-parse-better-errors
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/zkat/json-parse-better-errors
