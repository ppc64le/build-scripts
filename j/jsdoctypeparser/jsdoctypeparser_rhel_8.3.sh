# -----------------------------------------------------------------------------
#
# Package	: jsdoctypeparser
# Version	: 1.2.0
# Source repo	: https://github.com/jsdoctypeparser/jsdoctypeparser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=jsdoctypeparser
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/jsdoctypeparser/jsdoctypeparser
