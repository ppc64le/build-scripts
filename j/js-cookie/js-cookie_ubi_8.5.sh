...
npm install phantomjs@1.9.20 -ignore-scripts 
...
#Tests are in parity with intel.
#Testing test/index.html Warning: Callback must be a function Use --force to continue.
