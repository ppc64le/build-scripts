...
# Version       : 3.1-3.1.0-RC1
# Source repo   : https://github.com/eclipse-ee4j/jpa-api
# Tested on     : ubi: 8.3
...
echo "       PACKAGE_VERSION is an optional paramater whose default value is 3.1-3.1.0-RC1-RELEASE"

#Variables.
PACKAGE_VERSION=3.1-3.1.0-RC1-RELEASE
PACKAGE_VERSION="${1:-$PACKAGE_VERSION}"
PACKAGE_NAME=jpa-api/api
PACKAGE_URL=https://github.com/eclipse-ee4j/jpa-api.git
