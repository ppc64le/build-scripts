...
# -----------------------------------------------------------------------------
#
# Package          : jaraco.collections
# Version          : v5.1.0
# Source repo      : https://github.com/jaraco/jaraco.collections
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/jaraco/jaraco.collections
PACKAGE_DIR=jaraco.collections
