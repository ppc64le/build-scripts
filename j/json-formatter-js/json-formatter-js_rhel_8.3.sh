# -----------------------------------------------------------------------------
#
# Package	: json-formatter-js
# Version	: 2.3.4
# Source repo	: https://github.com/mohsen1/json-formatter-js
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=json-formatter-js
PACKAGE_VERSION=2.3.4
PACKAGE_URL=https://github.com/mohsen1/json-formatter-js
