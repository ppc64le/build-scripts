# ----------------------------------------------------------------------------
#
# Package       : jcabi-aspects
# Version       : 0.23.2
# Source repo   : https://github.com/jcabi/jcabi-aspects
# Tested on     : ubi: 8.3
...
echo "       PACKAGE_VERSION is an optional paramater whose default value is 0.23.2"

#Variables.
PACKAGE_VERSION=0.23.2
PACKAGE_VERSION="${1:-$PACKAGE_VERSION}"
PACKAGE_NAME=jcabi-aspects
PACKAGE_URL=https://github.com/jcabi/jcabi-aspects.git
