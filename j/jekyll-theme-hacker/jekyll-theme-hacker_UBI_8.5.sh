...
# Using jekyll-theme-hacker 0.1.1 from source at `.`
...
# Configuration file: /hacker/_config.yml
#             Source: /hacker
#        Destination: /hacker/_site
# Incremental build: disabled. Enable with --incremental
#       Generating...
#                     done in 0.571 seconds.
...
#   Version: 0.1.1
#   File: jekyll-theme-hacker-0.1.1.gem
# ------------------Test_success-------------------------
# hacker  | v0.1.1 |
