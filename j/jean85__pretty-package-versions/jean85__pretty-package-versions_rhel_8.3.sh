...
# Version	: 2.0.1
# Source repo	: https://github.com/Jean85/pretty-package-versions
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=jean85/pretty-package-versions
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/Jean85/pretty-package-versions
