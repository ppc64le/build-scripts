...
# Version          : jackson-modules-base-2.17.2
# Source repo      : https://github.com/FasterXML/jackson-modules-base.git
# Tested on        : UBI:9.3
# Language         : Java
# Ci-Check     : True
...
#variables
PACKAGE_NAME=jackson-modules-base
PACKAGE_URL=https://github.com/FasterXML/jackson-modules-base.git
PACKAGE_VERSION=${1:-jackson-modules-base-2.17.2}
