...
# -----------------------------------------------------------------------------
#
# Package	: jekyll-theme-cayman
# Version	: v0.1.1
# Source repo	: https://github.com/pages-themes/cayman
# Tested on	: UBI: 8.5
# Language      : Ruby
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/pages-themes/cayman
...
sed -i "17i\  s.required_ruby_version = '>= 2.4.0'" jekyll-theme-cayman.gemspec
