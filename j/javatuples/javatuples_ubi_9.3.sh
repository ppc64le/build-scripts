...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=javatuples
PACKAGE_URL=https://github.com/javatuples/javatuples.git
PACKAGE_VERSION=${1:-javatuples-1.2}
...
#Build
if ! mvn -B clean install -fae -Dmaven.javadoc.skip=true -Dgpg.skip ; then
