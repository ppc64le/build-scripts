#----------------------------------------------------------------------------
#
# Package			: jackson-dataformat-yaml
# Version			: 2.10.2
...
# variables
PKG_NAME="jackson-dataformat-yaml"
PKG_VERSION=2.10.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/FasterXML/jackson-dataformats-text.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/jackson-dataformats-text-$PKG_VERSION
cd yaml/
