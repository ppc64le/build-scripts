...
PKG_NAME="javassist"
PKG_VERSION=3.21.0
PKG_VERSION_LATEST=3.27.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/jboss-javassist/javassist.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/rel_3_21_0_ga
...
#git checkout -b $PKG_VERSION_LATEST tags/rel_3_27_0_ga
