...
# -----------------------------------------------------------------------------
#
# Package          : jupyterlab_git
# Version          : v0.51.1
# Source repo      : https://github.com/jupyterlab/jupyterlab-git
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=jupyterlab_git
PACKAGE_VERSION=${1:-v0.51.1}
PACKAGE_URL=https://github.com/jupyterlab/jupyterlab-git
PACKAGE_DIR=jupyterlab_git
