...
# Version	: 1.0.1
# Source repo	: https://github.com/ianschmitz/jest-environment-jsdom-fourteen
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=jest-environment-jsdom-fourteen
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/ianschmitz/jest-environment-jsdom-fourteen
