...
# ----------------------------------------------------------------------------
#
# Package       : jsonata4java
# Version       : f0fdbeb
# Source repo   : https://github.com/IBM/JSONata4Java
# Tested on     : UBI 9.3
# Language      : Java
# Ci-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=JSONata4Java
PACKAGE_URL=https://github.com/IBM/JSONata4Java.git
PACKAGE_VERSION=${1:-f0fdbeb}
