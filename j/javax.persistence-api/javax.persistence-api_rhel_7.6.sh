# ----------------------------------------------------------------------------
#
# Package			: javax.persistence-api
# Version			: 2.2
# Source repo		: https://github.com/javaee/jpa-spec
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="javax.persistence-api"
PKG_VERSION=2.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/javaee/jpa-spec.git"
