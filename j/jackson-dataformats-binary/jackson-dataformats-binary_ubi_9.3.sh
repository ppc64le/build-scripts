...
# Version       : jackson-dataformats-binary-2.17.2
# Source repo   : https://github.com/FasterXML/jackson-dataformats-binary 
# Tested on     : UBI: 9.3
# Language      : Java,Logos
# Travis-Check  : True
...
set -e
PACKAGE_NAME=jackson-dataformats-binary
PACKAGE_URL=https://github.com/FasterXML/jackson-dataformats-binary.git
PACKAGE_VERSION=${1:-jackson-dataformats-binary-2.17.2}
