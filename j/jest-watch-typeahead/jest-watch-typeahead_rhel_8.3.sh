# -----------------------------------------------------------------------------
#
# Package	: jest-watch-typeahead
# Version	: 0.4.2
# Source repo	: https://github.com/jest-community/jest-watch-typeahead
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=jest-watch-typeahead
PACKAGE_VERSION=0.4.2
PACKAGE_URL=https://github.com/jest-community/jest-watch-typeahead
