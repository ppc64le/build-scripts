...
# Source repo	: https://github.com/json-iterator/go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=json-iterator/go
PACKAGE_VERSION=f2b4162afba35581b6d4a50d3b8f34e33c144682
PACKAGE_URL=https://github.com/json-iterator/go
