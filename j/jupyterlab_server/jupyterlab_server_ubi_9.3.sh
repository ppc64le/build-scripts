...
# Version          : v2.27.3
# Source repo      : https://github.com/jupyterlab/jupyterlab_server
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v2.27.3}
PACKAGE_URL=https://github.com/jupyterlab/jupyterlab_server
PACKAGE_DIR=jupyterlab_server
