# ----------------------------------------------------------------------------
#
# Package			: jboss-transaction-api
# Version			: 1.1.1
# Source repo		: https://github.com/jboss/jboss-transaction-api_spec
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="jboss-transaction-api"
PKG_VERSION=1.1.1
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/jboss/jboss-transaction-api_spec.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/jboss-transaction-api_1.2_spec-$PKG_VERSION.Final
