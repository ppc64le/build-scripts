...
# -----------------------------------------------------------------------------
#
# Package	: jekyll-theme-tactile
# Version	: v0.1.1
# Source repo	: https://github.com/pages-themes/tactile
# Tested on	: UBI: 8.5
# Language      : Ruby
# Travis-Check  : False
...
PACKAGE_URL=https://github.com/pages-themes/tactile
...
sed -i "13i\  s.required_ruby_version = '>= 2.4.0'" jekyll-theme-tactile.gemspec
sed -i '1i # frozen_string_literal: true\n' jekyll-theme-tactile.gemspec
...
#   Version: 0.1.1
#   File: jekyll-theme-tactile-0.1.1.gem
# ------------------Test_success-------------------------