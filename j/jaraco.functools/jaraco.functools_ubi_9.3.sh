...
# -----------------------------------------------------------------------------
#
# Package          : jaraco.functools
# Version          : v4.0.1
# Source repo      : https://github.com/jaraco/jaraco.functools
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/jaraco/jaraco.functools
PACKAGE_DIR=jaraco.functools
