...
PKG_NAME="jaxb-api"
PKG_VERSION=2.3.1
PKG_VERSION_LATEST=3.0.0
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/eclipse-ee4j/jaxb-api.git"

# clone, build and test specified version
#cd $LOCAL_DIRECTORY
#git clone https://github.com/javaee/jaxb-v2.git $PKG_NAME-$PKG_VERSION
...
git checkout -b $PKG_VERSION_LATEST tags/$PKG_VERSION_LATEST-RC3
