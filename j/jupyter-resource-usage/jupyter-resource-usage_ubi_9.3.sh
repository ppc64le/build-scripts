...
# -----------------------------------------------------------------------------
#
# Package          : jupyter-resource-usage
# Version          : v1.0.1
# Source repo      : https://github.com/jupyter-server/jupyter-resource-usage
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/jupyter-server/jupyter-resource-usage
PACKAGE_DIR=jupyter-resource-usage
