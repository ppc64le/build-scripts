...
# Version          : 0.3.0
# Source repo      : https://github.com/jupyterlab/jupyterlab_pygments
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=jupyterlab_pygments
PACKAGE_VERSION=${1:-0.3.0}
PACKAGE_URL=https://github.com/jupyterlab/jupyterlab_pygments
PACKAGE_DIR=jupyterlab_pygments
