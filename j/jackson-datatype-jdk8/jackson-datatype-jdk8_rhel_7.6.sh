...
# variables
PKG_NAME="jackson-datatype-jdk8"
PKG_VERSION=2.9.8
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/FasterXML/jackson-modules-java8.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/jackson-modules-java8-$PKG_VERSION
cd datatypes/
