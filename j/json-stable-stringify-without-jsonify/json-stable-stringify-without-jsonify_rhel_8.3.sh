...
# Version	: 1.0.1
# Source repo	: https://github.com/samn/json-stable-stringify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=json-stable-stringify-without-jsonify
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/samn/json-stable-stringify
