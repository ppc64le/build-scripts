...
# Version	: 2.3.1
# Source repo	: https://github.com/npm/json-parse-even-better-errors
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=json-parse-even-better-errors
PACKAGE_VERSION=2.3.1
PACKAGE_URL=https://github.com/npm/json-parse-even-better-errors
