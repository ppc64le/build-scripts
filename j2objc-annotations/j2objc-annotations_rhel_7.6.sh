...
# variables
PKG_NAME="j2objc-annotations"
PKG_VERSION=1.1	
PKG_VERSION_LATEST=2.6
LOGS_DIRECTORY=/logs
...
cd annotations/
mvn -Dgpg.skip=true -Dmaven.javadoc.skip=true clean install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
