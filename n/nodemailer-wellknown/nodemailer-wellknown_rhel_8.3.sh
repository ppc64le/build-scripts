# -----------------------------------------------------------------------------
#
# Package	: nodemailer-wellknown
# Version	: 0.1.10
# Source repo	: https://github.com/andris9/nodemailer-wellknown
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-wellknown
PACKAGE_VERSION=0.1.10
PACKAGE_URL=https://github.com/andris9/nodemailer-wellknown
