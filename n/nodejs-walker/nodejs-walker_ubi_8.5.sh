...
# Version          : 3f78f80d026fd1efd2adc2f8927a0a4ccae35644
...
PACKAGE_VERSION=${1:-3f78f80d026fd1efd2adc2f8927a0a4ccae35644}
...
# 1 error  
# error walk:
# Uncaught AssertionError [ERR_ASSERTION]: Expect specific directory
     # + expected - actual

     # -/root/nodejs-walker/test/fixture-error-walk
     # +/root/nodejs-walker/test/fixture-error-walk/d
