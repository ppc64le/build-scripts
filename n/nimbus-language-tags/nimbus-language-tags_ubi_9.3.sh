...
# ----------------------------------------------------------------------------
#
# Package       : nimbus-language-tags
# Version       : 1.7
# Source repo   : https://bitbucket.org/connect2id/nimbus-language-tags
# Tested on     : UBI 9.3
# Language      : Java
# Travis-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=nimbus-language-tags
PACKAGE_URL=https://bitbucket.org/connect2id/nimbus-language-tags.git
