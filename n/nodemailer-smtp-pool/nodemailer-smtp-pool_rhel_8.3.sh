# -----------------------------------------------------------------------------
#
# Package	: nodemailer-smtp-pool
# Version	: 2.8.2
# Source repo	: https://github.com/andris9/nodemailer-smtp-pool
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-smtp-pool
PACKAGE_VERSION=2.8.2
PACKAGE_URL=https://github.com/andris9/nodemailer-smtp-pool
