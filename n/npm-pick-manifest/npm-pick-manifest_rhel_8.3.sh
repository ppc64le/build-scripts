# -----------------------------------------------------------------------------
#
# Package	: npm-pick-manifest
# Version	: 2.1.0
# Source repo	: https://github.com/npm/npm-pick-manifest
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=npm-pick-manifest
PACKAGE_VERSION=2.1.0
PACKAGE_URL=https://github.com/npm/npm-pick-manifest
