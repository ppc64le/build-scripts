# -----------------------------------------------------------------------------
#
# Package	: normalize-scroll-left
# Version	: 0.1.2
# Source repo	: https://github.com/alitaheri/normalize-scroll-left
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=normalize-scroll-left
PACKAGE_VERSION=0.1.2
PACKAGE_URL=https://github.com/alitaheri/normalize-scroll-left
