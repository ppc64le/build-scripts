# -----------------------------------------------------------------------------
#
# Package	: node-object-hash
# Version	: 1.4.2
# Source repo	: https://github.com/SkeLLLa/node-object-hash
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=node-object-hash
PACKAGE_VERSION=1.4.2
PACKAGE_URL=https://github.com/SkeLLLa/node-object-hash
