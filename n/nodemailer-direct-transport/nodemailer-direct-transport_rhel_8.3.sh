# -----------------------------------------------------------------------------
#
# Package	: nodemailer-direct-transport
# Version	: 3.3.2
# Source repo	: https://github.com/andris9/nodemailer-direct-transport
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-direct-transport
PACKAGE_VERSION=3.3.2
PACKAGE_URL=https://github.com/andris9/nodemailer-direct-transport
