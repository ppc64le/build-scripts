# -----------------------------------------------------------------------------
#
# Package	: @newrelic/superagent
# Version	: 4.0.0
# Source repo	: https://github.com/newrelic/node-newrelic-superagent
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@newrelic/superagent
PACKAGE_VERSION=4.0.0
PACKAGE_URL=https://github.com/newrelic/node-newrelic-superagent
