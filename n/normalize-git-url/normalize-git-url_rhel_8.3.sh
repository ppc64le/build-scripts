# -----------------------------------------------------------------------------
#
# Package	: normalize-git-url
# Version	: 3.0.2
# Source repo	: https://github.com/npm/normalize-git-url
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=normalize-git-url
PACKAGE_VERSION=3.0.2
PACKAGE_URL=https://github.com/npm/normalize-git-url
