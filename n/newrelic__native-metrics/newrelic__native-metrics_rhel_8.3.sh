...
# Version	: 6.0.0
# Source repo	: https://github.com/newrelic/node-native-metrics
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@newrelic/native-metrics
PACKAGE_VERSION=6.0.0
PACKAGE_URL=https://github.com/newrelic/node-native-metrics
