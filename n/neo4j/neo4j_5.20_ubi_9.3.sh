...
if ! mvn clean install -Dlog4j.configurationFile="/tmp/log" -pl -:kernel-it,-:bolt-it,-:neo4j-collections,-:neo4j-push-to-cloud,-:community-it,-:cypher-it,-:procedure-compiler,-:neo4j-cypher-planner,-:neo4j-cypher-expression-evaluator,-:gbptree-tests ; then
