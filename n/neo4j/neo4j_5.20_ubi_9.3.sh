...
# Tests 
if ! mvn clean install -Dlog4j.configurationFile="/tmp/log" -pl -:kernel-it,-:neo4j-kernel-test,-:neo4j-collections,-:neo4j-cypher-planner,-:neo4j-cypher-expression-evaluator,-:gbptree-tests ; then
