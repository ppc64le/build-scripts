...
if ! mvn -T 4 clean install -Dlog4j.configurationFile="/tmp/log" -pl -:neo4j-import-util,-:neo4j-push-to-cloud,-:community-it,-:kernel-it,-:neo4j-kernel-test,-:neo4j-collections,-:bolt-it,-:neo4j-graphdb-api,-:test-utils,-:neo4j-values,-:neo4j-random-values,-:io-test-utils,-:neo4j-logging,-:log-test-utils,-:neo4j-configuration,-:neo4j-lock,-:neo4j-schema,-:neo4j-procedure-api,-:cypher-it,-:neo4j-cypher-compatibility-spec-suite,-:neo4j-cypher-planner,-:cypher-shell ; then
