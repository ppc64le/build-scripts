...
# neo4j-push-to-cloud, community-it, cypher-it, procedure-compiler, neo4j-kernel-test, neo4j-import-util, neo4j-cypher-runtime-spec-suite, index-it are failing due to infra issues , passes on FYRE VM.
# neo4j-cypher-planner, neo4j-cypher-expression-evaluator, gbptree-tests passes on rerun 
if ! mvn clean install -Dlog4j.configurationFile="/tmp/log" -pl -:kernel-it,-:bolt-it,-:neo4j-collections,-:neo4j-push-to-cloud,-:community-it,-:cypher-it,-:procedure-compiler,-:neo4j-kernel-test,-:neo4j-import-util,-:neo4j-cypher-runtime-spec-suite,-:neo4j-cypher-compatibility-spec-suite,-:neo4j-cypher-planner,-:neo4j-cypher-expression-evaluator,-:gbptree-tests ; then
