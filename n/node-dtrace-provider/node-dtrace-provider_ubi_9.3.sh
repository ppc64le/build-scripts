...
# Version	    : v0.8.8
# Source repo	    : https://github.com/chrisa/node-dtrace-provider
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=node-dtrace-provider
PACKAGE_VERSION=${1:-v0.8.8}
PACKAGE_URL=https://github.com/chrisa/node-dtrace-provider
