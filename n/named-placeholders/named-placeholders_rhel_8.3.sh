# -----------------------------------------------------------------------------
#
# Package	: named-placeholders
# Version	: 1.1.2
# Source repo	: https://github.com/sidorares/named-placeholders
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=named-placeholders
PACKAGE_VERSION=1.1.2
PACKAGE_URL=https://github.com/sidorares/named-placeholders
