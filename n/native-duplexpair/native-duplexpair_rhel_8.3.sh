# -----------------------------------------------------------------------------
#
# Package	: native-duplexpair
# Version	: 1.0.0
# Source repo	: https://github.com/tediousjs/native-duplexpair
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=native-duplexpair
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/tediousjs/native-duplexpair
