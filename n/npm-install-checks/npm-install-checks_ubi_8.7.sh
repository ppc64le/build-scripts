...
# Version          : v6.3.0
# Source repo      : https://github.com/npm/npm-install-checks
# Tested on	: UBI 8.7
# Language      : Node
# Ci-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=npm-install-checks
PACKAGE_VERSION=${1:-v6.3.0}
PACKAGE_URL=https://github.com/npm/npm-install-checks
