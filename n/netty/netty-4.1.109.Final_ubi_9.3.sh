...
bash netty-tcnative_ubi_9.3.sh netty-tcnative-parent-2.0.65.Final
...
if ! ./mvnw test -Dtcnative.classifier=linux-ppcle_64-fedora -pl -:netty-handler ; then
