...
# ----------------------------------------------------------------------------
#
# Package       : nimbus-content-type
# Version       : 2.3
# Source repo   : https://bitbucket.org/connect2id/nimbus-content-type/
# Tested on     : UBI 9.3
# Language      : Java
# Travis-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=nimbus-content-type
PACKAGE_URL=https://bitbucket.org/connect2id/nimbus-content-type.git
