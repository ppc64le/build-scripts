# -----------------------------------------------------------------------------
#
# Package	: nested-error-stacks
# Version	: 2.1.0
# Source repo	: https://github.com/mdlavin/nested-error-stacks
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nested-error-stacks
PACKAGE_VERSION=2.1.0
PACKAGE_URL=https://github.com/mdlavin/nested-error-stacks
