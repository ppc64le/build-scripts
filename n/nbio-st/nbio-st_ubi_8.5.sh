...
#
# Package          : nbio-st
# Version          : e9e8d9816f32
# Source repo      : https://github.com/nbio/st
...
PACKAGE_VERSION=${1:-e9e8d9816f32}
PACKAGE_URL=https://github.com/nbio/st
...
if [ $ret -eq 0 ] ; then
 ...
 exit
     ...
     go mod init github.com/nbio/st
     go mod tidy
...
#readme_test.go:38: Tests purposely fail to demonstrate output. Its not an issue.
