# -----------------------------------------------------------------------------
#
# Package	: nodemailer-shared
# Version	: 1.1.0
# Source repo	: https://github.com/nodemailer/nodemailer-shared
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-shared
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/nodemailer/nodemailer-shared
