# -----------------------------------------------------------------------------
#
# Package	: node-environment-flags
# Version	: 1.0.6
# Source repo	: https://github.com/boneskull/node-environment-flags
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=node-environment-flags
PACKAGE_VERSION=1.0.6
PACKAGE_URL=https://github.com/boneskull/node-environment-flags
