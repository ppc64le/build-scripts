...
# Version          : v3.0.1
# Source repo      : https://github.com/npm/npm-normalize-package-bin
# Tested on	: UBI 8.7
# Language      : Node
# Ci-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=npm-normalize-package-bin
PACKAGE_VERSION=${1:-v3.0.1}
PACKAGE_URL=https://github.com/npm/npm-normalize-package-bin
