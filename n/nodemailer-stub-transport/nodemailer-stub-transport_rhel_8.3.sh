# -----------------------------------------------------------------------------
#
# Package	: nodemailer-stub-transport
# Version	: 1.1.0
# Source repo	: https://github.com/andris9/nodemailer-stub-transport
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-stub-transport
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/andris9/nodemailer-stub-transport
