...
yum install -y git gcc gcc-c++  make wget python-devel xz-devel bzip2-devel openssl-devel zlib-devel libffi-devel llvm15-devel.ppc64le
...
pip install numpy==1.26.3 setuptools
