# -----------------------------------------------------------------------------
#
# Package	: npm-cache-filename
# Version	: 1.0.2
# Source repo	: https://github.com/npm/npm-cache-filename
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=npm-cache-filename
PACKAGE_VERSION=1.0.2
PACKAGE_URL=https://github.com/npm/npm-cache-filename
