# -----------------------------------------------------------------------------
#
# Package	: nodemailer-smtp-transport
# Version	: 2.7.2
# Source repo	: https://github.com/andris9/nodemailer-smtp-transport
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=nodemailer-smtp-transport
PACKAGE_VERSION=2.7.2
PACKAGE_URL=https://github.com/andris9/nodemailer-smtp-transport
