# -----------------------------------------------------------------------------
#
# Package	: masterminds/squirrel
# Version	: v1.4.0
# Source repo	: https://github.com/masterminds/squirrel
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=masterminds/squirrel
PACKAGE_VERSION=v1.4.0
PACKAGE_URL=https://github.com/masterminds/squirrel
