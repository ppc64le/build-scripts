...
# Package          : marshmallow
# Version          : 3.21.3
# Source repo      : https://github.com/marshmallow-code/marshmallow
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-3.21.3}
PACKAGE_URL=https://github.com/marshmallow-code/marshmallow
PACKAGE_DIR=marshmallow
