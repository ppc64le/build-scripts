# -----------------------------------------------------------------------------
#
# Package	: mem-fs-editor
# Version	: 7.1.0
# Source repo	: https://github.com/SBoudrias/mem-fs-editor
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=mem-fs-editor
PACKAGE_VERSION=7.1.0
PACKAGE_URL=https://github.com/SBoudrias/mem-fs-editor
