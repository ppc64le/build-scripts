# -----------------------------------------------------------------------------
#
# Package	: markdown-escapes
# Version	: 1.0.4
# Source repo	: https://github.com/wooorm/markdown-escapes
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=markdown-escapes
PACKAGE_VERSION=1.0.4
PACKAGE_URL=https://github.com/wooorm/markdown-escapes
