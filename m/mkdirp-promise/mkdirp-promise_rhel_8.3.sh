# -----------------------------------------------------------------------------
#
# Package	: mkdirp-promise
# Version	: 1.1.0
# Source repo	: https://github.com/ahmadnassri/mkdirp-promise
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=mkdirp-promise
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/ahmadnassri/mkdirp-promise
