# -----------------------------------------------------------------------------
#
# Package	: moul/http2curl
# Version	: 9ac6cf4d929b2fa8fd2d2e6dec5bb0feb4f4911d
# Source repo	: https://github.com/moul/http2curl
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=moul/http2curl
PACKAGE_VERSION=9ac6cf4d929b2fa8fd2d2e6dec5bb0feb4f4911d
PACKAGE_URL=https://github.com/moul/http2curl
