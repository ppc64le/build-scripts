...
# Version       : trunk (Default)
# Source repo   : https://github.com/apache/maven-artifact.git
# Tested on     : UBI 9.3
# Language      : Java
# Ci-Check  : True
...
PACKAGE_NAME=maven-artifact
PACKAGE_URL=https://github.com/apache/maven-artifact.git
...
if [ $? != 0 ]
then
  echo "Build and Test failed for $PACKAGE_NAME"
  exit 1
fi
exit 0