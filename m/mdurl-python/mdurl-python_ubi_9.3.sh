...
# -----------------------------------------------------------------------------
#
# Package          : mdurl-python
# Version          : 0.1.2
# Source repo      : https://github.com/executablebooks/mdurl
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=mdurl-python
PACKAGE_VERSION=${1:-0.1.2}
PACKAGE_URL=https://github.com/executablebooks/mdurl
PACKAGE_DIR=mdurl-python
