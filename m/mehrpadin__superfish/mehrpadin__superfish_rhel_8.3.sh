# -----------------------------------------------------------------------------
#
# Package	: mehrpadin/superfish
# Version	: 2.1
# Source repo	: https://github.com/mehrpadin/Superfish-for-Drupal
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=mehrpadin/superfish
PACKAGE_VERSION=2.1
PACKAGE_URL=https://github.com/mehrpadin/Superfish-for-Drupal
