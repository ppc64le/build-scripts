...
# Version	: 1.0.1
# Source repo	: https://github.com/indutny/minimalistic-crypto-utils
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=minimalistic-crypto-utils
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/indutny/minimalistic-crypto-utils
