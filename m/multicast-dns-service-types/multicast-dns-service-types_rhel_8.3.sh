# -----------------------------------------------------------------------------
#
# Package	: multicast-dns-service-types
# Version	: 1.1.0
# Source repo	: https://github.com/mafintosh/multicast-dns-service-types
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=multicast-dns-service-types
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/mafintosh/multicast-dns-service-types
