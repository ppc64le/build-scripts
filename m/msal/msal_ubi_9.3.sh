...
# Package          : msal
# Version          : 1.31.1
# Source repo      : https://github.com/AzureAD/microsoft-authentication-library-for-python
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=msal
PACKAGE_VERSION=${1:-1.31.1}
PACKAGE_URL=https://github.com/AzureAD/microsoft-authentication-library-for-python
PACKAGE_DIR=msal
