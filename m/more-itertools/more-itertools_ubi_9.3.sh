...
# Version          : v10.4.0
# Source repo      : https://github.com/more-itertools/more-itertools
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v10.4.0}
PACKAGE_URL=https://github.com/more-itertools/more-itertools
PACKAGE_DIR=more-itertools
