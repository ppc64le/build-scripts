#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : multiple_fields_remove_button
# Version          : 8.x-1.0-alpha13
# Source repo      : https://git.drupalcode.org/project/multiple_fields_remove_button.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=multiple_fields_remove_button
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/multiple_fields_remove_button.git
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.0-alpha13}
...
#multiple_fields_remove_button  |  8.x-1.0-alpha13 #------------------Build_success-------------------------
