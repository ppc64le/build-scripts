...
# Package               : migrate
# Version               : v3.1.0
# Source repo           : https://github.com/golang-migrate/migrate
# Tested on             : UBI 8.5
# Language              : GO
...
#Set variables
PACKAGE_URL=https://github.com/golang-migrate/migrate
...
# Ensure go.mod file exists
     [ ! -f go.mod ] && go mod init golang-migrate/migrate
         go mod tidy && go get github.com/golang-migrate/migrate/database && go get github.com/golang-migrate/migrate/source
 
    go get github.com/golang-migrate/migrate/source
    go get github.com/golang-migrate/migrate/database  
    
if ! go build -v  -a; then
