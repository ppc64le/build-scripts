...
# Version	: 0.9.0
# Source repo	: https://github.com/webpack-contrib/mini-css-extract-plugin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=mini-css-extract-plugin
PACKAGE_VERSION=0.9.0
PACKAGE_URL=https://github.com/webpack-contrib/mini-css-extract-plugin
