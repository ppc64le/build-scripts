...
# Version       : 5.1.1
# Source repo   : https://github.com/eclipse/microprofile-metrics
# Tested on     : UBI: 9.3
# Language      : Java
# Travis-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=microprofile-metrics
PACKAGE_URL=https://github.com/eclipse/microprofile-metrics.git
