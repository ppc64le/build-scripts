...
# Version          : v13.0.0
# Source repo      : https://github.com/npm/make-fetch-happen
# Tested on	: UBI 8.7
# Language      : Node
# Ci-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=make-fetch-happen
PACKAGE_VERSION=${1:-v13.0.0}
PACKAGE_URL=https://github.com/npm/make-fetch-happen
