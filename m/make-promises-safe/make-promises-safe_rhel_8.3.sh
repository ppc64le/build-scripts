# -----------------------------------------------------------------------------
#
# Package	: make-promises-safe
# Version	: 5.1.0
# Source repo	: https://github.com/mcollina/make-promises-safe
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=make-promises-safe
PACKAGE_VERSION=5.1.0
PACKAGE_URL=https://github.com/mcollina/make-promises-safe
