...
# ----------------------------------------------------------------------------
#
# Package       : microprofile-open-api
# Version       : 4.0
# Source repo   : https://github.com/eclipse/microprofile-open-api
# Tested on     : UBI: 9.3
# Language      : Java
# Ci-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=microprofile-open-api
PACKAGE_URL=https://github.com/eclipse/microprofile-open-api.git
