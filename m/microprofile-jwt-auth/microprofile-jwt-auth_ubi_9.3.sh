...
# ----------------------------------------------------------------------------
#
# Package       : microprofile-jwt-auth
# Version       : 2.1
# Source repo   : https://github.com/eclipse/microprofile-jwt-auth
# Tested on     : UBI: 9.3
# Language      : Java
# Ci-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=microprofile-jwt-auth
PACKAGE_URL=https://github.com/eclipse/microprofile-jwt-auth.git
