...
# -----------------------------------------------------------------------------
#
# Package	    : module-importer
# Version	    : v1.0.1
# Source repo	    : https://github.com/humanwhocodes/module-importer
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=module-importer
PACKAGE_VERSION=${1:-v1.0.1}
PACKAGE_URL=https://github.com/humanwhocodes/module-importer
