...
# -----------------------------------------------------------------------------
#
# Package          : meson-python
# Version          : 0.17.1
# Source repo      : https://github.com/mesonbuild/meson-python
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-0.17.1}
PACKAGE_URL=https://github.com/mesonbuild/meson-python
PACKAGE_DIR=meson-python
