...
# docker run -d -p 27017:27017  quay.io/opencloudio/ibm-mongodb@sha256:563f4b3e582c52b9ae47fac5783fcb8e92ed4285d17893e79a37a5fa2f84c58e --dbpath=/tmp  --setParameter enableTestCommands=1 --smallfiles --nojournal
# docker run --network host -v /var/run/docker.sock:/var/run/docker.sock -it registry.access.redhat.com/ubi8
# after docker container is started run following script in it. 


WORK_DIR=`pwd`
PACKAGE_NAME=mongo-java-driver
PACKAGE_VERSION=r3.9.1
