...
# Version          : multiprocess-0.70.15
# Source repo      : https://github.com/uqfoundation/multiprocess
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-multiprocess-0.70.15}
PACKAGE_URL=https://github.com/uqfoundation/multiprocess
