...
PACKAGE_DIR=murmurhash
CURRENT_DIR="${PWD}"

# Install dependencies
yum install -y git gcc-toolset-13-gcc gcc-toolset-13-gcc-c++ gcc-toolset-13-gcc-gfortran \
    make wget openssl-devel bzip2-devel glibc-static libstdc++-static libffi-devel \
    zlib-devel python-devel python-pip pkg-config cmake
...
pip install setuptools packaging pytest build
