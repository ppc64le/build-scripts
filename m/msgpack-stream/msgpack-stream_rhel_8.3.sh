# -----------------------------------------------------------------------------
#
# Package	: msgpack-stream
# Version	: 0.0.13
# Source repo	: https://github.com/dominictarr/msgpack-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=msgpack-stream
PACKAGE_VERSION=0.0.13
PACKAGE_URL=https://github.com/dominictarr/msgpack-stream
