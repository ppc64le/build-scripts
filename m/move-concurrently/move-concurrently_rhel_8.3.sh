# -----------------------------------------------------------------------------
#
# Package	: move-concurrently
# Version	: 1.0.1
# Source repo	: https://github.com/npm/move-concurrently
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=move-concurrently
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/npm/move-concurrently
