# -----------------------------------------------------------------------------
#
# Package	: mixin-object
# Version	: 2.0.1
# Source repo	: https://github.com/jonschlinkert/mixin-object
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=mixin-object
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/jonschlinkert/mixin-object
