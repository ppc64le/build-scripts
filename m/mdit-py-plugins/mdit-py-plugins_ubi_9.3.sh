...
# -----------------------------------------------------------------------------
#
# Package          : mdit-py-plugins
# Version          : v0.4.2
# Source repo      : https://github.com/executablebooks/mdit-py-plugins
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/executablebooks/mdit-py-plugins
PACKAGE_DIR=mdit-py-plugins
