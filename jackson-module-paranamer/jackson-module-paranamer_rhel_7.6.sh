#----------------------------------------------------------------------------
#
# Package			: jackson-module-paranamer
# Version			: 2.10.2
# Source repo		: https://github.com/FasterXML/jackson-modules-base
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="jackson-module-paranamer"
PKG_VERSION=2.10.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/FasterXML/jackson-modules-base.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/jackson-modules-base-$PKG_VERSION
cd paranamer/
