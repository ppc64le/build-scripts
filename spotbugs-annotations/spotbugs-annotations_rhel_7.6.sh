# ----------------------------------------------------------------------------
#
# Package			: spotbugs-annotations
# Version			: 4.0.2
# Source repo		: https://github.com/spotbugs/spotbugs
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME="spotbugs-annotations"
PKG_VERSION=3.1.9
PKG_VERSION_LATEST=4.0.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/spotbugs/spotbugs.git"
...
#cd spotbugs-annotations/
#gradle build | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION-x.txt
...
cd spotbugs-annotations/
gradle build | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST-x.txt
...
#cd $PKG_NAME-master/
#cd spotbugs-annotations/
#gradle build | tee $LOGS_DIRECTORY/$PKG_NAME-x.txt
