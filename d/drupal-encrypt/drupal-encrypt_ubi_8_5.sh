...
# Version          : 8.x-3.0
# Source repo      : https://git.drupalcode.org/project/encrypt.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/encrypt.git
...
cd ../..
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/encrypt/tests/src/Unit; then
