...
# ----------------------------------------------------------------------------
# Package          : drupal-file_browser   
# Version          : 8.x-1.3
# Source repo      : https://git.drupalcode.org/project/file_browser
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# Variables
PACKAGE_NAME=file_browser
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/file_browser
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/file_browser/tests/src/ ; then
...
# drupal-file_browser has 2 types of test cases Functional and FunctionalJavascript. Functional and FunctionalJavascript need drupal framework to test. Unit can run without drupal framework setup.
 
# Please follow README.md file for drupal setup.

# To run all tests in one go :-

#bash-4.4# ../vendor/phpunit/phpunit/phpunit ../modules/file_browser/tests/src/

        # PHPUnit 7.5.20 by Sebastian Bergmann and contributors.

        # Testing ../modules/file_browser/tests/src/
        # .S                                                                  2 / 2 (100%)

        # Time: 1.93 minutes, Memory: 4.00 MB
