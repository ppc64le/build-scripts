# -----------------------------------------------------------------------------
#
# Package	: detect-port-alt
# Version	: 1.1.6
# Source repo	: https://github.com/node-modules/detect-port
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=detect-port-alt
PACKAGE_VERSION=1.1.6
PACKAGE_URL=https://github.com/node-modules/detect-port
