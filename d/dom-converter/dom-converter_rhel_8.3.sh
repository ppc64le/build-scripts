# -----------------------------------------------------------------------------
#
# Package	: dom-converter
# Version	: 0.2.0
# Source repo	: https://github.com/AriaMinaei/dom-converter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=dom-converter
PACKAGE_VERSION=0.2.0
PACKAGE_URL=https://github.com/AriaMinaei/dom-converter
