...
# ----------------------------------------------------------------------------
# Package          : drupal/views_data_export
# Version          : 1.0.0
# Source repo      : https://git.drupalcode.org/project/views_data_export
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=views_data_export
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/views_data_export
...
composer require drupal/xls_serialization:*
...
# Functional, Kernel tests need drupal framework to test.
# Functional test failure observed in parity with Intel
