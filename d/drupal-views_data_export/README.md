...
Follow automate_drupal.sh for more detail:-
	...
	bash-4.4# composer require drupal/rest:*
	bash-4.4# composer require drupal/views:*
	bash-4.4# composer require drupal/csv_serialization:*
	bash-4.4# composer require drupal/xls_serialization:*
...
Kernel tests :-
	...
	bash-4.4# ../vendor/phpunit/phpunit/phpunit ../modules/views_data_export/tests/src/Kernel/
	PHPUnit 7.5.20 by Sebastian Bergmann and contributors.
	
	Testing ../modules/views_data_export/tests/src/Kernel/
	.                                                                   1 / 1 (100%)
	
	Time: 5.36 seconds, Memory: 4.00 MB
...
Functional tests :-
	...
	bash-4.4# ../vendor/phpunit/phpunit/phpunit ../modules/views_data_export/tests/src/Functional/
	PHPUnit 7.5.20 by Sebastian Bergmann and contributors.
	
	Testing ../modules/views_data_export/tests/src/Functional/
	F.                                                                  2 / 2 (100%)
	
	Time: 8.75 minutes, Memory: 4.00 MB
	
	There was 1 failure:
	
	1) Drupal\Tests\views_data_export\Functional\ViewsDataExportBatchTest::testBatchCreation
	Count of exported nodes is wrong.
	Failed asserting that 4 matches expected 3.
	
	/opt/app-root/src/drupal/modules/views_data_export/tests/src/Functional/ViewsDataExportBatchTest.php:105
    ...
    1x in ViewsDataExportBatchTest::testBatchCreation from Drupal\Tests\views_data_export\Functional
    1x in ViewsDataExportTest::testHttpResponse from Drupal\Tests\views_data_export\Functional
