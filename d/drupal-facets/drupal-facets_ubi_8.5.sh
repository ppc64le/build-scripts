...
# Version          : 1.8.0
# Source repo      : https://git.drupalcode.org/project/facets
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/facets
...
# Functional, FunctionalJavascript, Kernel tests need drupal framework to test.
