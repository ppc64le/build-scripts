#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-media_entity_twitter
# Version          : 8.x-2.7
# Source repo      : https://git.drupalcode.org/project/media_entity_twitter
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=media_entity_twitter
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/media_entity_twitter
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-2.7}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/media_entity_twitter/tests; then
...
# drupal-media_entity_twitter has 2 types of test Functional/Kernel. Drupal framework is needed to run it. 
# Please follow README file for more information to run Functional/kernel testcases .
