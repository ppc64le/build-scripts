...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=extlink
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/extlink
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/extlink/tests; then
...
# drupal-extlink has one type of test FunctionalJavascript. Drupal framework is needed to run it. 
# Please follow README file for more information to run FunctionalJavascript testcases .
