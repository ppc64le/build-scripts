...
# ----------------------------------------------------------------------------
# Package          : slick_extras
# Version          : 8.x-1.0-rc5, 8.x-1.0-rc4
...
# Variables
PACKAGE_NAME=slick_extras
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/slick_extras
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.0-rc5}
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/$PACKAGE_NAME/slick_example/; then
