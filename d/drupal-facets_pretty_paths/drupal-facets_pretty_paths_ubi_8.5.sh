...
# Version          : 1.1.0
# Source repo      : https://git.drupalcode.org/project/facets_pretty_paths
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=facets_pretty_paths
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/facets_pretty_paths
