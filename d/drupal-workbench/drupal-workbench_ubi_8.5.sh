...
# Package          : workbench
# Version          : 8.x-1.3
# Source repo      : https://git.drupalcode.org/project/workbench.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/workbench.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/workbench/; then
