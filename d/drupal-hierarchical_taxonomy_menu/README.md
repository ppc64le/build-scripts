...
Clone the module which you wanted to test :-
    ...
    #git clone https://git.drupalcode.org/project/hierarchical_taxonomy_menu
...
Follow automate_drupal.sh for more detail:-
    ...
    #cd /opt/app-root/src/drupal/modules/hierarchical_taxonomy_menu
    bash-4.4# pwd
    /opt/app-root/src/drupal/modules/hierarchical_taxonomy_menu/
