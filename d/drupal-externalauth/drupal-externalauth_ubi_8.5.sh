...
# Variables
PACKAGE_NAME=externalauth
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/externalauth
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/externalauth/tests/src/Unit; then
...
# drupal-externalauth has 2 types of test Unit/Kernel.Unit test dont need drupal framework and DB etc. So can be executed by given script.
# Please follow README file for more information to run kernel test cases.
