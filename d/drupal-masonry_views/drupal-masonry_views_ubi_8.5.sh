#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-masonry_views
# Version          : 8.x-1.1
# Source repo      : https://git.drupalcode.org/project/masonry_views
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=masonry_views
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/masonry_views 
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/masonry_views/tests; then
...
#Time: 2.26 seconds, Memory: 4.00 MB
#No tests executed!
