...
# Source repo      : https://git.drupalcode.org/project/password_policy.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
PACKAGE_URL=https://git.drupalcode.org/project/password_policy.git
...
cd core/
 ...
 if ! ../vendor/phpunit/phpunit/phpunit ../modules/password_policy/tests; then
