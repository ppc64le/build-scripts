...
# Version          : 8.x-3.0
# Source repo      : https://git.drupalcode.org/project/password_policy
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# Variables
PACKAGE_NAME=password_policy
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/password_policy
...
# drupal-password_policy has only Functional test cases. Functional, Kernel tests need drupal framework to test. Unit tests can run without drupal framework setup.

# Follow https://github.com/ppc64le/build-scripts/blob/master/d/drupal-password_policy/README.md link for drupal setup.
​
...
# cd /opt/app-root/src/drupal/modules
# git clone  https://git.drupalcode.org/project/password_policy
# cd password_policy
# git checkout 8.x-3.0

# cd /opt/app-root/src/drupal/core/
# ../vendor/bin/drush pm:enable ctools
# ../vendor/bin/drush pm:enable password_policy

# ../vendor/phpunit/phpunit/phpunit ../modules/password_policy/tests
...
# Time: 3.63 minutes, Memory: 4.00 MB
