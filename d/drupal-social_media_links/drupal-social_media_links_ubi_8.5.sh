...
# Version          : 8.x-2.x
# Source repo      : https://git.drupalcode.org/project/social_media_links
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=social_media_links
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/social_media_links
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-2.8}
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/social_media_links/; then
