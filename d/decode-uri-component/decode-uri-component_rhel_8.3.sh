...
# Version	: 0.2.0
# Source repo	: https://github.com/samverschueren/decode-uri-component
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=decode-uri-component
PACKAGE_VERSION=0.2.0
PACKAGE_URL=https://github.com/samverschueren/decode-uri-component
