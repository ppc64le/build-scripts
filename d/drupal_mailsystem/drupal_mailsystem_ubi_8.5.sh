#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-mailsystem
# Version          : 8.x-4.3
# Source repo      : https://git.drupalcode.org/project/mailsystem
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=mailsystem
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/mailsystem
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-4.3}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/mailsystem/tests/src/Unit; then
...
# drupal-mailsystem has 2 types of test Unit/Functional.Unit test dont need drupal framework and DB etc. So can be executed by given script.
