#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-masonry 
# Version          : 8.x-1.2
# Source repo      : https://git.drupalcode.org/project/masonry 
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=masonry 
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/masonry 
