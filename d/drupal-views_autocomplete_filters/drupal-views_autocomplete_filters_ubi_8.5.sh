...
# ---------------------------------------------------------------------------
# Package          : drupal-views_autocomplete_filters
# Version          : 8.x-1.3
# Source repo      : https://git.drupalcode.org/project/views_autocomplete_filters
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=views_autocomplete_filters
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/views_autocomplete_filters/; then
