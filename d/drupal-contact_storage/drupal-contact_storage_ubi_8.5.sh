#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-contact_storage
# Version          : 8.x-1.1
# Source repo      : https://git.drupalcode.org/project/contact_storage
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=contact_storage
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/contact_storage
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/contact_storage/tests; then
...
# drupal-contact_storage has 2 types of test Functional/Kernel. Drupal framework is needed to run it. 
