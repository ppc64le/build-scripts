...
# Version          : 8.x-1.14 ,8.x-1.12
# Source repo      : https://git.drupalcode.org/project/gutenberg.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=gutenberg
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/gutenberg.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/gutenberg/; then
...
# drupal-gutenberg has no test cases.
