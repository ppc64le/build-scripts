...
# ----------------------------------------------------------------------------
# Package          : drupal/jquery_ui_slider
# Version          : 1.1.0
# Source repo      : https://git.drupalcode.org/project/jquery_ui_slider
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=jquery_ui_slider
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/jquery_ui_slider
