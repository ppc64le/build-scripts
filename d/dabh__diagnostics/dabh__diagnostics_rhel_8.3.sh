# -----------------------------------------------------------------------------
#
# Package	: @dabh/diagnostics
# Version	: 2.0.2
# Source repo	: https://github.com/3rd-Eden/diagnostics
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@dabh/diagnostics
PACKAGE_VERSION=2.0.2
PACKAGE_URL=https://github.com/3rd-Eden/diagnostics
