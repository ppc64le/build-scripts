#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-mimemail
# Version          : 8.x-1.0-alpha3
# Source repo      : https://git.drupalcode.org/project/mimemail
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=mimemail
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/mimemail
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.0-alpha3}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/mimemail/tests; then
...
# drupal-mimemail has 2 types of test Functional/Kernel. Drupal framework is needed to run it. 
