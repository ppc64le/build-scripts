#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-adminimal_admin_toolbar
# Version          : 8.x-1.11
# Source repo      : https://git.drupalcode.org/project/adminimal_admin_toolbar
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=adminimal_admin_toolbar
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/adminimal_admin_toolbar
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.11}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/adminimal_admin_toolbar; then
