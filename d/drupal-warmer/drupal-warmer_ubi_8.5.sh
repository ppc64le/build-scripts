...
# Maintainer       : Bhagat Singh <Bhagat.singh1@ibm.com>, Vishaka Desai <Vishaka.Desai@ibm.com>
#
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/warmer/tests/ --debug; then
...
# drupal-warmer has only unit test case. So no drupal framework is needed. Above script will work fine.
