# -----------------------------------------------------------------------------
#
# Package	: dns-prefetch-control
# Version	: 0.1.0
# Source repo	: https://github.com/helmetjs/dns-prefetch-control
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=dns-prefetch-control
PACKAGE_VERSION=0.1.0
PACKAGE_URL=https://github.com/helmetjs/dns-prefetch-control
