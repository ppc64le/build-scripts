...
# Package          : faqfield
# Version          : 8.x-7.0
# Source repo      : https://git.drupalcode.org/project/faqfield.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=faqfield
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/faqfield.git
CORE_PACKAGE_URL=https://github.com/drupal/drupal

PACKAGE_VERSION=${1:-8.x-7.0}
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/faqfield/; then
