...
# ----------------------------------------------------------------------------
# Package          : taxonomy_menu
# Version          : 8.x-3.x
# Source repo      : https://git.drupalcode.org/project/taxonomy_menu
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=taxonomy_menu
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/taxonomy_menu
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/taxonomy_menu/tests/src/Unit/; then
