...
# Package          : deprecated
# Version          : v1.2.18
# Source repo      : https://github.com/laurent-laporte-pro/deprecated
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v1.2.18}
PACKAGE_URL=https://github.com/laurent-laporte-pro/deprecated
PACKAGE_DIR=deprecated
