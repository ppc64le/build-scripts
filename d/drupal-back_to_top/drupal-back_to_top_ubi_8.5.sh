...
# ----------------------------------------------------------------------------
# Package          : drupal-back_to_top
# Version          : 8.x-1.1
# Source repo      : https://git.drupalcode.org/project/back_to_top
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=back_to_top
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/back_to_top
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/back_to_top; then
