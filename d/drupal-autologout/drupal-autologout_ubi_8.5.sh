...
# ----------------------------------------------------------------------------
# Package          : drupal/autologout
# Version          : 1.3.0
# Source repo      : https://git.drupalcode.org/project/autologout
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=autologout
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/autologout
...
# Functional tests need drupal framework to test.
