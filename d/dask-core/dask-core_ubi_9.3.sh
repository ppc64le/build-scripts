...
# Package          : dask-core
# Version          : 2024.5.0
# Source repo      : https://pypi.io/packages/source/d/dask/dask-2024.5.0.tar.gz
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_NAME=dask-core
PACKAGE_VERSION=${1:-2024.5.0}
PACKAGE_URL=https://pypi.io/packages/source/d/dask/dask-2024.5.0.tar.gz
PACKAGE_DIR=dask-core
