...
# Version	: 1.0.6
# Source repo	: https://github.com/tad-lispy/node-damerau-levenshtein
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=damerau-levenshtein
PACKAGE_VERSION=1.0.6
PACKAGE_URL=https://github.com/tad-lispy/node-damerau-levenshtein
