...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/flag/tests/src/Unit; then
...
# drupal-flag has 5 types of test Unit/Functional/Kernel/FunctionalJavascript/Traits. Unit test don't need drupal framework and DB etc. So can be executed by given script.
# Please follow README file for more information to run /Functional/Kernel/FunctionalJavascript/Traits test cases.
