...
Clone the module which you wanted to test :-
    ...
    #git clone https://git.drupalcode.org/project/schema_metatag
...
Follow automate_drupal.sh for more detail:-
    ...
    #cd /opt/app-root/src/drupal/modules/schema_metatag
    bash-4.4# pwd
    /opt/app-root/src/drupal/modules/schema_metatag/
