...
# Package          : diskcache
# Version          : v5.6.3
# Source repo      : https://github.com/grantjenks/python-diskcache
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v5.6.3}
PACKAGE_URL=https://github.com/grantjenks/python-diskcache
PACKAGE_DIR=diskcache
