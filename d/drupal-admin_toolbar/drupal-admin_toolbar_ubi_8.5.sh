...
# Version          : 3.0.0
# Source repo      : https://git.drupalcode.org/project/admin_toolbar
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=admin_toolbar
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/admin_toolbar
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/admin_toolbar/tests; then
...
# drupal-admin_toolbar has one type of test Functional. Drupal framework is needed to run it. 
