#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-message 
# Version          : 8.x-1.2
# Source repo      : https://git.drupalcode.org/project/message
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/message
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/message/tests/src/Unit; then
