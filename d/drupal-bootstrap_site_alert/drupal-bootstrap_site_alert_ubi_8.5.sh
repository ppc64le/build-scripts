...
# Version          : 8.x-1.9
# Source repo      : https://git.drupalcode.org/project/bootstrap_site_alert
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_NAME=bootstrap_site_alert
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/bootstrap_site_alert
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/bootstrap_site_alert/; then
