...
# Package	: d3-delaunay
# Version	: v6.0.4
# Source repo	: https://github.com/d3/d3-delaunay.git
# Tested on	: UBI: 8.5
# Language      : Javascript
# Travis-Check  : True
...
PACKAGE_NAME=d3-delaunay
PACKAGE_VERSION=${1:-v6.0.4}
PACKAGE_URL=https://github.com/d3/d3-delaunay.git
HOME_DIR=${PWD}
