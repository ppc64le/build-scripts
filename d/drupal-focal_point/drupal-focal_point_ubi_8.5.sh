...
# Package          : focal_point
# Version          : 8.x-1.5
# Source repo      : https://git.drupalcode.org/project/focal_point.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=focal_point
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/focal_point.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/focal_point/tests/src/Unit; then
...
# drupal-focal_point has 3 types of test Unit/Functional/FunctionalJavascript. Unit test don't need drupal framework and DB etc. So can be executed by given script.
# Please follow README file for more information to run /Functional/FunctionalJavascript test cases.
