...
# Package          : drupal-crop
# Version          : 8.x-2.1
# Source repo      : https://git.drupalcode.org/project/crop
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
PACKAGE_URL=https://git.drupalcode.org/project/crop
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-2.1}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/crop/tests; then
