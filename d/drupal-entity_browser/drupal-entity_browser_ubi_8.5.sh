...
# ----------------------------------------------------------------------------
# Package          : entity_browser
# Version          : 8.x-2.5,8.x-2.6
# Source repo      : https://git.drupalcode.org/project/entity_browser.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# Variables
PACKAGE_NAME=entity_browser
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/entity_browser.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/entity_browser/tests/src/; then
...
# drupal-entity_browser has 3 types of test Kernel/Functional/FunctionalJavascript. Unit test case is not avialable for this package.
