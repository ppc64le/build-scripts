...
# Variables
PACKAGE_NAME=autocomplete_deluxe
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/autocomplete_deluxe
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/autocomplete_deluxe/; then
