...
# Version	    : v5.0.3
# Source repo	    : https://github.com/browserify/diffie-hellman
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=diffie-hellman
PACKAGE_VERSION=${1:-v5.0.3}
PACKAGE_URL=https://github.com/browserify/diffie-hellman

export NODE_VERSION=${NODE_VERSION:-4}
