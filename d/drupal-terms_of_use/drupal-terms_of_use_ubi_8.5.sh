...
PACKAGE_NAME=terms_of_use
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/terms_of_use
CORE_PACKAGE_URL=https://github.com/drupal/drupal
PACKAGE_VERSION=${1:-8.x-2.2}
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/terms_of_use/; then
