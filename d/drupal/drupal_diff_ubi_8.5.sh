...
# Package       : drupal/diff
# Version       : 8.x-1.0
# Source repo   : https://git.drupalcode.org/project/diff.git
# Tested on     : UBI: 8.5
# Language      : PHP
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
#Run the sript ./drupal_diff_ubi_8.5.sh 8.x-1.0(version to test)
PACKAGE_NAME=diff
PACKAGE_VERSION=${1:-8.x-1.0}
PACKAGE_URL=https://git.drupalcode.org/project/diff.git
...
#Follow the step given in readme to test the functinal test cases.
