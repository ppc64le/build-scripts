#!/bin/bash -e
# -----------------------------------------------------------------------------
# Package       : drupal/editor_advanced_link
# Version       : 8.x-1.8
# Source repo   : https://git.drupalcode.org/project/editor_advanced_link.git
# Tested on     : UBI: 8.5
# Language      : PHP
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
#Run the sript ./drupal_editor_advanced_link_ubi_8.5.sh 8.x-1.8(version to test)
PACKAGE_NAME=editor_advanced_link
PACKAGE_VERSION=${1:-8.x-1.8}
PACKAGE_URL=https://git.drupalcode.org/project/editor_advanced_link.git
...
#Test cases not available for the current version
