...
# Version       : 8.x-3.6
# Source repo   : https://git.drupalcode.org/project/ctools.git
# Tested on     : UBI: 8.5
# Language      : PHP
# Travis-Check  : True
...
#
# ----------------------------------------------------------------------------
#Run the sript ./drupal_ctools_ubi_8.5.sh 8.x-3.6(version to test)
PACKAGE_NAME=ctools
PACKAGE_VERSION=${1:-8.x-3.6}
PACKAGE_URL=https://git.drupalcode.org/project/ctools.git
...
cd core
if ! ../vendor/bin/phpunit modules/ctools/tests/src/Unit ; then
