...
# Package          : addtoany
# Version          : 8.x-1.15
# Source repo      : https://git.drupalcode.org/project/addtoany.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=addtoany
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/addtoany.git
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/addtoany; then
