...
# ----------------------------------------------------------------------------
# Package          : session_based_temp_store
# Version          : 8.x-1.1
# Source repo      : https://git.drupalcode.org/project/session_based_temp_store
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# Variables
PACKAGE_NAME=session_based_temp_store
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/session_based_temp_store
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/session_based_temp_store/tests/; then
...
# drupal-session_based_temp_store has Functional test. Drupal framework is needed to run it. 
