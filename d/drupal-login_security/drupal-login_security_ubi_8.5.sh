#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-login_security
# Version          : 2.0.0
# Source repo      : https://git.drupalcode.org/project/login_security
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=login_security
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/login_security
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/login_security/tests; then
...
# drupal-login_security has 1 type of test Functional. Drupal framework is needed to run it. 
# Please follow README file for more information to run Functional testcases .

#Time: 2.63 minutes, Memory: 4.00 MB
