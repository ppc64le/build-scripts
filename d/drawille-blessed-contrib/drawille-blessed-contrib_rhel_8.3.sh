# -----------------------------------------------------------------------------
#
# Package	: drawille-blessed-contrib
# Version	: 1.0.0
# Source repo	: https://github.com/madbence/node-drawille
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=drawille-blessed-contrib
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/madbence/node-drawille
