# -----------------------------------------------------------------------------
#
# Package	: detect-conflict
# Version	: 1.0.1
# Source repo	: https://github.com/SBoudrias/detect-conflict
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=detect-conflict
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/SBoudrias/detect-conflict
