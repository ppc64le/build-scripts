...
# Package          : poll
# Version          : 8.x-1.4
# Source repo      : https://git.drupalcode.org/project/poll
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
PACKAGE_URL=https://git.drupalcode.org/project/poll
...
# drupal-poll has only Functional and Kernel test cases. Functional, Kernel tests need drupal framework to test. Unit tests can run without drupal framework setup.

# Follow https://github.com/ppc64le/build-scripts/blob/master/d/drupal-poll/README.md link for drupal setup.
​
# To Run all test cases in one go:
​
# cd /opt/app-root/src/drupal/modules
# git clone  https://git.drupalcode.org/project/poll
# cd poll
...
# ../vendor/bin/drush pm:enable poll

# ../vendor/phpunit/phpunit/phpunit ../modules/poll/tests
