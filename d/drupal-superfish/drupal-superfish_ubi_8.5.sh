...
# -----------------------------------------------------------------------------
#
# Package          : drupal/superfish
# Version          : 8.x-1.4
# Source repo      : https://git.drupalcode.org/project/superfish
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_NAME=superfish
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/superfish
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/superfish/; then
