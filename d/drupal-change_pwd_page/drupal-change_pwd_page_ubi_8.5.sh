...
# ---------------------------------------------------------------------------
# Package          : drupal-change_pwd_page
# Version          : 8.x-1.0
# Source repo      : https://git.drupalcode.org/project/change_pwd_page
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=change_pwd_page
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/change_pwd_page
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/change_pwd_page/; then
