#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-views_taxonomy_term_name_depth
# Version          : dev
# Source repo      : https://git.drupalcode.org/project/views_taxonomy_term_name_depth
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=views_taxonomy_term_name_depth
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/views_taxonomy_term_name_depth
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-dev}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/views_taxonomy_term_name_depth; then
...
#Time: 1.41 seconds, Memory: 4.00 MB
#No tests executed!
