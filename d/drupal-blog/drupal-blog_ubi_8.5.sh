...
# Package          : drupal-blog
# Version          : 8.x-2.x
# Source repo      : https://git.drupalcode.org/project/blog
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
PACKAGE_URL=https://git.drupalcode.org/project/blog
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/blog/tests; then
...
# drupal-blog has one type of test Functional. Drupal framework is needed to run it. 
# Please follow README file for more information to run Functional testcases .

#Time: 7.23 minutes, Memory: 4.00 MB
#OK (11 tests, 173 assertions)
