...
PACKAGE_URL=https://git.drupalcode.org/project/ultimate_cron
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-7.x-2.0}
...
#Unit test case.
if ! ../vendor/phpunit/phpunit/phpunit ../modules/ultimate_cron/tests/src/Unit; then
