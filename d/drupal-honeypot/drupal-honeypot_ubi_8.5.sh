...
# Package          : honeypot
# Version          : 2.0.1
# Source repo      : https://git.drupalcode.org/project/honeypot.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# Variables
PACKAGE_NAME=honeypot
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/honeypot.git
...
cd ../..
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/honeypot/tests/; then
...
# No Unit test case is avialable for this drupal-honeypot.
# drupal-honeypot has 1 types of test Functional. Drupal framework is needed to run it.
