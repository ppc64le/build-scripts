...
# ----------------------------------------------------------------------------
# Package          : flood_unblock
# Version          : 3.2.0
# Source repo      : https://git.drupalcode.org/project/flood_unblock.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# Variables
PACKAGE_NAME=flood_unblock
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/flood_unblock.git
