...
# Variables
PACKAGE_NAME=unlimited_number
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/unlimited_number
...
#Unit test case.
if ! ../vendor/phpunit/phpunit/phpunit ../modules/unlimited_number/tests/src/Unit; then
