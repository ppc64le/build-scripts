...
# Package          : token
# Version          : 8.x-1.9
# Source repo      : https://git.drupalcode.org/project/token
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
PACKAGE_URL=https://git.drupalcode.org/project/token
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/token/tests/; then
