...
# ----------------------------------------------------------------------------
# Package          : drupal/config_update
# Version          : 1.7.0
# Source repo      : https://git.drupalcode.org/project/config_update
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=config_update
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/config_update
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.7}
...
# drupal/config_update has only unit test case. So no drupal framework is needed. Above script will work fine.
