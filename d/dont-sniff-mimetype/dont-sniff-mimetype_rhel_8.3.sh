# -----------------------------------------------------------------------------
#
# Package	: dont-sniff-mimetype
# Version	: 1.0.0
# Source repo	: https://github.com/helmetjs/dont-sniff-mimetype
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=dont-sniff-mimetype
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/helmetjs/dont-sniff-mimetype
