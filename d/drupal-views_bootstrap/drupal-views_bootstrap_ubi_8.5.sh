...
# Variables
PACKAGE_NAME=views_bootstrap
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/views_bootstrap
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-5.3.x}
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/views_bootstrap/; then
