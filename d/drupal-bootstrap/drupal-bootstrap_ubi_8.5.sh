...
# Version          : 8.x-3.x
# Source repo      : https://git.drupalcode.org/project/bootstrap
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
PACKAGE_URL=https://git.drupalcode.org/project/bootstrap
...
if ! ../vendor/phpunit/phpunit/phpunit ../modules/bootstrap/; then
...
# drupal-bootstrap has no test cases.
