...
# -----------------------------------------------------------------------------
#
# Package       : user_pwreset_timeout
# Version       : 8.x-1.2
# Source repo   : https://git.drupalcode.org/project/user_pwreset_timeout
# Tested on     : UBI 8.5
# Language      : PHP
# Travis-Check  : True
...
PACKAGE_NAME=user_pwreset_timeout
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/user_pwreset_timeout
...
if !  ../vendor/phpunit/phpunit/phpunit ../modules/user_pwreset_timeout/; then
