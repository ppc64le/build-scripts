# -----------------------------------------------------------------------------
#
# Package	: default-compare
# Version	: 1.0.0
# Source repo	: https://github.com/doowb/default-compare
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=default-compare
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/doowb/default-compare
