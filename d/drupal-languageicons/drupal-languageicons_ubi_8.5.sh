#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : drupal-languageicons
# Version          : 8.x-1.0-beta3
# Source repo      : https://git.drupalcode.org/project/languageicons
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=languageicons
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/languageicons
CORE_PACKAGE_URL=https://github.com/drupal/drupal
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-8.x-1.0-beta3}
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/languageicons/tests; then
