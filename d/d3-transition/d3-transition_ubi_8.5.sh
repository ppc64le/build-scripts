...
# Version	: v3.0.1
# Source repo	: https://github.com/d3/d3-transition.git
# Tested on	: UBI: 8.5
# Language      : Javascript
# Travis-Check  : True
...
PACKAGE_NAME=d3-transition
PACKAGE_VERSION=${1:-v3.0.1}
PACKAGE_URL=https://github.com/d3/d3-transition.git
HOME_DIR=${PWD}
