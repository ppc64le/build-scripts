...
PACKAGE_NAME=snaker
PACKAGE_URL=https://github.com/serenize/snaker
PACKAGE_VERSION=${1:-de5293a32fd929048775e277fa6dd163bdeac7b3}
...
#clone package
mkdir -p $GOPATH/src/github.com/serenize
cd $GOPATH/src/github.com/serenize
