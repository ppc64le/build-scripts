...
# -----------------------------------------------------------------------------
#
# Package	    : stacktrace-gps
# Version	    : v3.1.2
# Source repo	    : https://github.com/stacktracejs/stacktrace-gps
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=stacktrace-gps
PACKAGE_VERSION=${1:-v3.1.2}
PACKAGE_URL=https://github.com/stacktracejs/stacktrace-gps
HOME_DIR=${PWD}
