# -----------------------------------------------------------------------------
#
# Package	: strict-uri-encode
# Version	: 1.1.0
# Source repo	: https://github.com/kevva/strict-uri-encode
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=strict-uri-encode
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/kevva/strict-uri-encode
