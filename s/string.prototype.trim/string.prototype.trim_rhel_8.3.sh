...
# Version	: 1.2.4
# Source repo	: https://github.com/es-shims/String.prototype.trim
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=string.prototype.trim
PACKAGE_VERSION=1.2.4
PACKAGE_URL=https://github.com/es-shims/String.prototype.trim
