# -----------------------------------------------------------------------------
#
# Package	: sebastian/resource-operations
# Version	: 2.0.1
# Source repo	: https://github.com/sebastianbergmann/resource-operations
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/resource-operations
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/sebastianbergmann/resource-operations
