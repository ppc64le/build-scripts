...
# Version	: v0.7.0
# Source repo	: https://github.com/kubernetes-sigs/controller-runtime
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sigs.k8s.io/controller-runtime
PACKAGE_VERSION=v0.7.0
PACKAGE_URL=https://github.com/kubernetes-sigs/controller-runtime
