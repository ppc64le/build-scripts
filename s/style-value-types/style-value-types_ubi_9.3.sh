...
DIR_NAME=popmotion
PACKAGE_NAME=style-value-types
PACKAGE_VERSION=${1:-adf681e}
PACKAGE_URL=https://github.com/Popmotion/popmotion
...
git clone $PACKAGE_URL $DIR_NAME
cd  $DIR_NAME
