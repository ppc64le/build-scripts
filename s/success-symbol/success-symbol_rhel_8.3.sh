# -----------------------------------------------------------------------------
#
# Package	: success-symbol
# Version	: 0.1.0
# Source repo	: https://github.com/jonschlinkert/success-symbol
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=success-symbol
PACKAGE_VERSION=0.1.0
PACKAGE_URL=https://github.com/jonschlinkert/success-symbol
