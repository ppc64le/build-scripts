...
# Version       : 2.1,2.3.3,3.0.0
# Source repo   : https://github.com/symfony-cmf/Routing
# Tested on     : UBI 8.5
# Language      : PHP
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/symfony-cmf/Routing
...
if ! composer require --dev  phpunit/phpunit --with-all-dependencies ^9 symfony/phpunit-bridge:*  -W && composer install; then
        echo "------------------$PACKAGE_NAME:install_fails-------------------------------------"
        echo "$PACKAGE_URL $PACKAGE_NAME"
        echo "$PACKAGE_NAME  |  $PACKAGE_URL | $PACKAGE_VERSION | $OS_NAME | GitHub | Fail |  Install_Fails"
        exit 0
fi
composer require jms/serializer:1.7.1 --dev
