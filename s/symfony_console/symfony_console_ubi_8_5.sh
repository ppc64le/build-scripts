...
sed -i 's/assertRegExp/assertMatchesRegularExpression/g' Tests/ApplicationTest.php
sed -i 's/assertNotRegExp/assertDoesNotMatchRegularExpression/g' Tests/ApplicationTest.php
sed -i 's/assertRegExp/assertMatchesRegularExpression/g' Tests/Command/ListCommandTest.php

if [[ $PACKAGE_VERSION == v5.1.3 ]] || [[ $PACKAGE_VERSION == v5.0.7 ]] || [[ $PACKAGE_VERSION == v3.4.41 ]] || [[ $PACKAGE_VERSION == v3.4.15 ]] || [[ $PACKAGE_VERSION == v2.8.52 ]]; then
