...
# Version	: 4.2.3
# Source repo	: https://github.com/sebastianbergmann/environment
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/environment
PACKAGE_VERSION=4.2.3
PACKAGE_URL=https://github.com/sebastianbergmann/environment
