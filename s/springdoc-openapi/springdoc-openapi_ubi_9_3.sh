...
# Version          : v2.6.0
# Source repo      : https://github.com/springdoc/springdoc-openapi
# Tested on        : UBI: 9.3
# Language         : Java
# Ci-Check     : True
...
# Variables
PACKAGE_NAME=springdoc-openapi
PACKAGE_URL=https://github.com/springdoc/springdoc-openapi
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-v2.6.0}

#Dependencies
yum install -y tzdata tzdata-java java-17-openjdk-devel git wget 
