# -----------------------------------------------------------------------------
#
# Package	: sirbrillig/phpcs-variable-analysis
# Version	: 2.11.0
# Source repo	: https://github.com/sirbrillig/phpcs-variable-analysis
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sirbrillig/phpcs-variable-analysis
PACKAGE_VERSION=2.11.0
PACKAGE_URL=https://github.com/sirbrillig/phpcs-variable-analysis
