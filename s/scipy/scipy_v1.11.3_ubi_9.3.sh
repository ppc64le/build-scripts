...
pip install meson 'wheel<0.39.0' beniget==0.4.0 pythran==0.12.1 pyproject_metadata==0.8.1 'pybind11>=2.10.4' gast==0.5.0 meson-python ninja numpy==1.21.6 'setuptools>=65.0' Cython==0.29.37 'meson-python<0.13.0,>=0.11.0' 'patchelf>=0.11.0' pooch pytest build
