...
# -----------------------------------------------------------------------------
#
# Package          : scrapegraph-py
# Version          : v2.1.2
# Source repo      : https://github.com/ScrapeGraphAI/scrapegraph-py
# Tested on     : UBI:9.3
# Language      : Python
# Ci-Check  : True
...
# Variables
PACKAGE_NAME=scrapegraph-py
PACKAGE_VERSION=${1:-v2.1.2}
PACKAGE_URL=https://github.com/ScrapeGraphAI/scrapegraph-py
PACKAGE_DIR=scrapegraph-py
