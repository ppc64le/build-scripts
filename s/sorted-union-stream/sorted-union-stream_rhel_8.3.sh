# -----------------------------------------------------------------------------
#
# Package	: sorted-union-stream
# Version	: 2.1.3
# Source repo	: https://github.com/mafintosh/sorted-union-stream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sorted-union-stream
PACKAGE_VERSION=2.1.3
PACKAGE_URL=https://github.com/mafintosh/sorted-union-stream
