...
# Version	: 0.2.0
# Source repo	: https://github.com/mathiasbynens/String.prototype.repeat
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=string.prototype.repeat
PACKAGE_VERSION=0.2.0
PACKAGE_URL=https://github.com/mathiasbynens/String.prototype.repeat
