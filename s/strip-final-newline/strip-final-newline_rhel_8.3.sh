...
# Version	: 2.0.0
# Source repo	: https://github.com/sindresorhus/strip-final-newline
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=strip-final-newline
PACKAGE_VERSION=2.0.0
PACKAGE_URL=https://github.com/sindresorhus/strip-final-newline
