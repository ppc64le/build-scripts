...
# Source repo	: https://github.com/kubernetes-sigs/kubebuilder
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sigs.k8s.io/kubebuilder
PACKAGE_VERSION=v1.0.9-0.20200513134826-f07a0146a40b
PACKAGE_URL=https://github.com/kubernetes-sigs/kubebuilder
