...
# Version	: 1.1.1
# Source repo	: https://github.com/sebastianbergmann/object-reflector
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/object-reflector
PACKAGE_VERSION=1.1.1
PACKAGE_URL=https://github.com/sebastianbergmann/object-reflector
