...
# Version	: 1.0.1
# Source repo	: https://github.com/sebastianbergmann/code-unit-reverse-lookup
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/code-unit-reverse-lookup
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/sebastianbergmann/code-unit-reverse-lookup
