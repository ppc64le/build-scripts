...
# Version       : 3.3.2
# Source repo   : https://github.com/spring-projects/spring-data-commons
# Tested on     : UBI: 9.3
# Language      : java
# Ci-Check  : True
...
export PACKAGE_NAME=spring-data-commons
export PACKAGE_URL=https://github.com/spring-projects/spring-data-commons
