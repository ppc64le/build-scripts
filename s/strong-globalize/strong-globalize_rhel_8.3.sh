# -----------------------------------------------------------------------------
#
# Package	: strong-globalize
# Version	: 6.0.5
# Source repo	: https://github.com/strongloop/strong-globalize
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=strong-globalize
PACKAGE_VERSION=6.0.5
PACKAGE_URL=https://github.com/strongloop/strong-globalize
