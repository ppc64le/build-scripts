...
# Version	: 0.2.1
# Source repo	: https://github.com/mathiasbynens/String.fromCodePoint
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=string.fromcodepoint
PACKAGE_VERSION=0.2.1
PACKAGE_URL=https://github.com/mathiasbynens/String.fromCodePoint
