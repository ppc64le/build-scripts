...
# Version       : sizeofag-1.0.4
# Source repo   : https://github.com/fracpete/sizeofag
# Tested on     : ubi: 8.3
...
PACKAGE_VERSION=sizeofag-1.0.4

echo "Usage: $0 [<PACKAGE_VERSION>]"
echo "       PACKAGE_VERSION is an optional paramater whose default value is sizeofag-1.0.4"

PACKAGE_VERSION="${1:-$PACKAGE_VERSION}"
PACKAGE_NAME=sizeofag
PACKAGE_URL=https://github.com/fracpete/sizeofag.git
