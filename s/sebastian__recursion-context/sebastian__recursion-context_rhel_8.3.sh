...
# Version	: 3
# Source repo	: https://github.com/sebastianbergmann/recursion-context
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/recursion-context
PACKAGE_VERSION=3
PACKAGE_URL=https://github.com/sebastianbergmann/recursion-context
