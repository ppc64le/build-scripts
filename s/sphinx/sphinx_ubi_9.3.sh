...
#Dependencies
yum install -y python3.12 python3.12-devel python3.12-pip ncurses git gcc-toolset-13 libffi libffi-devel sqlite 
yum install -y sqlite-devel sqlite-libs python3.12-pytest make cmake wget cargo rust openssl-devel graphviz
