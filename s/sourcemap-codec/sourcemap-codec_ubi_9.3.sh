...
# Version	    : v1.4.15
# Source repo	    : https://github.com/jridgewell/sourcemap-codec
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=sourcemap-codec
PACKAGE_VERSION=${1:-v1.4.15}
PACKAGE_URL=https://github.com/jridgewell/sourcemap-codec
