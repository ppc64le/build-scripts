...
# Package          : shellescape
# Version          : v3.8.1
# Source repo      : https://github.com/chrissimpkins/shellescape
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v3.8.1}
PACKAGE_URL=https://github.com/chrissimpkins/shellescape
PACKAGE_DIR=shellescape
