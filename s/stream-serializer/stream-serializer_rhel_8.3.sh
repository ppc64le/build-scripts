# -----------------------------------------------------------------------------
#
# Package	: stream-serializer
# Version	: 1.1.2
# Source repo	: https://github.com/dominictarr/stream-serializer
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=stream-serializer
PACKAGE_VERSION=1.1.2
PACKAGE_URL=https://github.com/dominictarr/stream-serializer
