...
# Version	: 1.0.1
# Source repo	: https://github.com/sindresorhus/set-immediate-shim
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=set-immediate-shim
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/sindresorhus/set-immediate-shim
