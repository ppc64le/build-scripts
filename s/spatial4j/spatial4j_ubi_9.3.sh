...
# Package       : spatial4j
# Version       : v0.8
# Source repo   : https://github.com/locationtech/spatial4j
# Tested on     : UBI 9.3
# Language      : Java
# Ci-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=spatial4j
PACKAGE_URL=https://github.com/locationtech/spatial4j.git
PACKAGE_VERSION=${1:-v0.8}
