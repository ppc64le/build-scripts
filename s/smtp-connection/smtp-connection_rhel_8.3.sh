# -----------------------------------------------------------------------------
#
# Package	: smtp-connection
# Version	: 2.12.0
# Source repo	: https://github.com/andris9/smtp-connection
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=smtp-connection
PACKAGE_VERSION=2.12.0
PACKAGE_URL=https://github.com/andris9/smtp-connection
