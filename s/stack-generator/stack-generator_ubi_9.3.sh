...
# -----------------------------------------------------------------------------
#
# Package	    : stack-generator
# Version	    : v2.0.10
# Source repo	    : https://github.com/stacktracejs/stack-generator
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=stack-generator
PACKAGE_VERSION=${1:-v2.0.10}
PACKAGE_URL=https://github.com/stacktracejs/stack-generator
HOME_DIR=${PWD}
