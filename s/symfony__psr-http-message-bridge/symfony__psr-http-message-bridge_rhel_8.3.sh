...
# Version	: 1.2.0
# Source repo	: https://github.com/symfony/psr-http-message-bridge
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=symfony/psr-http-message-bridge
PACKAGE_VERSION=1.2.0
PACKAGE_URL=https://github.com/symfony/psr-http-message-bridge
