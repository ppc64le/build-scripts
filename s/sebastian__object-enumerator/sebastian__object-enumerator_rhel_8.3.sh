...
# Version	: 3.0.3
# Source repo	: https://github.com/sebastianbergmann/object-enumerator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sebastian/object-enumerator
PACKAGE_VERSION=3.0.3
PACKAGE_URL=https://github.com/sebastianbergmann/object-enumerator
