...
# Version	: 2.1.0
# Source repo	: https://github.com/es-shims/String.prototype.trimLeft
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=string.prototype.trimleft
PACKAGE_VERSION=2.1.0
PACKAGE_URL=https://github.com/es-shims/String.prototype.trimLeft
