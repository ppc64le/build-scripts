# -----------------------------------------------------------------------------
#
# Package	: sort-keys-length
# Version	: 1.0.1
# Source repo	: https://github.com/kevva/sort-keys-length
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=sort-keys-length
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/kevva/sort-keys-length
