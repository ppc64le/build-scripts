...
# Version	: 1.22.1
# Source repo	: https://github.com/symfony/polyfill-intl-normalizer
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=symfony/polyfill-intl-normalizer
PACKAGE_VERSION=1.22.1
PACKAGE_URL=https://github.com/symfony/polyfill-intl-normalizer
