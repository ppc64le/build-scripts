...
# Version	: 3.5.0
# Source repo	: https://github.com/strongloop/strong-error-handler
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=strong-error-handler
PACKAGE_VERSION=3.5.0
PACKAGE_URL=https://github.com/strongloop/strong-error-handler
