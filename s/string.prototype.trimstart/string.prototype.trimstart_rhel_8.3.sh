...
# Version	: 1.0.4
# Source repo	: https://github.com/es-shims/String.prototype.trimStart
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=string.prototype.trimstart
PACKAGE_VERSION=1.0.4
PACKAGE_URL=https://github.com/es-shims/String.prototype.trimStart
