# -----------------------------------------------------------------------------
#
# Package	: sphinxcontrib-log-cabinet
# Version	: 1.0.1
# Source repo	: https://github.com/davidism/sphinxcontrib-log-cabinet
# Tested on	: RHEL 8.3
...
PACKAGE_URL=https://github.com/davidism/sphinxcontrib-log-cabinet
