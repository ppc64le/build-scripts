# -----------------------------------------------------------------------------
#
# Package	: symfony/polyfill-iconv
# Version	: 1.22.1
# Source repo	: https://github.com/symfony/polyfill-iconv
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=symfony/polyfill-iconv
PACKAGE_VERSION=1.22.1
PACKAGE_URL=https://github.com/symfony/polyfill-iconv
