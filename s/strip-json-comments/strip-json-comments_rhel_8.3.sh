...
# Version	: 3.1.0
# Source repo	: https://github.com/sindresorhus/strip-json-comments
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=strip-json-comments
PACKAGE_VERSION=3.1.0
PACKAGE_URL=https://github.com/sindresorhus/strip-json-comments
