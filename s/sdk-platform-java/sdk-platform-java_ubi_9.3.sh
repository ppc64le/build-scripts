...
# -----------------------------------------------------------------------------
#
# Package          : sdk-platform-java
# Version          : v2.44.0
# Source repo      : https://github.com/googleapis/sdk-platform-java.git
# Tested on        : UBI:9.3
# Language         : Java
# Ci-Check     : True
...
#variables
PACKAGE_NAME=sdk-platform-java
PACKAGE_URL=https://github.com/googleapis/sdk-platform-java.git
PACKAGE_VERSION=${1:-v2.44.0}
