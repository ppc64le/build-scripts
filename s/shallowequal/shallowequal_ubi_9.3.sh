...
# Version	    : 8e7f1b9
# Source repo	    : https://github.com/react-dnd/shallowequal
# Tested on	    : UBI 9.3
# Language          : Node
# Ci-Check      : True
...
PACKAGE_NAME=shallowequal
PACKAGE_VERSION=${1:-8e7f1b9}
PACKAGE_URL=https://github.com/react-dnd/shallowequal
