# -----------------------------------------------------------------------------
#
# Package	: salsify/json-streaming-parser
# Version	: 8.2.0
# Source repo	: https://github.com/salsify/jsonstreamingparser
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=salsify/json-streaming-parser
PACKAGE_VERSION=8.2.0
PACKAGE_URL=https://github.com/salsify/jsonstreamingparser
