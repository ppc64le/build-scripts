# -----------------------------------------------------------------------------
#
# Package	: semver-compare
# Version	: 1.0.0
# Source repo	: https://github.com/substack/semver-compare
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=semver-compare
PACKAGE_VERSION=1.0.0
PACKAGE_URL=https://github.com/substack/semver-compare
