...
# Version	: 1.1.1
# Source repo	: https://github.com/symfony/event-dispatcher-contracts
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=symfony/event-dispatcher-contracts
PACKAGE_VERSION=1.1.1
PACKAGE_URL=https://github.com/symfony/event-dispatcher-contracts
