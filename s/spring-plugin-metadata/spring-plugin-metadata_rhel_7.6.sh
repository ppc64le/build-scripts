# ----------------------------------------------------------------------------
#
# Package			: spring-plugin-metadata
# Version			: 1.2.0, 2.0.0
# Source repo		: https://github.com/spring-projects/spring-plugin
# Tested on			: RHEL 7.6
...
# variables
PKG_NAME=spring-plugin/metadata
PKG_VERSION=1.2.0
PKG_VERSION_LATEST=2.0.0	
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/spring-projects/spring-plugin.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/$PKG_VERSION.RELEASE
cd metadata/
...
git checkout -b $PKG_VERSION_LATEST tags/$PKG_VERSION_LATEST.RELEASE
cd metadata/
