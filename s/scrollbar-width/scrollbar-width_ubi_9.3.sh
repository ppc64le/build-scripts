...
# -----------------------------------------------------------------------------
#
# Package	    : scrollbar-width
# Version	    : v1.9.5
# Source repo	    : https://github.com/xobotyi/scrollbar-width
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=scrollbar-width
PACKAGE_VERSION=${1:-v1.9.5}
PACKAGE_URL=https://github.com/xobotyi/scrollbar-width
