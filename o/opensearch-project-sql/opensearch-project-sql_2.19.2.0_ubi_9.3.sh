...
OPENSEARCH_BUILD_VERSION=${PACKAGE_VERSION::-2}
...
export OPENSEARCH_DIST_PATH=file://${BUILD_HOME}/opensearch-build/tar/builds/opensearch/dist/opensearch-min-${OPENSEARCH_BUILD_VERSION}-SNAPSHOT-linux-ppc64le.tar.gz
...
# -----------------
ret=0
./gradlew integTest -PcustomDistributionUrl=file://${BUILD_HOME}/opensearch-build/tar/builds/opensearch/dist/opensearch-min-${OPENSEARCH_BUILD_VERSION}-SNAPSHOT-linux-ppc64le.tar.gz || ret=$?
if [ $ret -ne 0 ]; then
	set +ex
