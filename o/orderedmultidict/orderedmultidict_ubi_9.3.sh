...
# -----------------------------------------------------------------------------
#
# Package          : orderedmultidict
# Version          : v1.0.1
# Source repo      : https://github.com/gruns/orderedmultidict
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/gruns/orderedmultidict
PACKAGE_DIR=orderedmultidict
