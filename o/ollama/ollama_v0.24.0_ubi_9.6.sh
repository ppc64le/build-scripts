...
echo "** Downloading power specific patches **"
...
wget -O set_threads_env.patch https://raw.githubusercontent.com/ppc64le/build-scripts/refs/heads/master/o/ollama/set_threads_env_v0.24.0.patch
