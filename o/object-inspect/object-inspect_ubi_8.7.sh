...
# Version          : v1.10.3
# Source repo      : https://github.com/inspect-js/object-inspect
# Tested on	: UBI 8.7
# Language      : Node
# Ci-Check  : True
...
#
# ----------------------------------------------------------------------------
PACKAGE_NAME=object-inspect
PACKAGE_VERSION=${1:-v1.10.3}
PACKAGE_URL=https://github.com/inspect-js/object-inspect
