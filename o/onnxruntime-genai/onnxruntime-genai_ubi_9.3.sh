...
# Version          : v0.11.4
# Source repo      : https://github.com/microsoft/onnxruntime-genai
# Tested on     : UBI:9.3
# Language      : Python
# Ci-Check  : True
...
# Variables
PACKAGE_NAME=onnxruntime-genai
PACKAGE_VERSION=${1:-v0.11.4}
PACKAGE_URL=https://github.com/microsoft/onnxruntime-genai
PACKAGE_DIR=onnxruntime-genai
