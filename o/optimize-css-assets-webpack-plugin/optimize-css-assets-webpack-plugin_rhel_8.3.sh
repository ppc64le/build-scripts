# -----------------------------------------------------------------------------
#
# Package	: optimize-css-assets-webpack-plugin
# Version	: 5.0.3
# Source repo	: https://github.com/NMFR/optimize-css-assets-webpack-plugin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=optimize-css-assets-webpack-plugin
PACKAGE_VERSION=5.0.3
PACKAGE_URL=https://github.com/NMFR/optimize-css-assets-webpack-plugin
