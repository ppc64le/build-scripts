# -----------------------------------------------------------------------------
#
# Package	: @openapi-contrib/openapi-schema-to-json-schema
# Version	: 3.1.0
# Source repo	: https://github.com/openapi-contrib/openapi-schema-to-json-schema
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@openapi-contrib/openapi-schema-to-json-schema
PACKAGE_VERSION=3.1.0
PACKAGE_URL=https://github.com/openapi-contrib/openapi-schema-to-json-schema
