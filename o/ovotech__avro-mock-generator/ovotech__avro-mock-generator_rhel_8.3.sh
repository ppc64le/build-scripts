# -----------------------------------------------------------------------------
#
# Package	: @ovotech/avro-mock-generator
# Version	: 2.0.3
# Source repo	: https://github.com/ovotech/avro-mock-generator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@ovotech/avro-mock-generator
PACKAGE_VERSION=2.0.3
PACKAGE_URL=https://github.com/ovotech/avro-mock-generator
