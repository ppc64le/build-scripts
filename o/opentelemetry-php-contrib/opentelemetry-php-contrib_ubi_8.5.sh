...
composer install && echo "installation successful for opentelemetry-php-contrib."
./vendor/bin/phpunit && echo "tests successful for opentelemetry-php-contrib."
