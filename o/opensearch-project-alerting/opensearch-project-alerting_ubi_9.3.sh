...
if ! ./gradlew build -x :alerting:compileKotlin -x :alerting:compileTestKotlin -x :alerting:testingConventions ; then
...
if ! ./gradlew test -x :alerting:compileKotlin -x :alerting:compileTestKotlin ; then
