...
#commenting the backward compatibility tests
...
-PcustomDistributionUrl="$HOME/OpenSearch/distribution/archives/linux-ppc64le-tar/build/distributions/opensearch-min-2.19.2-SNAPSHOT-linux-ppc64le.tar.gz"; then
