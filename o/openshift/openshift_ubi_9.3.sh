...
# Package          : openshift
# Version          : v0.13.2
# Source repo      : https://github.com/openshift/openshift-restclient-python
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/openshift/openshift-restclient-python
PACKAGE_DIR=openshift
