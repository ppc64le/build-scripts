...
# -----------------------------------------------------------------------------
#
# Package          : asynchronous-search
# Version          : 2.19.2.0
# Source repo      : https://github.com/opensearch-project/asynchronous-search
# Tested on        : UBI:9.3
# Language         : Java
# Travis-Check     : True
...
PACKAGE_NAME=asynchronous-search
PACKAGE_URL=https://github.com/opensearch-project/asynchronous-search
...
if ! ./gradlew build -PcustomDistributionUrl="$wdir/OpenSearch/distribution/archives/linux-ppc64le-tar/build/distributions/opensearch-min-2.19.2-SNAPSHOT-linux-ppc64le.tar.gz"; then
