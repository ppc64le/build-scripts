...
# Package          : orjson
# Version          : 3.12.0
# Source repo      : https://github.com/ijl/orjson.git
# Tested on        : UBI:9.6
# Language         : Python
# Ci-Check         : True
...
# Variables
PACKAGE_NAME=orjson
PACKAGE_VERSION=${1:-"3.12.0"}
PACKAGE_URL=https://github.com/ijl/orjson.git
...
python3 -m pip install --upgrade pip setuptools wheel pytest  maturin puccinialin
