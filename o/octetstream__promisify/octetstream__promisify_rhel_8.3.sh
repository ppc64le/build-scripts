# -----------------------------------------------------------------------------
#
# Package	: @octetstream/promisify
# Version	: 2.0.2
# Source repo	: https://github.com/octet-stream/promisify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@octetstream/promisify
PACKAGE_VERSION=2.0.2
PACKAGE_URL=https://github.com/octet-stream/promisify
