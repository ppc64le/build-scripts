...
# Package	    : os-homedir
# Version	    : v1.0.2
# Source repo	    : https://github.com/sindresorhus/os-homedir
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_NAME=os-homedir
PACKAGE_VERSION=${1:-v1.0.2}
PACKAGE_URL=https://github.com/sindresorhus/os-homedir
...
if ! npm install ava@0.18.2; then
    echo "------------------$PACKAGE_NAME:install_fails-------------------------------------"
    echo "$PACKAGE_URL $PACKAGE_NAME"
    echo "$PACKAGE_NAME  |  $PACKAGE_URL | $PACKAGE_VERSION | GitHub | Fail |  Install_Fails"
    exit 1
