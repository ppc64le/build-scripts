...
# Version       : 3.0.2
# Source        : https://github.com/jonschlinkert/extend-shallow.git
# Tested on     : RHEL 7.6
...
git clone https://github.com/jonschlinkert/extend-shallow.git && cd extend-shallow
git checkout $PACKAGE_VERSION

npm install npm@6.14.5
npm install
sed -i -e 's/Object.assign ||//g'  index.js
npm test
