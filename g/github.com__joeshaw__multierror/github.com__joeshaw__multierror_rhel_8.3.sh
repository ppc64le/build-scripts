...
# Source repo	: https://github.com/joeshaw/multierror
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/joeshaw/multierror
PACKAGE_VERSION=v0.0.0-20140124173710-69b34d4ec901
PACKAGE_URL=https://github.com/joeshaw/multierror
