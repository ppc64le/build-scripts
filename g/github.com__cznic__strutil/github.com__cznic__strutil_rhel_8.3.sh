...
# Source repo	: https://github.com/cznic/strutil
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cznic/strutil
PACKAGE_VERSION=v0.0.0-20171016134553-529a34b1c186
PACKAGE_URL=https://github.com/cznic/strutil
