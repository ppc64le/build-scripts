...
# Source repo	: https://github.com/azure/azure-sdk-for-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/azure/azure-sdk-for-go
PACKAGE_VERSION=v36.1.0+incompatible
PACKAGE_URL=https://github.com/azure/azure-sdk-for-go
