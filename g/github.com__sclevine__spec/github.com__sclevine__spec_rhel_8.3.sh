# -----------------------------------------------------------------------------
#
# Package	: github.com/sclevine/spec
# Version	: v1.2.0
# Source repo	: https://github.com/sclevine/spec
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/sclevine/spec
PACKAGE_VERSION=v1.2.0
PACKAGE_URL=https://github.com/sclevine/spec
