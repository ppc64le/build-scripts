...
# Source repo	: https://github.com/bugsnag/osext
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/bugsnag/osext
PACKAGE_VERSION=v0.0.0-20130617224835-0dd3f918b21b
PACKAGE_URL=https://github.com/bugsnag/osext
