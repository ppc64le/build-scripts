...
# Source repo	: https://github.com/cznic/sortutil
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cznic/sortutil
PACKAGE_VERSION=v0.0.0-20150617083342-4c7342852e65
PACKAGE_URL=https://github.com/cznic/sortutil
