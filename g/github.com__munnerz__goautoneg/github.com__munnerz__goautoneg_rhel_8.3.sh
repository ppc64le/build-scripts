...
# Source repo	: https://github.com/munnerz/goautoneg
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/munnerz/goautoneg
PACKAGE_VERSION=v0.0.0-20191010083416-a7dc8b61c822
PACKAGE_URL=https://github.com/munnerz/goautoneg
