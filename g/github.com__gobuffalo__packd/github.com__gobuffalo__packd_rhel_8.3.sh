# -----------------------------------------------------------------------------
#
# Package	: github.com/gobuffalo/packd
# Version	: v0.3.0
# Source repo	: https://github.com/gobuffalo/packd
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/gobuffalo/packd
PACKAGE_VERSION=v0.3.0
PACKAGE_URL=https://github.com/gobuffalo/packd
