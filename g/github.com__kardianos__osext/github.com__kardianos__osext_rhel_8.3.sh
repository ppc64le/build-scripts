...
# Source repo	: https://github.com/kardianos/osext
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/kardianos/osext
PACKAGE_VERSION=v0.0.0-20190222173326-2bc1f35cddc0
PACKAGE_URL=https://github.com/kardianos/osext
