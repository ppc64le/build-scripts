...
# Source repo	: https://github.com/flynn/go-shlex
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/flynn/go-shlex
PACKAGE_VERSION=v0.0.0-20150515145356-3f9db97f8568
PACKAGE_URL=https://github.com/flynn/go-shlex
