# -----------------------------------------------------------------------------
#
# Package	: github.com/fsouza/fake-gcs-server
# Version	: v1.7.0
# Source repo	: https://github.com/fsouza/fake-gcs-server
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/fsouza/fake-gcs-server
PACKAGE_VERSION=v1.7.0
PACKAGE_URL=https://github.com/fsouza/fake-gcs-server
