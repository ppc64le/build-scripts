# -----------------------------------------------------------------------------
#
# Package	: g11n-pipeline-flatten
# Version	: 2.0.1
# Source repo	: https://github.com/srl295/gp-js-flatten
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=g11n-pipeline-flatten
PACKAGE_VERSION=2.0.1
PACKAGE_URL=https://github.com/srl295/gp-js-flatten
