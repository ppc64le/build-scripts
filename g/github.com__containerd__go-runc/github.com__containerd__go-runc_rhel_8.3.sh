...
# Source repo	: https://github.com/containerd/go-runc
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/containerd/go-runc
PACKAGE_VERSION=v0.0.0-20180907222934-5a6d9f37cfa3
PACKAGE_URL=https://github.com/containerd/go-runc
