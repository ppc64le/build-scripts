...
# Source repo	: https://github.com/mholt/certmagic
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mholt/certmagic
PACKAGE_VERSION=v0.6.2-0.20190624175158-6a42ef9fe8c2
PACKAGE_URL=https://github.com/mholt/certmagic
