# -----------------------------------------------------------------------------
#
# Package	: github.com/openshift/build-machinery-go
# Version	: v0.0.0-20200917070002-f171684f77ab
# Source repo	: https://github.com/openshift/build-machinery-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/openshift/build-machinery-go
PACKAGE_VERSION=v0.0.0-20200917070002-f171684f77ab
PACKAGE_URL=https://github.com/openshift/build-machinery-go
