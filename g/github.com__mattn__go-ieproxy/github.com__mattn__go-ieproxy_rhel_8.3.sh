...
# Source repo	: https://github.com/mattn/go-ieproxy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mattn/go-ieproxy
PACKAGE_VERSION=v0.0.0-20191113090002-7c0f6868bffe
PACKAGE_URL=https://github.com/mattn/go-ieproxy
