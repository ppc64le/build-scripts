# -----------------------------------------------------------------------------
#
# Package	: google-oauth-client-java6
# Version	: v1.27.0
# Source repo	: https://github.com/googleapis/google-oauth-java-client
# Tested on	: UBI 8.5
# Language	: JAVA
# Travis-Check	: True
...
HOME_DIR=`pwd`
PACKAGE_NAME=google-oauth-java-client/google-oauth-client-java6
PACKAGE_VERSION=${1:-v1.27.0}
PACKAGE_URL=https://github.com/googleapis/google-oauth-java-client
