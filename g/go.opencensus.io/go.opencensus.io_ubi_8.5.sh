...
# Version	: v0.22.5
# Source repo	: https://github.com/census-instrumentation/opencensus-go
# Tested on	: UBI 8.5
# Language      : GO
# Travis-Check  : True
...
PACKAGE_NAME=go.opencensus.io
PACKAGE_VERSION=${1:-v0.22.5}
PACKAGE_URL=https://github.com/census-instrumentation/opencensus-go
