# -----------------------------------------------------------------------------
#
# Package	: get-own-enumerable-property-symbols
# Version	: 3.0.2
# Source repo	: https://github.com/mightyiam/get-own-enumerable-property-symbols
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=get-own-enumerable-property-symbols
PACKAGE_VERSION=3.0.2
PACKAGE_URL=https://github.com/mightyiam/get-own-enumerable-property-symbols
