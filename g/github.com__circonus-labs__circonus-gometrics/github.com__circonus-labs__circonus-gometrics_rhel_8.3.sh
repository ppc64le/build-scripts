# -----------------------------------------------------------------------------
#
# Package	: github.com/circonus-labs/circonus-gometrics
# Version	: v2.3.1+incompatible
# Source repo	: https://github.com/circonus-labs/circonus-gometrics
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/circonus-labs/circonus-gometrics
PACKAGE_VERSION=v2.3.1+incompatible
PACKAGE_URL=https://github.com/circonus-labs/circonus-gometrics
