# -----------------------------------------------------------------------------
#
# Package	: github.com/jefferai/jsonx
# Version	: v1.0.0
# Source repo	: https://github.com/jefferai/jsonx
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jefferai/jsonx
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/jefferai/jsonx
