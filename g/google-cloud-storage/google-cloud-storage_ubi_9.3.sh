...
# Version          : v1.44.0
# Source repo      : https://github.com/googleapis/python-storage
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v1.44.0}
PACKAGE_URL=https://github.com/googleapis/python-storage
PACKAGE_DIR=google-cloud-storage
