# -----------------------------------------------------------------------------
#
# Package	: github.com/nwaples/rardecode
# Version	: v1.0.0
# Source repo	: https://github.com/nwaples/rardecode
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/nwaples/rardecode
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/nwaples/rardecode
