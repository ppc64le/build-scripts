# -----------------------------------------------------------------------------
#
# Package	: github.com/moby/term
# Version	: v0.0.0-20200312100748-672ec06f55cd
# Source repo	: https://github.com/moby/term
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/moby/term
PACKAGE_VERSION=v0.0.0-20200312100748-672ec06f55cd
PACKAGE_URL=https://github.com/moby/term
