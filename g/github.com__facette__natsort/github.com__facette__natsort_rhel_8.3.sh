# -----------------------------------------------------------------------------
#
# Package	: github.com/facette/natsort
# Version	: v0.0.0-20181210072756-2cd4dd1e2dcb
# Source repo	: https://github.com/facette/natsort
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/facette/natsort
PACKAGE_VERSION=v0.0.0-20181210072756-2cd4dd1e2dcb
PACKAGE_URL=https://github.com/facette/natsort
