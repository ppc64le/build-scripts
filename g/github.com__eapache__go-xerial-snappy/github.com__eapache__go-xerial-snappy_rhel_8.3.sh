...
# Source repo	: https://github.com/eapache/go-xerial-snappy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/eapache/go-xerial-snappy
PACKAGE_VERSION=v0.0.0-20180814174437-776d5712da21
PACKAGE_URL=https://github.com/eapache/go-xerial-snappy
