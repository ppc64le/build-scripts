# -----------------------------------------------------------------------------
#
# Package	: github.com/jackc/pgpassfile
# Version	: v1.0.0
# Source repo	: https://github.com/jackc/pgpassfile
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jackc/pgpassfile
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/jackc/pgpassfile
