# -----------------------------------------------------------------------------
#
# Package	: github.com/stoewer/go-strcase
# Version	: v1.2.0
# Source repo	: https://github.com/stoewer/go-strcase
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/stoewer/go-strcase
PACKAGE_VERSION=v1.2.0
PACKAGE_URL=https://github.com/stoewer/go-strcase
