# -----------------------------------------------------------------------------
#
# Package	: github.com/openzipkin-contrib/zipkin-go-opentracing
# Version	: v0.4.5
...
PACKAGE_NAME=github.com/openzipkin-contrib/zipkin-go-opentracing
PACKAGE_VERSION=v0.4.5
PACKAGE_URL=https://github.com/openzipkin-contrib/zipkin-go-opentracing
