...
# Source repo	: https://github.com/google/shlex
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/google/shlex
PACKAGE_VERSION=v0.0.0-20191202100458-e7afc7fbc510
PACKAGE_URL=https://github.com/google/shlex
