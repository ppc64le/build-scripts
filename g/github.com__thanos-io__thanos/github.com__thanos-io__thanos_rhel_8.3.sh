# -----------------------------------------------------------------------------
#
# Package	: github.com/thanos-io/thanos
# Version	: v0.11.0
# Source repo	: https://github.com/thanos-io/thanos
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/thanos-io/thanos
PACKAGE_VERSION=v0.11.0
PACKAGE_URL=https://github.com/thanos-io/thanos
