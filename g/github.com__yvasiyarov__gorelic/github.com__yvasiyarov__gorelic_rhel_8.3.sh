# -----------------------------------------------------------------------------
#
# Package	: github.com/yvasiyarov/gorelic
# Version	: v0.0.7
# Source repo	: https://github.com/yvasiyarov/gorelic
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/yvasiyarov/gorelic
PACKAGE_VERSION=v0.0.7
PACKAGE_URL=https://github.com/yvasiyarov/gorelic
