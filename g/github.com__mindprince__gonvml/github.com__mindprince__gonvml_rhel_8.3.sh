...
# Source repo	: https://github.com/mindprince/gonvml
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mindprince/gonvml
PACKAGE_VERSION=v0.0.0-20171110221305-fee913ce8fb2
PACKAGE_URL=https://github.com/mindprince/gonvml
