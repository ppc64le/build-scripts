# -----------------------------------------------------------------------------
#
# Package	: golang/snappy
# Version	: 2e65f85255dbc3072edf28d6b5b8efc472979f5a
# Source repo	: https://github.com/golang/snappy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=golang/snappy
PACKAGE_VERSION=2e65f85255dbc3072edf28d6b5b8efc472979f5a
PACKAGE_URL=https://github.com/golang/snappy
