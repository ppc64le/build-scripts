# -----------------------------------------------------------------------------
#
# Package	: gopkg.in/fsnotify/fsnotify.v1
# Version	: v1.4.7
# Source repo	: https://github.com/fsnotify/fsnotify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/fsnotify/fsnotify.v1
PACKAGE_VERSION=v1.4.7
PACKAGE_URL=https://github.com/fsnotify/fsnotify
