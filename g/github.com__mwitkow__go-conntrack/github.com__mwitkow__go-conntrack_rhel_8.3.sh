...
# Source repo	: https://github.com/mwitkow/go-conntrack
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mwitkow/go-conntrack
PACKAGE_VERSION=v0.0.0-20190716064945-2f068394615f
PACKAGE_URL=https://github.com/mwitkow/go-conntrack
