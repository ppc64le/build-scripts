# -----------------------------------------------------------------------------
#
# Package	: github.com/lucas-clemente/quic-clients
# Version	: v0.1.0
# Source repo	: https://github.com/lucas-clemente/quic-clients
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/lucas-clemente/quic-clients
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/lucas-clemente/quic-clients
