# -----------------------------------------------------------------------------
#
# Package	: hashicorp/go-immutable-radix
# Version	: v1.2.0
# Source repo	: https://github.com/hashicorp/go-immutable-radix
# Tested on	: RHEL 8.3
# Language      : GO
# Ci-Check  : False
...
PACKAGE_NAME=hashicorp/go-immutable-radix
PACKAGE_VERSION=v1.2.0
PACKAGE_URL=https://github.com/hashicorp/go-immutable-radix
