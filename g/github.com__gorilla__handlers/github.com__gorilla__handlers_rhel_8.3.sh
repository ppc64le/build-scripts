...
# Version	: v1.4.2
# Source repo	: https://github.com/gorilla/handlers
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/gorilla/handlers
PACKAGE_VERSION=v1.4.2
PACKAGE_URL=https://github.com/gorilla/handlers
