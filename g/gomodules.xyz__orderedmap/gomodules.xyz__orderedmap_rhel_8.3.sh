# -----------------------------------------------------------------------------
#
# Package	: gomodules.xyz/orderedmap
# Version	: v0.1.0
# Source repo	: https://github.com/gomodules/orderedmap
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gomodules.xyz/orderedmap
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/gomodules/orderedmap
