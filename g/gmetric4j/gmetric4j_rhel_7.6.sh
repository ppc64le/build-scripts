...
#
# Package			: gmetric4j
# Version			: 1.0.3, 1.0.10
# Source repo		: https://github.com/ganglia/gmetric4j
# Tested on			: RHEL 7.6
...
PKG_NAME="gmetric4j"
PKG_VERSION=1.0.3
PKG_VERSION_LATEST=1.0.10
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/ganglia/gmetric4j.git"
...
mvn -Dmaven.javadoc.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
...
mvn -Dmaven.javadoc.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION_LATEST.txt

# clone, build and test master
#cd $LOCAL_DIRECTORY
#git clone $REPOSITORY $PKG_NAME-master
#cd $PKG_NAME-master/
#mvn -Dmaven.javadoc.skip=true install | tee $LOGS_DIRECTORY/$PKG_NAME.txt
