...
# Version	: 1.0.1
# Source repo	: https://github.com/GrahamCampbell/Result-Type
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=graham-campbell/result-type
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/GrahamCampbell/Result-Type
