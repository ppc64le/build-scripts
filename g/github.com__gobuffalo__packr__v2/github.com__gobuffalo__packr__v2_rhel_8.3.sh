# -----------------------------------------------------------------------------
#
# Package	: github.com/gobuffalo/packr/v2
# Version	: v2.7.1
# Source repo	: https://github.com/gobuffalo/packr
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/gobuffalo/packr/v2
PACKAGE_VERSION=v2.7.1
PACKAGE_URL=https://github.com/gobuffalo/packr
