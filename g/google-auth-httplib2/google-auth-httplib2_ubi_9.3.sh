...
# Version          : v0.2.0
# Source repo      : https://github.com/GoogleCloudPlatform/google-auth-library-python-httplib2
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=google-auth-httplib2
PACKAGE_VERSION=${1:-v0.2.0}
PACKAGE_URL=https://github.com/GoogleCloudPlatform/google-auth-library-python-httplib2
PACKAGE_DIR=google-auth-httplib2
