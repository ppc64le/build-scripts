...
# Version	: v1.5.2
# Source repo	: https://github.com/russross/blackfriday
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/russross/blackfriday
PACKAGE_VERSION=v1.5.2
PACKAGE_URL=https://github.com/russross/blackfriday
