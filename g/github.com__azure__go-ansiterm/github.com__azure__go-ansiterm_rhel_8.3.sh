...
# Source repo	: https://github.com/azure/go-ansiterm
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/azure/go-ansiterm
PACKAGE_VERSION=v0.0.0-20170929234023-d6e3b3328b78
PACKAGE_URL=https://github.com/azure/go-ansiterm
