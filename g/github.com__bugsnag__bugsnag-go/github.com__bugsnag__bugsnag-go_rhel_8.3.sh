...
# Version	: v1.5.3
# Source repo	: https://github.com/bugsnag/bugsnag-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/bugsnag/bugsnag-go
PACKAGE_VERSION=v1.5.3
PACKAGE_URL=https://github.com/bugsnag/bugsnag-go
