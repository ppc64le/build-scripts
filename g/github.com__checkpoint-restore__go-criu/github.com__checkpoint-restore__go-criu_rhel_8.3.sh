...
# Source repo	: https://github.com/checkpoint-restore/go-criu
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/checkpoint-restore/go-criu
PACKAGE_VERSION=v0.0.0-20190109184317-bdb7599cd87b
PACKAGE_URL=https://github.com/checkpoint-restore/go-criu
