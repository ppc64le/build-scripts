...
# Source repo	: https://github.com/sean-/seed
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/sean-/seed
PACKAGE_VERSION=v0.0.0-20170313163322-e2103e2c3529
PACKAGE_URL=https://github.com/sean-/seed
