# -----------------------------------------------------------------------------
#
# Package	: github.com/alvaroloes/enumer
# Version	: v1.1.2
# Source repo	: https://github.com/alvaroloes/enumer
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/alvaroloes/enumer
PACKAGE_VERSION=v1.1.2
PACKAGE_URL=https://github.com/alvaroloes/enumer
