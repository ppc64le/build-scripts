...
# Source repo	: https://github.com/heketi/tests
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/heketi/tests
PACKAGE_VERSION=v0.0.0-20151005000721-f3775cbcefd6
PACKAGE_URL=https://github.com/heketi/tests
