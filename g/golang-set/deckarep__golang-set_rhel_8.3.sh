# -----------------------------------------------------------------------------
#
# Package	: deckarep/golang-set
# Version	: v1.7.1
# Source repo	: https://github.com/deckarep/golang-set
# Tested on	: RHEL 8.3
# Language      : GO
# Ci-Check  : False
...
PACKAGE_NAME=deckarep/golang-set
PACKAGE_VERSION=v1.7.1
PACKAGE_URL=https://github.com/deckarep/golang-set
