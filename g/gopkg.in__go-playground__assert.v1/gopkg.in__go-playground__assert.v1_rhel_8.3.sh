# -----------------------------------------------------------------------------
#
# Package	: gopkg.in/go-playground/assert.v1
# Version	: v1.2.1
# Source repo	: https://github.com/go-playground/assert
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/go-playground/assert.v1
PACKAGE_VERSION=v1.2.1
PACKAGE_URL=https://github.com/go-playground/assert
