...
# Version	: v1.7.5
# Source repo	: https://github.com/karrick/godirwalk
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/karrick/godirwalk
PACKAGE_VERSION=v1.7.5
PACKAGE_URL=https://github.com/karrick/godirwalk
