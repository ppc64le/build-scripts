...
# Source repo	: https://github.com/andreyvit/diff
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/andreyvit/diff
PACKAGE_VERSION=v0.0.0-20170406064948-c7f18ee00883
PACKAGE_URL=https://github.com/andreyvit/diff
