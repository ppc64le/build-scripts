# -----------------------------------------------------------------------------
#
# Package	: github.com/mozillazg/go-cos
# Version	: v0.13.0
# Source repo	: https://github.com/mozillazg/go-cos
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mozillazg/go-cos
PACKAGE_VERSION=v0.13.0
PACKAGE_URL=https://github.com/mozillazg/go-cos
