# -----------------------------------------------------------------------------
#
# Package	: github.com/jsonnet-bundler/jsonnet-bundler
# Version	: v0.3.1
# Source repo	: https://github.com/jsonnet-bundler/jsonnet-bundler
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jsonnet-bundler/jsonnet-bundler
PACKAGE_VERSION=v0.3.1
PACKAGE_URL=https://github.com/jsonnet-bundler/jsonnet-bundler
