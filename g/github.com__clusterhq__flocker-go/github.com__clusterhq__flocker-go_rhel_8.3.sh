...
# Source repo	: https://github.com/clusterhq/flocker-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/clusterhq/flocker-go
PACKAGE_VERSION=v0.0.0-20160920122132-2b8b7259d313
PACKAGE_URL=https://github.com/clusterhq/flocker-go
