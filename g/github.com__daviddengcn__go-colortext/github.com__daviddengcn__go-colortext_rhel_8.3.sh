...
# Source repo	: https://github.com/daviddengcn/go-colortext
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/daviddengcn/go-colortext
PACKAGE_VERSION=v0.0.0-20160507010035-511bcaf42ccd
PACKAGE_URL=https://github.com/daviddengcn/go-colortext
