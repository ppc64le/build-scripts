# -----------------------------------------------------------------------------
#
# Package	: github.com/xlab/treeprint
# Version	: v0.0.0-20180616005107-d6fb6747feb6
# Source repo	: https://github.com/xlab/treeprint
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/xlab/treeprint
PACKAGE_VERSION=v0.0.0-20180616005107-d6fb6747feb6
PACKAGE_URL=https://github.com/xlab/treeprint
