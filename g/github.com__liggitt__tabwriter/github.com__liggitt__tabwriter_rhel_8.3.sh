...
# Source repo	: https://github.com/liggitt/tabwriter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/liggitt/tabwriter
PACKAGE_VERSION=v0.0.0-20181228230101-89fcab3d43de
PACKAGE_URL=https://github.com/liggitt/tabwriter
