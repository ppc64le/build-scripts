...
# Source repo	: https://github.com/inconshreveable/log15
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/inconshreveable/log15.v2
PACKAGE_VERSION=v2.0.0-20180818164646-67afb5ed74ec
PACKAGE_URL=https://github.com/inconshreveable/log15
