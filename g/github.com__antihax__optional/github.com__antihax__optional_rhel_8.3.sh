# -----------------------------------------------------------------------------
#
# Package	: github.com/antihax/optional
# Version	: v1.0.0
# Source repo	: https://github.com/antihax/optional
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/antihax/optional
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/antihax/optional
