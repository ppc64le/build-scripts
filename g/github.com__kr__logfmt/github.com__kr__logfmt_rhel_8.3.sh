...
# Source repo	: https://github.com/kr/logfmt
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/kr/logfmt
PACKAGE_VERSION=v0.0.0-20140226030751-b84e30acd515
PACKAGE_URL=https://github.com/kr/logfmt
