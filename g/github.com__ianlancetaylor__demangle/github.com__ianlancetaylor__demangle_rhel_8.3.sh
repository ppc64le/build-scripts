# -----------------------------------------------------------------------------
#
# Package	: github.com/ianlancetaylor/demangle
# Version	: v0.0.0-20181102032728-5e5cf60278f6
# Source repo	: https://github.com/ianlancetaylor/demangle
# Tested on	: RHEL 8.3
...
PACKAGE_VERSION=v0.0.0-20181102032728-5e5cf60278f6
PACKAGE_URL=https://github.com/ianlancetaylor/demangle
