...
# Version	: v0.8.5
# Source repo	: https://github.com/cloudflare/cloudflare-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cloudflare/cloudflare-go
PACKAGE_VERSION=v0.8.5
PACKAGE_URL=https://github.com/cloudflare/cloudflare-go
