...
# Package          : google-auth
# Version          : v2.38.0
# Source repo      : https://github.com/googleapis/google-auth-library-python
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v2.38.0}
PACKAGE_URL=https://github.com/googleapis/google-auth-library-python
PACKAGE_DIR=google-auth
