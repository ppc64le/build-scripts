...
# Version	: v0.9.1
# Source repo	: https://github.com/jstemmer/go-junit-report
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jstemmer/go-junit-report
PACKAGE_VERSION=v0.9.1
PACKAGE_URL=https://github.com/jstemmer/go-junit-report
