...
# Version	: v0.3.5
# Source repo	: https://github.com/gotestyourself/gotestsum
# Language      : GO
# Ci-Check  : False
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gotest.tools/gotestsum
PACKAGE_VERSION=v0.3.5
PACKAGE_URL=https://github.com/gotestyourself/gotestsum
