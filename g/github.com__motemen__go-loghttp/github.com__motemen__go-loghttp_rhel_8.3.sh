# -----------------------------------------------------------------------------
#
# Package	: github.com/motemen/go-loghttp
# Version	: v0.0.0-20170804080138-974ac5ceac27
# Source repo	: https://github.com/motemen/go-loghttp
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/motemen/go-loghttp
PACKAGE_VERSION=v0.0.0-20170804080138-974ac5ceac27
PACKAGE_URL=https://github.com/motemen/go-loghttp
