# -----------------------------------------------------------------------------
#
# Package	: google-p12-pem
# Version	: 3.0.3
# Source repo	: https://github.com/googleapis/google-p12-pem
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=google-p12-pem
PACKAGE_VERSION=3.0.3
PACKAGE_URL=https://github.com/googleapis/google-p12-pem
