# -----------------------------------------------------------------------------
#
# Package	: github.com/operator-framework/operator-lib
# Version	: v0.1.0
# Source repo	: https://github.com/operator-framework/operator-lib
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/operator-framework/operator-lib
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/operator-framework/operator-lib
