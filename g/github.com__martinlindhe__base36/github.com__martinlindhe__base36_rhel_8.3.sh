# -----------------------------------------------------------------------------
#
# Package	: github.com/martinlindhe/base36
# Version	: v1.0.0
# Source repo	: https://github.com/martinlindhe/base36
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/martinlindhe/base36
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/martinlindhe/base36
