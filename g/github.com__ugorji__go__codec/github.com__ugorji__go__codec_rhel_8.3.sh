...
# Source repo	: https://github.com/ugorji/go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/ugorji/go/codec
PACKAGE_VERSION=v0.0.0-20181204163529-d75b2dcb6bc8
PACKAGE_URL=https://github.com/ugorji/go
