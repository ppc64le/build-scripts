...
# Source repo	: https://github.com/googleapis/gax-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/googleapis/gax-go
PACKAGE_VERSION=v2.0.2+incompatible
PACKAGE_URL=https://github.com/googleapis/gax-go
