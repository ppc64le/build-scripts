...
# Source repo	: https://github.com/ryanuber/columnize
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/ryanuber/columnize
PACKAGE_VERSION=v2.1.0+incompatible
PACKAGE_URL=https://github.com/ryanuber/columnize
