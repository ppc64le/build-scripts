...
# Source repo	: https://github.com/go-inf/inf
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=go-inf/inf
PACKAGE_VERSION=3887ee99ecf07df5b447e9b00d9c0b2adaa9f3e4
PACKAGE_URL=https://github.com/go-inf/inf
