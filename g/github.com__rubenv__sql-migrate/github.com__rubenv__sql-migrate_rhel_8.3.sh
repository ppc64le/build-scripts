...
# Source repo	: https://github.com/rubenv/sql-migrate
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/rubenv/sql-migrate
PACKAGE_VERSION=v0.0.0-20200616145509-8d140a17f351
PACKAGE_URL=https://github.com/rubenv/sql-migrate
