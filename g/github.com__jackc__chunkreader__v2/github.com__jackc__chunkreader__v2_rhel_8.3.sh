# -----------------------------------------------------------------------------
#
# Package	: github.com/jackc/chunkreader/v2
# Version	: v2.0.1
# Source repo	: https://github.com/jackc/chunkreader
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jackc/chunkreader/v2
PACKAGE_VERSION=v2.0.1
PACKAGE_URL=https://github.com/jackc/chunkreader
