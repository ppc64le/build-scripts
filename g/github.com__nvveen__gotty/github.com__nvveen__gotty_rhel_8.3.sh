...
# Source repo	: https://github.com/nvveen/gotty
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/nvveen/gotty
PACKAGE_VERSION=v0.0.0-20120604004816-cd527374f1e5
PACKAGE_URL=https://github.com/nvveen/gotty
