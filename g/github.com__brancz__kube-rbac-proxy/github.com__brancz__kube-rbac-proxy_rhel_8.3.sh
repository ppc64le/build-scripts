# -----------------------------------------------------------------------------
#
# Package	: github.com/brancz/kube-rbac-proxy
# Version	: v0.5.0
# Source repo	: https://github.com/brancz/kube-rbac-proxy
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/brancz/kube-rbac-proxy
PACKAGE_VERSION=v0.5.0
PACKAGE_URL=https://github.com/brancz/kube-rbac-proxy
