...
# Source repo	: https://github.com/wadey/gocovmerge
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/wadey/gocovmerge
PACKAGE_VERSION=v0.0.0-20160331181800-b5bfa59ec0ad
PACKAGE_URL=https://github.com/wadey/gocovmerge
