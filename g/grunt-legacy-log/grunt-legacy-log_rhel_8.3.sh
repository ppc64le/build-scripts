# -----------------------------------------------------------------------------
#
# Package	: grunt-legacy-log
# Version	: 3.0.0
# Source repo	: https://github.com/gruntjs/grunt-legacy-log
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=grunt-legacy-log
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/gruntjs/grunt-legacy-log
