...
# Version	: v9.30.2
# Source repo	: https://github.com/go-playground/validator
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/go-playground/validator.v9
PACKAGE_VERSION=v9.30.2
PACKAGE_URL=https://github.com/go-playground/validator
