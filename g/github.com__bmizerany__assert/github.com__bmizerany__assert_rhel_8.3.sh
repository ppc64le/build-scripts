...
# Source repo	: https://github.com/bmizerany/assert
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/bmizerany/assert
PACKAGE_VERSION=v0.0.0-20160611221934-b7ed37b82869
PACKAGE_URL=https://github.com/bmizerany/assert
