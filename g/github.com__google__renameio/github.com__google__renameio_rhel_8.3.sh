# -----------------------------------------------------------------------------
#
# Package	: github.com/google/renameio
# Version	: v0.1.0
# Source repo	: https://github.com/google/renameio
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/google/renameio
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/google/renameio
