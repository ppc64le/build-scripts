# -----------------------------------------------------------------------------
#
# Package	: github.com/dsnet/compress
# Version	: v0.0.1
# Source repo	: https://github.com/dsnet/compress
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/dsnet/compress
PACKAGE_VERSION=v0.0.1
PACKAGE_URL=https://github.com/dsnet/compress
