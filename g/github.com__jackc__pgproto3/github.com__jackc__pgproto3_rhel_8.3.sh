# -----------------------------------------------------------------------------
#
# Package	: github.com/jackc/pgproto3
# Version	: v1.1.0
# Source repo	: https://github.com/jackc/pgproto3
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/jackc/pgproto3
PACKAGE_VERSION=v1.1.0
PACKAGE_URL=https://github.com/jackc/pgproto3
