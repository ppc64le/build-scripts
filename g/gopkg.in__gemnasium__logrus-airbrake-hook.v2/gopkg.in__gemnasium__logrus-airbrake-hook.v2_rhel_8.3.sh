...
# Version	: v2.1.2
# Source repo	: https://github.com/gemnasium/logrus-airbrake-hook
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/gemnasium/logrus-airbrake-hook.v2
PACKAGE_VERSION=v2.1.2
PACKAGE_URL=https://github.com/gemnasium/logrus-airbrake-hook
