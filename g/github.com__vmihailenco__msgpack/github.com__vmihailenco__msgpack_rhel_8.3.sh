...
# Source repo	: https://github.com/vmihailenco/msgpack
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/vmihailenco/msgpack
PACKAGE_VERSION=v4.0.1+incompatible
PACKAGE_URL=https://github.com/vmihailenco/msgpack
