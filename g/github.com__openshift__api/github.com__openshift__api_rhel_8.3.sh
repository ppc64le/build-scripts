...
# Version	: v0.0.0-20201102162614-9252afb032e1
# Source repo	: https://github.com/openshift/api
# Tested on	: RHEL 8.3
...
PACKAGE_VERSION=v0.0.0-20201102162614-9252afb032e1
PACKAGE_URL=https://github.com/openshift/api
