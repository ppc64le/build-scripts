...
# Version	: v1.0.1
# Source repo	: https://github.com/smartystreets/assertions
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/smartystreets/assertions
PACKAGE_VERSION=v1.0.1
PACKAGE_URL=https://github.com/smartystreets/assertions
