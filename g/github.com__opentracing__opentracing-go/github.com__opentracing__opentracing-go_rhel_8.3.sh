...
# Version	: v1.1.0
# Source repo	: https://github.com/opentracing/opentracing-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/opentracing/opentracing-go
PACKAGE_VERSION=v1.1.0
PACKAGE_URL=https://github.com/opentracing/opentracing-go
