...
# Source repo	: https://github.com/docker/go-events
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/docker/go-events
PACKAGE_VERSION=v0.0.0-20190806004212-e31b211e4f1c
PACKAGE_URL=https://github.com/docker/go-events
