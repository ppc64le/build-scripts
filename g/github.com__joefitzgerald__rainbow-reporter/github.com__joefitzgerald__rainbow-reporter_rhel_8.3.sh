# -----------------------------------------------------------------------------
#
# Package	: github.com/joefitzgerald/rainbow-reporter
# Version	: v0.1.0
...
PACKAGE_NAME=github.com/joefitzgerald/rainbow-reporter
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/joefitzgerald/rainbow-reporter
