...
# Version	: v1.1.0
# Source repo	: https://github.com/spf13/jwalterweatherman
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/spf13/jwalterweatherman
PACKAGE_VERSION=v1.1.0
PACKAGE_URL=https://github.com/spf13/jwalterweatherman
