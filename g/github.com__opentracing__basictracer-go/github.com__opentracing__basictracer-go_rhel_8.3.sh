...
# Version	: v1.0.0
# Source repo	: https://github.com/opentracing/basictracer-go
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/opentracing/basictracer-go
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/opentracing/basictracer-go
