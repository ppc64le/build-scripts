# -----------------------------------------------------------------------------
#
# Package	: github.com/lovoo/gcloud-opentracing
# Version	: v0.3.0
# Source repo	: https://github.com/lovoo/gcloud-opentracing
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/lovoo/gcloud-opentracing
PACKAGE_VERSION=v0.3.0
PACKAGE_URL=https://github.com/lovoo/gcloud-opentracing
