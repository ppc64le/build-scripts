# -----------------------------------------------------------------------------
#
# Package	: github.com/lucas-clemente/quic-go-certificates
# Version	: v0.0.0-20160823095156-d2f86524cced
# Source repo	: https://github.com/lucas-clemente/quic-go-certificates
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/lucas-clemente/quic-go-certificates
PACKAGE_VERSION=v0.0.0-20160823095156-d2f86524cced
PACKAGE_URL=https://github.com/lucas-clemente/quic-go-certificates
