...
# Version	: v1.7.4
# Source repo	: https://github.com/klauspost/compress
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/klauspost/compress
PACKAGE_VERSION=v1.7.4
PACKAGE_URL=https://github.com/klauspost/compress
