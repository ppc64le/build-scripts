...
# Source repo	: https://github.com/cznic/mathutil
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cznic/mathutil
PACKAGE_VERSION=v0.0.0-20180504122225-ca4c9f2c1369
PACKAGE_URL=https://github.com/cznic/mathutil
