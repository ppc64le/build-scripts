...
# Source repo	: https://github.com/codahale/hdrhistogram
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/codahale/hdrhistogram
PACKAGE_VERSION=v0.0.0-20161010025455-3a0bb77429bd
PACKAGE_URL=https://github.com/codahale/hdrhistogram
