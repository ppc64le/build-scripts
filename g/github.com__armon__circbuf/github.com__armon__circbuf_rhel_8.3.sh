...
# Source repo	: https://github.com/armon/circbuf
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/armon/circbuf
PACKAGE_VERSION=v0.0.0-20150827004946-bbbad097214e
PACKAGE_URL=https://github.com/armon/circbuf
