# -----------------------------------------------------------------------------
#
# Package	: github.com/elastic/go-windows
# Version	: v1.0.1
# Source repo	: https://github.com/elastic/go-windows
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/elastic/go-windows
PACKAGE_VERSION=v1.0.1
PACKAGE_URL=https://github.com/elastic/go-windows
