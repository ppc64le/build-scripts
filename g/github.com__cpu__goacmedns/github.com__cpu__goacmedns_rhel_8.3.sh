# -----------------------------------------------------------------------------
#
# Package	: github.com/cpu/goacmedns
# Version	: v0.0.0-20180701200144-565ecf2a84df
# Source repo	: https://github.com/cpu/goacmedns
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cpu/goacmedns
PACKAGE_VERSION=v0.0.0-20180701200144-565ecf2a84df
PACKAGE_URL=https://github.com/cpu/goacmedns
