...
# Version	: v0.2.2
# Source repo	: https://github.com/cyphar/filepath-securejoin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/cyphar/filepath-securejoin
PACKAGE_VERSION=v0.2.2
PACKAGE_URL=https://github.com/cyphar/filepath-securejoin
