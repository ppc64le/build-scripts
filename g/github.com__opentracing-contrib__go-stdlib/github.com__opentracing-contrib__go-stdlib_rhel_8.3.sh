...
# Source repo	: https://github.com/opentracing-contrib/go-stdlib
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/opentracing-contrib/go-stdlib
PACKAGE_VERSION=v0.0.0-20190519235532-cf7a6c988dc9
PACKAGE_URL=https://github.com/opentracing-contrib/go-stdlib
