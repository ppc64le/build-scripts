...
# Source repo	: https://github.com/phayes/freeport
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/phayes/freeport
PACKAGE_VERSION=v0.0.0-20180830031419-95f893ade6f2
PACKAGE_URL=https://github.com/phayes/freeport
