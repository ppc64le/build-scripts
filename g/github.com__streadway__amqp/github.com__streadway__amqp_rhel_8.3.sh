...
# Source repo	: https://github.com/streadway/amqp
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/streadway/amqp
PACKAGE_VERSION=v0.0.0-20190827072141-edfb9018d271
PACKAGE_URL=https://github.com/streadway/amqp
