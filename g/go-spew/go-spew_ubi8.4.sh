...
#
# Package        : go-spew
# Version        : v0.0.0-20151105211317-5215b55f46b2 
# Source repo    : https://github.com/davecgh/go-spew.git
# Tested on      : UBI 8.4
# Language       : GO
# Travis-Check  : False
...
PACKAGE_URL=https://github.com/davecgh/go-spew.git
PACKAGE_NAME=go-spew
PACKAGE_VERSION=v0.0.0-20151105211317-5215b55f46b2
