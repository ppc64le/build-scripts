...
# Source repo	: https://github.com/go-check/check
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=gopkg.in/check.v1
PACKAGE_VERSION=v1.0.0-20200227125254-8fa46927fb4f
PACKAGE_URL=https://github.com/go-check/check
