# -----------------------------------------------------------------------------
#
# Package	: github.com/coredns/corefile-migration
# Version	: v1.0.2
# Source repo	: https://github.com/coredns/corefile-migration
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/coredns/corefile-migration
PACKAGE_VERSION=v1.0.2
PACKAGE_URL=https://github.com/coredns/corefile-migration
