...
# Version	: v0.20.0
# Source repo	: https://github.com/googleapis/google-api-go-client
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=google.golang.org/api
PACKAGE_VERSION=v0.20.0
PACKAGE_URL=https://github.com/googleapis/google-api-go-client
