# -----------------------------------------------------------------------------
#
# Package	: github.com/santhosh-tekuri/jsonschema
# Version	: v1.2.4
# Source repo	: https://github.com/santhosh-tekuri/jsonschema
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/santhosh-tekuri/jsonschema
PACKAGE_VERSION=v1.2.4
PACKAGE_URL=https://github.com/santhosh-tekuri/jsonschema
