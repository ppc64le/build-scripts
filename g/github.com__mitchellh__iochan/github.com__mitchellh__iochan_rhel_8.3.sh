# -----------------------------------------------------------------------------
#
# Package	: github.com/mitchellh/iochan
# Version	: v1.0.0
# Source repo	: https://github.com/mitchellh/iochan
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mitchellh/iochan
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/mitchellh/iochan
