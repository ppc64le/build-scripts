...
# Source repo	: https://github.com/xdg/scram
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/xdg/scram
PACKAGE_VERSION=v0.0.0-20180814205039-7eeb5667e42c
PACKAGE_URL=https://github.com/xdg/scram
