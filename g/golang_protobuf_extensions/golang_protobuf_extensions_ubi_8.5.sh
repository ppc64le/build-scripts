...
# Source repo   : https://github.com/matttproud/golang_protobuf_extensions.git
# Tested on     : UBI 8.5
# Language      : Go
# Ci-Check  : True
...
PACKAGE_VERSION=${1:-'v1.0.2-0.20181231171920-c182affec369'}
PACKAGE_URL=https://github.com/matttproud/golang_protobuf_extensions.git

yum -y update && yum install -y git wget gcc-c++
