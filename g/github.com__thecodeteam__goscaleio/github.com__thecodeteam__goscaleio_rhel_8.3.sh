# -----------------------------------------------------------------------------
#
# Package	: github.com/thecodeteam/goscaleio
# Version	: v0.1.0
# Source repo	: https://github.com/thecodeteam/goscaleio
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/thecodeteam/goscaleio
PACKAGE_VERSION=v0.1.0
PACKAGE_URL=https://github.com/thecodeteam/goscaleio
