...
# Source repo	: https://github.com/golang/glog
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/golang/glog
PACKAGE_VERSION=v0.0.0-20160126235308-23def4e6c14b
PACKAGE_URL=https://github.com/golang/glog
