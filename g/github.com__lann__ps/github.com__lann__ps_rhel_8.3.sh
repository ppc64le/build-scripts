...
# Source repo	: https://github.com/lann/ps
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/lann/ps
PACKAGE_VERSION=v0.0.0-20150810152359-62de8c46ede0
PACKAGE_URL=https://github.com/lann/ps
