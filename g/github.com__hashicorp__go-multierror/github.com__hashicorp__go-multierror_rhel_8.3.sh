...
# Version	: v1.0.0
# Source repo	: https://github.com/hashicorp/go-multierror
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/hashicorp/go-multierror
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/hashicorp/go-multierror
