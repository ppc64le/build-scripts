# -----------------------------------------------------------------------------
#
# Package	: github.com/golangplus/fmt
# Version	: v0.0.0-20150411045040-2a5d6d7d2995
# Source repo	: https://github.com/golangplus/fmt
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/golangplus/fmt
PACKAGE_VERSION=v0.0.0-20150411045040-2a5d6d7d2995
PACKAGE_URL=https://github.com/golangplus/fmt
