# -----------------------------------------------------------------------------
#
# Package	: github.com/pierrec/cmdflag
# Version	: v0.0.2
# Source repo	: https://github.com/pierrec/cmdflag
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/pierrec/cmdflag
PACKAGE_VERSION=v0.0.2
PACKAGE_URL=https://github.com/pierrec/cmdflag
