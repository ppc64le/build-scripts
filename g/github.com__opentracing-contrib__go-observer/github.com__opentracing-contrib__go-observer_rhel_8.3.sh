...
# Source repo	: https://github.com/opentracing-contrib/go-observer
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/opentracing-contrib/go-observer
PACKAGE_VERSION=v0.0.0-20170622124052-a52f23424492
PACKAGE_URL=https://github.com/opentracing-contrib/go-observer
