...
# Source repo	: https://github.com/heketi/rest
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/heketi/rest
PACKAGE_VERSION=v0.0.0-20180404230133-aa6a65207413
PACKAGE_URL=https://github.com/heketi/rest
