...
# Version          : v1.2.2
# Source repo      : https://github.com/GoogleCloudPlatform/google-auth-library-python-oauthlib
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_URL=https://github.com/GoogleCloudPlatform/google-auth-library-python-oauthlib
PACKAGE_DIR=google-auth-oauthlib
