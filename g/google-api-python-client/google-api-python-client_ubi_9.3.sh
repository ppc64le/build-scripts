...
# Version          : v1.12.11
# Source repo      : https://github.com/googleapis/google-api-python-client/
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-v1.12.11}
PACKAGE_URL=https://github.com/googleapis/google-api-python-client/
PACKAGE_DIR=google-api-python-client
