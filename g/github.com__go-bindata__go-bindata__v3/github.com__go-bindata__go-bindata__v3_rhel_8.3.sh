# -----------------------------------------------------------------------------
#
# Package	: github.com/go-bindata/go-bindata/v3
# Version	: v3.1.3
# Source repo	: https://github.com/go-bindata/go-bindata
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/go-bindata/go-bindata/v3
PACKAGE_VERSION=v3.1.3
PACKAGE_URL=https://github.com/go-bindata/go-bindata
