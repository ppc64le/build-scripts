...
# Source repo	: https://github.com/exponent-io/jsonpath
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/exponent-io/jsonpath
PACKAGE_VERSION=v0.0.0-20151013193312-d6023ce2651d
PACKAGE_URL=https://github.com/exponent-io/jsonpath
