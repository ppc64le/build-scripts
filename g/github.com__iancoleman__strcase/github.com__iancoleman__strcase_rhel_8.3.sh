...
# Source repo	: https://github.com/iancoleman/strcase
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/iancoleman/strcase
PACKAGE_VERSION=v0.0.0-20191112232945-16388991a334
PACKAGE_URL=https://github.com/iancoleman/strcase
