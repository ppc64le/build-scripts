...
# Source repo	: https://github.com/containerd/cgroups
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/containerd/cgroups
PACKAGE_VERSION=v0.0.0-20190919134610-bf292b21730f
PACKAGE_URL=https://github.com/containerd/cgroups
