...
# Source repo	: https://github.com/lann/builder
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/lann/builder
PACKAGE_VERSION=v0.0.0-20180802200727-47ae307949d0
PACKAGE_URL=https://github.com/lann/builder
