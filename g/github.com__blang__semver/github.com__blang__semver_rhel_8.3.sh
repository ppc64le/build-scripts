...
# Source repo	: https://github.com/blang/semver
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/blang/semver
PACKAGE_VERSION=v3.5.1+incompatible
PACKAGE_URL=https://github.com/blang/semver
