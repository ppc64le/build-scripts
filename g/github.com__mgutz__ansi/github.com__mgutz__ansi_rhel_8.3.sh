...
# Source repo	: https://github.com/mgutz/ansi
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/mgutz/ansi
PACKAGE_VERSION=v0.0.0-20170206155736-9520e82c474b
PACKAGE_URL=https://github.com/mgutz/ansi
