...
# Package	: gokrb5.v7
# Version	: v7.5.0
# Source repo	: https://github.com/jcmturner/gokrb5
# Tested on	: UBI 8.5
# Language      : GO
# Travis-Check  : True
...
PACKAGE_NAME=gopkg.in/jcmturner/gokrb5.v7
PACKAGE_VERSION=${1:-v7.5.0}
PACKAGE_URL=https://github.com/jcmturner/gokrb5
...
cd $(ls -d $GOPATH/pkg/mod/$PACKAGE_NAME*)
echo "Testing $PACKAGE_PATH with $PACKAGE_VERSION"
# Create a go.mod file for package module
