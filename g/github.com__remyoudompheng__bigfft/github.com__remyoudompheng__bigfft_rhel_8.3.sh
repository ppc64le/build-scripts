...
# Source repo	: https://github.com/remyoudompheng/bigfft
# Tested on	: RHEL 8.3
...
PACKAGE_VERSION=v0.0.0-20170806203942-52369c62f446
PACKAGE_URL=https://github.com/remyoudompheng/bigfft
