...
# Source repo	: https://github.com/auth0/go-jwt-middleware
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/auth0/go-jwt-middleware
PACKAGE_VERSION=v0.0.0-20170425171159-5493cabe49f7
PACKAGE_URL=https://github.com/auth0/go-jwt-middleware
