...
# Source repo	: https://github.com/go-ozzo/ozzo-validation
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/go-ozzo/ozzo-validation
PACKAGE_VERSION=v3.5.0+incompatible
PACKAGE_URL=https://github.com/go-ozzo/ozzo-validation
