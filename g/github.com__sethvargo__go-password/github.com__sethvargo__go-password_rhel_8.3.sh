# -----------------------------------------------------------------------------
#
# Package	: github.com/sethvargo/go-password
# Version	: v0.2.0
# Source repo	: https://github.com/sethvargo/go-password
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=github.com/sethvargo/go-password
PACKAGE_VERSION=v0.2.0
PACKAGE_URL=https://github.com/sethvargo/go-password
