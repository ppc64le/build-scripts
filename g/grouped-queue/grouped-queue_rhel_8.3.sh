# -----------------------------------------------------------------------------
#
# Package	: grouped-queue
# Version	: 1.1.0
# Source repo	: https://github.com/SBoudrias/grouped-queue
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=grouped-queue
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/SBoudrias/grouped-queue
