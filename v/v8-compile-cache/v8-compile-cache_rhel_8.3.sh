# -----------------------------------------------------------------------------
#
# Package	: v8-compile-cache
# Version	: 2.3.0
# Source repo	: https://github.com/zertosh/v8-compile-cache
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=v8-compile-cache
PACKAGE_VERSION=2.3.0
PACKAGE_URL=https://github.com/zertosh/v8-compile-cache
