#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : votingapi_widgets
# Version          : 8.x-1.x
# Source repo      : https://git.drupalcode.org/project/votingapi_widgets.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : True
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=votingapi_widgets
CORE_PACKAGE_NAME=drupal
PACKAGE_URL=https://git.drupalcode.org/project/votingapi_widgets.git
...
if ! ../vendor/bin/phpunit ../modules/votingapi_widgets/; then
...
#bash-4.4# ../vendor/bin/phpunit ../modules/votingapi_widgets/
#PHPUnit 7.5.20 by Sebastian Bergmann and contributors.

#Time: 835 ms, Memory: 4.00 MB
