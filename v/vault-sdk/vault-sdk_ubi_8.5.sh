...
PACKAGE_NAME=vault
SUB_PACKAGE_NAME=vault-sdk
#PACKAGE_VERSION is configurable can be passed as an argument.
PACKAGE_VERSION=${1:-sdk/v0.2.1}
...
# Test is in parity with intel with 1 test case failure. 
 #--- FAIL: TestNewConfigEntry (0.00s)
  #   --- FAIL: TestNewConfigEntry/equality_check (0.00s)
   #      config_test.go:44: bad, diff: []string{"CaseSensitiveNames: bool != <nil pointer>"}
