#!/bin/bash -e
# ----------------------------------------------------------------------------
# Package          : views_custom_cache_tag
# Version          : 8.x-1.2
# Source repo      : https://git.drupalcode.org/project/views_custom_cache_tag.git
# Tested on        : UBI 8.5
# Language         : PHP
# Travis-Check     : False
...
# ----------------------------------------------------------------------------
# Variables
PACKAGE_NAME=views_custom_cache_tag
PACKAGE_VERSION=${1:-8.x-1.2}
PACKAGE_URL=https://git.drupalcode.org/project/views_custom_cache_tag.git
...
cd ../../
cd core/
if ! ../vendor/phpunit/phpunit/phpunit ../modules/views_custom_cache_tag/tests/; then
...
#No Unit test case in this package
# views_custom_cache_tag has 1 types of test Functional . 
