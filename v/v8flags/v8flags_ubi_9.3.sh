...
# Package	    : v8flags
# Version	    : v4.0.1
# Source repo	    : https://github.com/gulpjs/v8flags
# Tested on	    : UBI 9.3
# Language          : Node
# Ci-Check      : True
...
PACKAGE_NAME=v8flags
PACKAGE_VERSION=${1:-v4.0.1}
PACKAGE_URL=https://github.com/gulpjs/v8flags
...
# Tests commented because they fail inside docker container. Command is npm test.
