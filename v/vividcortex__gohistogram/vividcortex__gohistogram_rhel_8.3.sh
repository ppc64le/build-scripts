# -----------------------------------------------------------------------------
#
# Package	: vividcortex/gohistogram
# Version	: v1.0.0
# Source repo	: https://github.com/vividcortex/gohistogram
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=vividcortex/gohistogram
PACKAGE_VERSION=v1.0.0
PACKAGE_URL=https://github.com/vividcortex/gohistogram
