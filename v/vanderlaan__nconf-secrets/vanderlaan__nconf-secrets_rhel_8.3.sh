# -----------------------------------------------------------------------------
#
# Package	: @vanderlaan/nconf-secrets
# Version	: 1.0.1
# Source repo	: https://github.com/bvanderlaan/nconf-secrets
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=@vanderlaan/nconf-secrets
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/bvanderlaan/nconf-secrets
