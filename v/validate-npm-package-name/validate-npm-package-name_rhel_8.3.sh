...
# Version	: 3.0.0
# Source repo	: https://github.com/npm/validate-npm-package-name
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=validate-npm-package-name
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/npm/validate-npm-package-name
