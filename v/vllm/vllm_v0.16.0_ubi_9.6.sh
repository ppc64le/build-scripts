...
#Temporary workaround for PPC64LE builds of vLLM CPU extension
#The template instantiation `mla_decode_kvcache_cpu_impl<scalar_t, 576, 512, 16>`in `mla_decode.cpp` is not implemented for BF16 on Power9/Power10 VSX.
#This makes `qk_vec_type` resolve to void, causing compile-time errors:
