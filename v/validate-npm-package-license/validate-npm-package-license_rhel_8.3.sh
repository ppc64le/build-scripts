...
# Version	: 3.0.1
# Source repo	: https://github.com/kemitchell/validate-npm-package-license.js
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=validate-npm-package-license
PACKAGE_VERSION=3.0.1
PACKAGE_URL=https://github.com/kemitchell/validate-npm-package-license.js
