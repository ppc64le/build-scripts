...
# Version          : 0.5.7
# Source repo      : https://github.com/edwardgeorge/virtualenv-clone
# Tested on	: UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-0.5.7}
PACKAGE_URL=https://github.com/edwardgeorge/virtualenv-clone
PACKAGE_DIR=virtualenv-clone
