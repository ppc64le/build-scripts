...
# Version	: 1.0.1
# Source repo	: https://github.com/goinstant/buffer-equal-constant-time
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=buffer-equal-constant-time
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/goinstant/buffer-equal-constant-time
