...
# -----------------------------------------------------------------------------
#
# Package          : browsergym-core
# Version          : v0.14.3
# Source repo      : https://github.com/ServiceNow/BrowserGym
# Tested on     : UBI:9.3
# Language      : Python
# Ci-Check  : True
...
# Variables
PACKAGE_NAME=browsergym-core
PACKAGE_VERSION=${1:-v0.14.3}
PACKAGE_URL=https://github.com/ServiceNow/BrowserGym
PACKAGE_DIR=browsergym-core
