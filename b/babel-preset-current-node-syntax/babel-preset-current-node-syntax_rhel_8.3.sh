...
# Version	: 0.1.4
# Source repo	: https://github.com/nicolo-ribaudo/babel-preset-current-node-syntax
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=babel-preset-current-node-syntax
PACKAGE_VERSION=0.1.4
PACKAGE_URL=https://github.com/nicolo-ribaudo/babel-preset-current-node-syntax
