# -----------------------------------------------------------------------------
#
# Package	: bunyan-prettystream
# Version	: 0.1.3
# Source repo	: https://github.com/mrrama/node-bunyan-prettystream
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=bunyan-prettystream
PACKAGE_VERSION=0.1.3
PACKAGE_URL=https://github.com/mrrama/node-bunyan-prettystream
