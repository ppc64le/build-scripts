...
# Version	: 1.0.1
# Source repo	: https://github.com/crypto-browserify/browserify-cipher
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=browserify-cipher
PACKAGE_VERSION=1.0.1
PACKAGE_URL=https://github.com/crypto-browserify/browserify-cipher
