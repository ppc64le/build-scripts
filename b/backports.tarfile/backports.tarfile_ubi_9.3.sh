...
# -----------------------------------------------------------------------------
#
# Package          : backports.tarfile
# Version          : v1.2.0
# Source repo      : https://github.com/jaraco/backports.tarfile
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=backports.tarfile
PACKAGE_VERSION=${1:-v1.2.0}
PACKAGE_URL=https://github.com/jaraco/backports.tarfile
PACKAGE_DIR=backports.tarfile
