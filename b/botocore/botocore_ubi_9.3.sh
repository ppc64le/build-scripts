...
# Package          : botocore
# Version          : 1.36.3
# Source repo      : https://github.com/boto/botocore
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
PACKAGE_VERSION=${1:-1.36.3}
PACKAGE_URL=https://github.com/boto/botocore
PACKAGE_DIR=botocore
...
(python3 -m pytest tests/unit/ tests/functional/) && test_status=0 || test_status=$?
