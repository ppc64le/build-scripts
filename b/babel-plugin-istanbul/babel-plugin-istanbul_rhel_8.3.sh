...
# Version	: 5.2.0
# Source repo	: https://github.com/istanbuljs/babel-plugin-istanbul
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=babel-plugin-istanbul
PACKAGE_VERSION=5.2.0
PACKAGE_URL=https://github.com/istanbuljs/babel-plugin-istanbul
