# -----------------------------------------------------------------------------
#
# Package	: buffer-indexof
# Version	: 1.1.1
# Source repo	: https://github.com/soldair/node-buffer-indexof
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=buffer-indexof
PACKAGE_VERSION=1.1.1
PACKAGE_URL=https://github.com/soldair/node-buffer-indexof
