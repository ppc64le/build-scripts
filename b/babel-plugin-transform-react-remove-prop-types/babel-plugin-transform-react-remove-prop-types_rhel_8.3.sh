# -----------------------------------------------------------------------------
#
# Package	: babel-plugin-transform-react-remove-prop-types
# Version	: 0.4.24
# Source repo	: https://github.com/oliviertassinari/babel-plugin-transform-react-remove-prop-types
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=babel-plugin-transform-react-remove-prop-types
PACKAGE_VERSION=0.4.24
PACKAGE_URL=https://github.com/oliviertassinari/babel-plugin-transform-react-remove-prop-types
