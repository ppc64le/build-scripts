...
# Version	: 3.0.0
# Source repo	: https://github.com/bendrucker/builtin-status-codes
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=builtin-status-codes
PACKAGE_VERSION=3.0.0
PACKAGE_URL=https://github.com/bendrucker/builtin-status-codes
