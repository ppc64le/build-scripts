# -----------------------------------------------------------------------------
#
# Package	: buffer-indexof-polyfill
# Version	: 1.0.2
# Source repo	: https://github.com/sarosia/buffer-indexof-polyfill
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=buffer-indexof-polyfill
PACKAGE_VERSION=1.0.2
PACKAGE_URL=https://github.com/sarosia/buffer-indexof-polyfill
