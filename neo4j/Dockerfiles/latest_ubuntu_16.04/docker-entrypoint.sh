...
#
# This file is originally available at <https://github.com/neo4j/docker-neo4j-publish/blob/eb6334f976453d0d8530a67b086ff96875a0742f/3.4.0/community/docker-entrypoint.sh>
# Please note that original file and derivatives are available under
# following license(s):
# Apache-2.0
# -----------------------------------------------------------------------------
#!/bin/bash -eu
