...
# Package			: javax.json	
# Version			: 1.1.2
# Source repo		: https://github.com/javaee/jsonp
# Tested on			: RHEL 7.6
...
PKG_NAME="javax.json"
PKG_VERSION=1.0
PKG_VERSION_LATEST=1.1.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/javaee/jsonp.git"

# clone, build and test specified version
#cd $LOCAL_DIRECTORY
#git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
#cd $PKG_NAME-$PKG_VERSION/
#git checkout -b $PKG_VERSION tags/json-$PKG_VERSION
...
git checkout -b $PKG_VERSION_LATEST tags/jsonp-$PKG_VERSION_LATEST
