...
# Version	: 4.0.1
# Source repo	: https://github.com/davidmarkclements/quick-format
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=quick-format-unescaped
PACKAGE_VERSION=4.0.1
PACKAGE_URL=https://github.com/davidmarkclements/quick-format
