...
# Version	: 6.13.7
# Source repo	: https://github.com/sindresorhus/query-string
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=query-string
PACKAGE_VERSION=6.13.7
PACKAGE_URL=https://github.com/sindresorhus/query-string
