...
# Package          : quantreg
# Version          : 5.98
# Source repo      : https://github.com/cran/quantreg.git
# Tested on        : UBI:9.3
# Language         : R
# Ci-Check     : True
...
PACKAGE_VERSION=${1:-5.98}
PACKAGE_URL=https://github.com/cran/quantreg.git
...
dnf install -y geos-devel gdal-devel udunits2-devel unixODBC-devel libpq-devel proj-devel sqlite-devel gsl-devel 
