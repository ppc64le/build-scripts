...
# variables
PKG_NAME="commons-logging"
PKG_VERSION=1.1.3
PKG_VERSION_LATEST=1.2
LOGS_DIRECTORY=/logs
LOCAL_DIRECTORY=/root
REPOSITORY="https://github.com/apache/commons-logging.git"

# clone, build and test specified version
cd $LOCAL_DIRECTORY
git clone $REPOSITORY $PKG_NAME-$PKG_VERSION
cd $PKG_NAME-$PKG_VERSION/
git checkout -b $PKG_VERSION tags/LOGGING_1_1_3
...
git checkout -b $PKG_VERSION_LATEST tags/LOGGING_1_2
