...
# -----------------------------------------------------------------------------
#
# Package	    : esprima-node
# Version	    : 15001.1.0-dev-harmony-fb
# Source repo	    : https://github.com/facebookarchive/esprima
# Tested on	    : UBI 9.3
# Language          : Node
# Travis-Check      : True
...
PACKAGE_VERSION=${1:-15001.1.0-dev-harmony-fb}
PACKAGE_URL=https://github.com/facebookarchive/esprima
