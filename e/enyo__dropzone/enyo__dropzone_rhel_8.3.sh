...
# Version	: v5.9.2
# Source repo	: https://github.com/dropzone/dropzone-packagist
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=enyo/dropzone
PACKAGE_VERSION=v5.9.2
PACKAGE_URL=https://github.com/dropzone/dropzone-packagist
