...
# Version       : v6.3.1
# Source        : https://github.com/evcohen/eslint-plugin-jsx-a11y.git
# Tested on     : RHEL 7.6
...
git clone https://github.com/evcohen/eslint-plugin-jsx-a11y.git && cd eslint-plugin-jsx-a11y
