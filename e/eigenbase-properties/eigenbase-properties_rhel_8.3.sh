# -----------------------------------------------------------------------------
#
# Package	: eigenbase-properties
# Version	: 1.1.5
# Source repo	: https://github.com/julianhyde/eigenbase-properties
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eigenbase-properties
PACKAGE_VERSION=1.1.5
PACKAGE_URL=https://github.com/julianhyde/eigenbase-properties
