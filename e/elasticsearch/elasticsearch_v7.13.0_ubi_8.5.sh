...
WORKDIR=`pwd`
ELASTICSEARCH_VERSION=${1:-v7.13.0}
...
# Apply patches
wget https://raw.githubusercontent.com/kandarpamalipeddi/build-scripts/master/e/elasticsearch/elasticsearch_v7.13.0.patch
...
./gradlew :distribution:archives:linux-ppc64le-tar:check