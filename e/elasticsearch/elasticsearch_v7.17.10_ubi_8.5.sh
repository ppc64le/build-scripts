...
WORKDIR=`pwd`
ELASTICSEARCH_VERSION=${1:-v7.17.10}
...
# Apply patches
wget https://raw.githubusercontent.com/vinodk99/build-scripts/elastic_patch/e/elasticsearch/elasticsearch_v7.17.10.patch
