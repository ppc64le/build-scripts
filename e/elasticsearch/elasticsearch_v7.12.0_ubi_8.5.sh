...
WORKDIR=`pwd`
ELASTICSEARCH_VERSION=${1:-v7.12.0}
...
# Apply patches
wget https://raw.githubusercontent.com/kandarpamalipeddi/build-scripts/master/e/elasticsearch/elasticsearch_v7.12.0.patch
git apply elasticsearch_v7.12.0.patch
