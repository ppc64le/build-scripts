...
# Version	: v0.3.5
# Source repo	: https://github.com/medikoo/event-emitter
# Tested on	: ubi 8.5
# Language      : node
# Travis-Check  : True
...
PACKAGE_NAME="event-emitter"
PACKAGE_VERSION=${1:-"v0.3.5"}
PACKAGE_URL="https://github.com/medikoo/event-emitter"
export NODE_VERSION=${NODE_VERSION:-v10.24.1}
