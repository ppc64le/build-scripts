...
# -----------------------------------------------------------------------------
#
# Package	    : event-loop-stats
# Version	    : v1.4.1
# Source repo	    : https://github.com/bripkens/event-loop-stats
# Tested on	    : UBI 9.3
# Language          : Node
# Ci-Check      : True
...
PACKAGE_NAME=event-loop-stats
PACKAGE_VERSION=${1:-v1.4.1}
PACKAGE_URL=https://github.com/bripkens/event-loop-stats
