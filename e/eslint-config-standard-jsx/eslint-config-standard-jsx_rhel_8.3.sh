...
# Version	: 8.1.0
# Source repo	: https://github.com/standard/eslint-config-standard-jsx
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-config-standard-jsx
PACKAGE_VERSION=8.1.0
PACKAGE_URL=https://github.com/standard/eslint-config-standard-jsx
