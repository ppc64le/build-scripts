# -----------------------------------------------------------------------------
#
# Package	: express-error-handler
# Version	: 1.1.0
# Source repo	: https://github.com/dilvie/express-error-handler
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=express-error-handler
PACKAGE_VERSION=1.1.0
PACKAGE_URL=https://github.com/dilvie/express-error-handler
