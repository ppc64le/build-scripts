...
# Source repo	: https://github.com/envoyproxy/go-control-plane
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=envoyproxy/go-control-plane
PACKAGE_VERSION=v0.9.9-0.20201210154907-fd9021fe5dad
PACKAGE_URL=https://github.com/envoyproxy/go-control-plane
