...
# Version       : 6.0.1-RELEASE-api
# Source repo   : https://github.com/jakartaee/expression-language 
# Tested on     : UBI: 9.3
# Language      : Java,Html
# Ci-Check  : True
...
set -e
PACKAGE_NAME=expression-language
PACKAGE_URL=https://github.com/jakartaee/expression-language.git
PACKAGE_VERSION=${1:-6.0.1-RELEASE-api}
