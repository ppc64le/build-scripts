# -----------------------------------------------------------------------------
#
# Package	: emitter-listener
# Version	: 1.1.2
# Source repo	: https://github.com/othiym23/emitter-listener
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=emitter-listener
PACKAGE_VERSION=1.1.2
PACKAGE_URL=https://github.com/othiym23/emitter-listener
