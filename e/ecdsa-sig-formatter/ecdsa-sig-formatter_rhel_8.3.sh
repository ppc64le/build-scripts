...
# Version	: 1.0.10
# Source repo	: https://github.com/Brightspace/node-ecdsa-sig-formatter
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=ecdsa-sig-formatter
PACKAGE_VERSION=1.0.10
PACKAGE_URL=https://github.com/Brightspace/node-ecdsa-sig-formatter
