...
# Source repo		: https://github.com/martinwithaar/Encryptor4j.git
# Tested on		: UBI 8
...
# variables
PKG_NAME="Encryptor4j"
PKG_VERSION=0.1.2
PKG_VERSION_LATEST=0.1.2
REPOSITORY="https://github.com/martinwithaar/Encryptor4j.git"

echo "Usage: $0 [<PKG_VERSION>]"
echo "       PKG_VERSION is an optional paramater whose default value is 0.1.2"
...
#echo "releaseSigningEnabled=false" >> ./gradle.properties
#echo "skipCodegen=true" >> ./gradle.properties
#echo "skipAndroid=true" >> ./gradle.properties
#cd core/

gradle build -x signArchives | tee $LOGS_DIRECTORY/$PKG_NAME-$PKG_VERSION.txt
