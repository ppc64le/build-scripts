...
# Version       : master(7d273fc)
# Source        : https://github.com/webpack/enhanced-resolve.git 
# Tested on     : RHEL 7.6
...
git clone https://github.com/webpack/enhanced-resolve.git && cd enhanced-resolve
