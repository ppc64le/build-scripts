...
# Version	: 14.1.0
# Source repo	: https://github.com/standard/eslint-config-standard
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-config-standard
PACKAGE_VERSION=14.1.0
PACKAGE_URL=https://github.com/standard/eslint-config-standard
