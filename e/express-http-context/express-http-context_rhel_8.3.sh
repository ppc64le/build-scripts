# -----------------------------------------------------------------------------
#
# Package	: express-http-context
# Version	: 1.2.4
# Source repo	: https://github.com/skonves/express-http-context
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=express-http-context
PACKAGE_VERSION=1.2.4
PACKAGE_URL=https://github.com/skonves/express-http-context
