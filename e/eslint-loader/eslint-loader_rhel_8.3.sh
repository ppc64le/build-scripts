# -----------------------------------------------------------------------------
#
# Package	: eslint-loader
# Version	: 3.0.3
# Source repo	: https://github.com/webpack-contrib/eslint-loader
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-loader
PACKAGE_VERSION=3.0.3
PACKAGE_URL=https://github.com/webpack-contrib/eslint-loader
