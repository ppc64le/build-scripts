...
SCRIPT_PACKAGE_VERSION=v1.29.0
...
#bazel test --config=clang --config=libc++ --test_timeout=9000 --cxxopt=-fpermissive --define=wasm=disabled //test/... --cache_test_results=no || true
EOF
