...
# Version	: 2.3.0
# Source repo	: https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-plugin-eslint-plugin
PACKAGE_VERSION=2.3.0
PACKAGE_URL=https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin
