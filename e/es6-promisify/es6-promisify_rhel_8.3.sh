# -----------------------------------------------------------------------------
#
# Package	: es6-promisify
# Version	: 6.1.1
# Source repo	: https://github.com/mikehall314/es6-promisify
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=es6-promisify
PACKAGE_VERSION=6.1.1
PACKAGE_URL=https://github.com/mikehall314/es6-promisify
