...
# Version          : v0.2.2
# Source repo      : https://github.com/alexmojaki/eval_type_backport
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=eval_type_backport
PACKAGE_VERSION=${1:-v0.2.2}
PACKAGE_URL=https://github.com/alexmojaki/eval_type_backport
PACKAGE_DIR=eval_type_backport
