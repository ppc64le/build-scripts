...
# Version	: 1.3.723
# Source repo	: https://github.com/kilian/electron-to-chromium
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=electron-to-chromium
PACKAGE_VERSION=1.3.723
PACKAGE_URL=https://github.com/kilian/electron-to-chromium
