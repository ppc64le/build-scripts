...
# Please find errors in README file for version v6.0.0
# https://github.com/sindresorhus/execa/issues/474
# Script is failing with 1 issue that is open in github repo.
# To see full stack trace :- npm test test/test.js | tee /dev/null | head