...
# Version	: 0.3.3
# Source repo	: https://github.com/import-js/eslint-plugin-import
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-import-resolver-node
PACKAGE_VERSION=0.3.3
PACKAGE_URL=https://github.com/import-js/eslint-plugin-import
