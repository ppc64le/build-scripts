...
# Version	: 4.0.0
# Source repo	: https://github.com/sindresorhus/escape-string-regexp
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=escape-string-regexp
PACKAGE_VERSION=4.0.0
PACKAGE_URL=https://github.com/sindresorhus/escape-string-regexp
