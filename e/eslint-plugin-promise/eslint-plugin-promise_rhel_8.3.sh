...
# Version	: 4.3.1
# Source repo	: https://github.com/xjamundx/eslint-plugin-promise
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=eslint-plugin-promise
PACKAGE_VERSION=4.3.1
PACKAGE_URL=https://github.com/xjamundx/eslint-plugin-promise
