# -----------------------------------------------------------------------------
#
# Package	: express-normalize-query-params-middleware
# Version	: 0.5.1
# Source repo	: https://github.com/kogosoftwarellc/express-normalize-query-params-middleware
# Tested on	: RHEL 8.3
...
PACKAGE_NAME=express-normalize-query-params-middleware
PACKAGE_VERSION=0.5.1
PACKAGE_URL=https://github.com/kogosoftwarellc/express-normalize-query-params-middleware
